...
pub fn run() {
    ...
    leptos_posthoc::hydrate_body(|orig| {
        ...
        view!(<Themer attr:style="font-family:inherit;font-size:inherit;font-weight:inherit;line-height:inherit;background-color:inherit;display:contents;"><FTMLGlobalSetup><FTMLDocumentSetup uri=DocumentUri::no_doc().clone()>
