 ...
 * | [`/api/buldqueue/log`](crate::router::buildqueue::log) | `archive=<STRING>`, `rel_path=<STRING>`, `target=<STRING>` | returns the log of the stated build job (requires admin login)|
 * | **Web Sockets** | | |
 ...
 * | [`/content/toc`](crate::router::content::toc) | [DocumentURI](immt_ontology::uris::DocumentURI) | `(Vec<`[CSS](immt_utils::CSS)`>,Vec<`[TOCElem](crate::router::content::toc::TOCElem)`>)` Returns a pair of CSS rules and the table of contents of the given document, including section titles |
*/