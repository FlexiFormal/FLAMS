...
impl DrawerSize {
    fn css(self) -> &'static str {
        ...
        let (cls, csstr) = match self {
            Self::Small => (
                "flams-drawer-absolute-small",
                ".flams-drawer-absolute-small {--thaw-drawer--size:20vw !important;z-index:5;}",
            ),
            Self::Medium => (
                "flams-drawer-absolute-medium",
                ".flams-drawer-absolute-medium {--thaw-drawer--size:50vw !important;z-index:5;}",
            ),
            Self::Wide => (
                "flams-drawer-absolute-wide",
                ".flams-drawer-absolute-wide {--thaw-drawer--size:80vw !important;z-index:5;}",
            ),
        };
