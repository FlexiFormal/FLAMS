...
use flams_ontology::{narration::LOKind, uris::{DocumentElementURI, DocumentURI, SymbolURI}};
use leptos::prelude::*;
use flams_utils::CSS;
#[cfg(feature="csr")]
use std::borrow::Cow;
...
use flams_ontology::{uris::{ArchiveId, URI},languages::Language};
...
impl ServerConfig {
    ...
    #[cfg(feature="omdoc")]
    #[inline]
    pub async fn omdoc(&self,uri:flams_ontology::uris::URI) -> Result<(Vec<CSS>,AnySpec),String> {
    ...
    #[cfg(feature="omdoc")]
    #[inline]
    pub async fn notations(&self,uri:flams_ontology::uris::URI) -> Result<Vec<(DocumentElementURI,flams_ontology::narration::notations::Notation)>,String> {
        let ret = self.get_notations.call(uri,()).await;
        ret
    }

    #[cfg(feature="omdoc")]
    pub fn get_notation(&self,uri:&flams_ontology::uris::DocumentElementURI) -> Option<flams_ontology::narration::notations::Notation> {
    ...
    pub async fn present(&self,t:flams_ontology::content::terms::Term) -> Result<String,String> {
        ...
        use flams_ontology::narration::notations::{Notation,Presenter,PresentationError};
