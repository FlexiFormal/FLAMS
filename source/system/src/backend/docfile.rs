...
use eyre::eyre;
use flams_ontology::narration::{documents::{Document, UncheckedDocument}, exercises::{Quiz, QuizElement, QuizQuestion}, DocumentElement, NarrationTrait};
    ...
    fn as_quiz(&self,backend:&impl Backend) -> eyre::Result<Quiz> {
        ...
        macro_rules! pop { () => {
            if let Some((c,mut e,s)) = stack.pop() {
                ...
                match s {
                    Some(either::Either::Left(s)) =>
                        elements.push(QuizElement::Section{ title:s, elements:e }),
        ...
        loop {
            ...
            match e {
                ...
                DocumentElement::Section(sect) => {
                    ...
                    } else { push!(sect.children().iter();None);}
                }
                ...
                DocumentElement::Exercise(e) => {
                    ...
                    elements.push(QuizElement::Question(QuizQuestion {
                        html,//solution,
                        uri:e.uri.clone(),
                        preconditions:e.preconditions.to_vec(),objectives:e.objectives.to_vec(),
