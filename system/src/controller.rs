...
impl Controller {
    ...
    pub fn formats(&self) -> &FormatStore {
        &self.0.formats
    }
    ...
    pub fn relational_manager(&self) -> &RelationalManager {
        &self.0.relman
    }
...
impl ControllerBuilder {
    ...
    pub fn build(self) -> Controller {
        ...
        relman.init();
        info!(
            "Controller initialized; base ontology has {} quads",
            relman.size()
        );
