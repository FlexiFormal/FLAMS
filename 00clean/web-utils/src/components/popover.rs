...
use leptos::{ev, html};
use leptos::prelude::*;
pub use thaw::{PopoverTrigger, PopoverAppearance, PopoverPosition};
use thaw_utils::{class_list, add_event_listener};
...
pub fn Popover(
    ...
    let is_show_popover = match trigger_type {
        PopoverTriggerType::HoverSignal(s) |
        PopoverTriggerType::ClickSignal(s) => s,
