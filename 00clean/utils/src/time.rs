...
fn non_zero<I:AsU64>(i:I) -> NonZeroU64 {
    NonZeroU64::new(i.into_u64()).unwrap_or_else(|| NonZeroU64::new(1).unwrap_or_else(|| unreachable!()))
}
impl Timestamp {
    #[must_use]
    pub fn now() -> Self {
...
impl Display for Timestamp {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        let timestamp = chrono::DateTime::<chrono::Utc>::from_timestamp_millis(ts).unwrap_or_else(|| unreachable!())
