...
use crate::{STeXExtension, EXTENSIONS, ID};
            ...
            .with(
                fmt.with_filter(
                    Targets::new()
                        ...
                        .with_target("source_file", LevelFilter::OFF),
                ),
            )
            .try_init();
    } else {
...
fn check_metathy() {
    test_setup(false);
    check_file_string_tokens(Path::new(
        "/home/jazzpirate/work/MathHub/sTeX/meta-inf/source/Metatheory.en.tex",
    ));
    check_file_string_parsed(Path::new(
        "/home/jazzpirate/work/MathHub/sTeX/meta-inf/source/Metatheory.en.tex",
    ));
    check_file_tokens(Path::new(
        "/home/jazzpirate/work/MathHub/sTeX/meta-inf/source/Metatheory.en.tex",
    ));
    check_file_parsed(Path::new(
        "/home/jazzpirate/work/MathHub/sTeX/meta-inf/source/Metatheory.en.tex",
    ));
}
#[test]
fn check_latex_ltx() {
    ...
    measure_average("latex.ltx string", 50, || {
        check_file_string_tokens(Path::new(
            "/home/jazzpirate/TeXLive/texmf-dist/tex/latex/base/latex.ltx",
        ));
        check_file_string_parsed(Path::new(
            "/home/jazzpirate/TeXLive/texmf-dist/tex/latex/base/latex.ltx",
        ));
...
fn get_mh() -> ArchiveGroup {
    ...
    store.register(immt_api::formats::Format::new(
        ID,
        EXTENSIONS,
