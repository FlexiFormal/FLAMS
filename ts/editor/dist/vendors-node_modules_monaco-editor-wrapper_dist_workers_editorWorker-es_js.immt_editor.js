...
/* harmony export */   bootstrapSimpleEditorWorker: () => (/* binding */ Po),
/* harmony export */   initialize: () => (/* binding */ _r)
/* harmony export */ });
class Cr {
  constructor() {
    this.listeners = [], this.unexpectedErrorHandler = function(e) {
      setTimeout(() => {
        throw e.stack ? st.isErrorNoTelemetry(e) ? new st(e.message + `
...
const Sr = new Cr();
function dt(t) {
  Rr(t) || Sr.onUnexpectedError(t);
}
function zn(t) {
  if (t instanceof Error) {
    const { name: e, message: n } = t, s = t.stacktrace || t.stack;
    return {
      $isError: !0,
      name: e,
      message: n,
...
const un = "Canceled";
function Rr(t) {
  return t instanceof Ar ? !0 : t instanceof Error && t.name === un && t.message === un;
}
...
function Er(t, e) {
  ...
  let s = !1, r;
  return function() {
    return s || (s = !0, r = t.apply(n, arguments)), r;
  };
}
function rt(t, e) {
  const n = it(t, e);
...
function it(t, e, n = 0, s = t.length) {
  let r = n, i = s;
  for (; r < i; ) {
...
function cn(t, e, n = 0, s = t.length) {
  let r = n, i = s;
  for (; r < i; ) {
    const a = Math.floor((r + i) / 2);
    e(t[a]) ? i = a : r = a + 1;
...
const jt = class jt {
  ...
  findLastMonotonous(e) {
    if (jt.assertInvariants) {
      if (this._prevFindLastPredicate) {
        for (const s of this._array)
          if (this._prevFindLastPredicate(s) && !e(s))
            throw new Error(
...
jt.assertInvariants = !1;
let It = jt;
function kr(t, e, n = (s, r) => s === r) {
  if (t === e)
    return !0;
...
function* Pr(t, e) {
  let n, s;
  for (const r of t)
    s !== void 0 && e(s, r) ? n.push(r) : (n && (yield n), n = [r]), s = r;
  n && (yield n);
}
function Tr(t, e) {
...
const Je = class Je {
  ...
  filter(e) {
    return new Je((n) => this.iterate((s) => e(s) ? n(s) : !0));
  }
  map(e) {
    return new Je((n) => this.iterate((s) => n(e(s))));
  }
  some(e) {
    let n = !1;
    return this.iterate((s) => (n = e(s), !n)), n;
  }
  findFirst(e) {
    let n;
    return this.iterate((s) => e(s) ? (n = s, !1) : !0), n;
  }
  findLast(e) {
    let n;
  ...
  findLastMaxBy(e) {
    let n, s = !0;
    return this.iterate((r) => ((s || hn.isGreaterThan(e(r, n))) && (s = !1, n = r), !0)), n;
  }
};
Je.empty = new Je((e) => {
});
...
const Fe = class Fe {
  constructor(e, n) {
    if (this[jn] = "ResourceMap", e instanceof Fe)
      this.map = new Map(e.map), this.toKey = n ?? Fe.defaultToKey;
    else if (Br(e)) {
      this.map = /* @__PURE__ */ new Map(), this.toKey = n ?? Fe.defaultToKey;
      for (const [s, r] of e)
        this.set(s, r);
    } else
      this.map = /* @__PURE__ */ new Map(), this.toKey = e ?? Fe.defaultToKey;
  }
  set(e, n) {
    return this.map.set(this.toKey(e), new Vr(e, n)), this;
  }
  get(e) {
    var n;
...
Fe.defaultToKey = (e) => e.toString();
let fn = Fe;
class qr {
  constructor() {
    this[Gn] = "LinkedMap", this._map = /* @__PURE__ */ new Map(), this._head = void 0, this._tail = void 0, this._size = 0, this._state = 0;
  }
  clear() {
  ...
  set(e, n, s = 0) {
    ...
    if (r)
      ...
      switch (r = { key: e, value: n, next: void 0, previous: void 0 }, s) {
        case 0:
          this.addItemLast(r);
          break;
        case 1:
  ...
  forEach(e, n) {
    ...
    let r = this._head;
    for (; r; ) {
      if (n ? e.bind(n)(r.value, r.key, this) : e(r.value, r.key, this), this._state !== s)
  ...
  [(Gn = Symbol.toStringTag, Symbol.iterator)]() {
    return this.entries();
  }
  trimOld(e) {
    if (e >= this.size)
  ...
  touch(e, n) {
    ...
    if (!(n !== 1 && n !== 2)) {
      if (n === 1) {
        if (e === this._head)
          return;
        const s = e.next, r = e.previous;
        e === this._tail ? (r.next = void 0, this._tail = r) : (s.previous = r, r.next = s), e.previous = void 0, e.next = this._head, this._head.previous = e, this._head = e, this._state++;
      } else if (n === 2) {
        if (e === this._tail)
          return;
        const s = e.next, r = e.previous;
        e === this._head ? (s.previous = void 0, this._head = s) : (s.previous = r, r.next = s), e.next = void 0, e.previous = this._tail, this._tail.next = e, this._tail = e, this._state++;
      }
    }
  }
  toJSON() {
...
class Qs {
  ...
  add(e, n) {
    ...
    s || (s = /* @__PURE__ */ new Set(), this.map.set(e, s)), s.add(n);
  }
  delete(e, n) {
    const s = this.map.get(e);
    s && (s.delete(n), s.size === 0 && this.map.delete(e));
  }
  forEach(e, n) {
    const s = this.map.get(e);
    s && s.forEach(n);
...
(function(t) {
  ...
  t.reduce = w;
  function* L(p, x, C = p.length) {
    for (x < 0 && (x += p.length), C < 0 ? C += p.length : C > p.length && (C = p.length); x < C; x++)
      yield p[x];
  }
  t.slice = L;
  function _(p, x = Number.POSITIVE_INFINITY) {
    const C = [];
    if (x === 0)
      return [C, p];
...
const Gt = class Gt {
  ...
  getDisposableData(e) {
    let n = this.livingDisposables.get(e);
    return n || (n = { parent: null, source: null, isSingleton: !1, value: e, idx: Gt.idx++ }, this.livingDisposables.set(e, n)), n;
  }
  trackDisposable(e) {
  ...
  setParent(e, n) {
    const s = this.getDisposableData(e);
    s.parent = n;
  }
  markAsDisposed(e) {
  ...
  getRootParent(e, n) {
    ...
    if (s)
      return s;
    const r = e.parent ? this.getRootParent(this.getDisposableData(e.parent), n) : e;
    return n.set(e, r), r;
  }
  getTrackedDisposables() {
    const e = /* @__PURE__ */ new Map();
    return [...this.livingDisposables.entries()].filter(([, s]) => s.source !== null && !this.getRootParent(s, e).isSingleton).flatMap(([s]) => s);
  }
  computeLeakingDisposables(e = 10, n) {
    let s;
    if (n)
      s = n;
    else {
      ...
      if (s = c.filter((f) => !(f.parent && h.has(f.parent))), s.length === 0)
    ...
    function r(u) {
      function c(f, d) {
        for (; f.length > 0 && d.some(
          (m) => typeof m == "string" ? m === f[0] : f[0].match(m)
        ); )
          f.shift();
      }
...
`).map((f) => f.trim().replace("at ", "")).filter((f) => f !== "");
    ...
    for (const u of s) {
      ...
      for (let h = 0; h <= c.length; h++)
        i.add(c.slice(0, h).join(`
`), u);
    }
    s.sort(mt((u) => u.idx, gt));
    let a = "", l = 0;
    for (const u of s.slice(0, e)) {
      l++;
      const c = r(u), h = [];
      for (let f = 0; f < c.length; f++) {
        let d = c[f];
        d = `(shared with ${i.get(c.slice(0, f + 1).join(`
`)).size}/${s.length} leaks) at ${d}`;
        const g = i.get(c.slice(0, f).join(`
`)), b = yr([...g].map((w) => r(w)[f]), (w) => w);
        delete b[c[f]];
        for (const [w, L] of Object.entries(b))
          h.unshift(`    - stacktraces of ${L.length} other leaks continue with ${w}`);
        h.unshift(d);
      }
      a += `


==================== Leaking disposable ${l}/${s.length}: ${u.value.constructor.name} ====================
${h.join(`
`)}
============================================================
...
const Xt = class Xt {
  ...
  add(e) {
    ...
    return this._isDisposed ? Xt.DISABLE_DISPOSED_WARNING || console.warn(new Error(
...
Wn.None = Object.freeze({ dispose() {
} });
let at = Wn;
const Ze = class Ze {
  constructor(e) {
    this.element = e, this.next = Ze.Undefined, this.prev = Ze.Undefined;
  }
};
Ze.Undefined = new Ze(void 0);
let G = Ze;
class Wr {
  constructor() {
...
const zr = globalThis.performance && typeof globalThis.performance.now == "function";
class Kt {
  static create(e) {
    return new Kt(e);
  }
  constructor(e) {
    this._now = zr && e === !1 ? Date.now : globalThis.performance.now.bind(globalThis.performance), this._startTime = this._now(), this._stopTime = -1;
  }
  stop() {
...
(function(t) {
  ...
  function n(S) {
    return (N, E = null, y) => {
      ...
      return I = S((W) => {
        if (!P)
          return I ? I.dispose() : P = !0, N.call(E, W);
      }, null, y), P && I.dispose(), I;
    };
  }
  t.once = n;
  function s(S, N) {
    return t.once(t.filter(S, N));
  }
  t.onceIf = s;
  function r(S, N, E) {
    return h((y, P = null, I) => S((W) => y.call(P, N(W)), null, I), E);
  }
  t.map = r;
  function i(S, N, E) {
    return h((y, P = null, I) => S((W) => {
      N(W), y.call(P, W);
    }, null, I), E);
  }
  t.forEach = i;
  function a(S, N, E) {
    return h((y, P = null, I) => S((W) => N(W) && y.call(P, W), null, I), E);
  }
  t.filter = a;
  function l(S) {
    return S;
  ...
  function u(...S) {
    return (N, E = null, y) => {
      const P = Hr(...S.map((I) => I((W) => N.call(E, W))));
      return f(P, y);
    };
  }
  t.any = u;
  ...
  function f(S, N) {
    return N instanceof Array ? N.push(S) : N && N.add(S), S;
  }
  function d(S, N, E = 100, y = !1, P = !1, I, W) {
    let K, ie, He, St = 0, De;
    const Lr = {
      leakWarningThreshold: I,
      onWillAddFirstListener() {
        K = S((vr) => {
          St++, ie = N(ie, vr), y && !He && (Rt.fire(ie), ie = void 0), De = () => {
            const Nr = ie;
            ie = void 0, He = void 0, (!y || St > 1) && Rt.fire(Nr), St = 0;
          }, typeof E == "number" ? (clearTimeout(He), He = setTimeout(De, E)) : He === void 0 && (He = 0, queueMicrotask(De));
        });
      },
    ...
    return W == null || W.add(Rt), Rt.event;
  }
  t.debounce = d;
  function m(S, N = 0, E) {
    return t.debounce(S, (y, P) => y ? (y.push(P), y) : [P], N, void 0, !0, void 0, E);
  }
  t.accumulate = m;
  function g(S, N = (y, P) => y === P, E) {
    let y = !0, P;
    return a(S, (I) => {
      const W = y || !N(I, P);
      return y = !1, P = I, W;
  ...
  t.split = b;
  function w(S, N = !1, E = [], y) {
    let P = E.slice(), I = S((ie) => {
      P ? P.push(ie) : K.fire(ie);
    });
    y && y.add(I);
    const W = () => {
      P == null || P.forEach((ie) => K.fire(ie)), P = null;
    }, K = new fe({
      onWillAddFirstListener() {
        I || (I = S((ie) => K.fire(ie)), y && y.add(I));
      },
  ...
  class v {
    ...
    forEach(N) {
      return this.steps.push((E) => (N(E), E)), this;
    }
    filter(N) {
      return this.steps.push((E) => N(E) ? E : _), this;
    }
    reduce(N, E) {
      let y = E;
      return this.steps.push((P) => (y = N(y, P), y)), this;
    }
    latch(N = (E, y) => E === y) {
      let E = !0, y;
      return this.steps.push((P) => {
        const I = E || !N(P, y);
        return E = !1, y = P, I ? P : _;
      }), this;
    }
    evaluate(N) {
  ...
  function p(S, N, E = (y) => y) {
    const y = (...K) => W.fire(E(...K)), P = () => S.on(N, y), I = () => S.removeListener(N, y), W = new fe(
      { onWillAddFirstListener: P, onDidRemoveLastListener: I }
    );
    return W.event;
  }
  t.fromNodeEventEmitter = p;
  function x(S, N, E = (y) => y) {
    const y = (...K) => W.fire(E(...K)), P = () => S.addEventListener(N, y), I = () => S.removeEventListener(N, y), W = new fe(
      { onWillAddFirstListener: P, onDidRemoveLastListener: I }
    );
    return W.event;
  }
  ...
  class J {
    constructor(N, E) {
      ...
      this.emitter = new fe(y), E && E.add(this.emitter);
    }
    beginUpdate(N) {
      this._counter++;
    }
  ...
  function $(S, N) {
    return new J(S, N).emitter.event;
  }
  t.fromObservable = $;
  function D(S) {
    return (N, E, y) => {
      ...
      const W = {
        ...
        endUpdate() {
          P--, P === 0 && (S.reportChanges(), I && (I = !1, N.call(E)));
        },
      ...
      return y instanceof Lt ? y.add(K) : Array.isArray(y) && y.push(K), K;
    };
  }
  t.fromObservableLight = D;
})(Bt || (Bt = {}));
const Ke = class Ke {
  constructor(e) {
    this.listenerCount = 0, this.invocationCount = 0, this.elapsedOverall = 0, this.durations = [], this.name = `${e}_${Ke._idPool++}`, Ke.all.add(this);
  }
  start(e) {
...
Ke.all = /* @__PURE__ */ new Set(), Ke._idPool = 0;
let dn = Ke, Or = -1;
const Qt = class Qt {
  constructor(e, n, s = (Qt._idPool++).toString(16).padStart(3, "0")) {
...
class fe {
  constructor(e) {
    var n, s, r, i;
    this._size = 0, this._options = e, this._leakageMon = (n = this._options) != null && n.leakWarningThreshold ? new mn(
      (e == null ? void 0 : e.onListenerError) ?? dt,
      ((s = this._options) == null ? void 0 : s.leakWarningThreshold) ?? Or
    ) : void 0, this._perfMon = (r = this._options) != null && r._profName ? new dn(this._options._profName) : void 0, this._deliveryQueue = (i = this._options) == null ? void 0 : i.deliveryQueue;
  }
  dispose() {
    var e, n, s, r;
    this._disposed || (this._disposed = !0, ((e = this._deliveryQueue) == null ? void 0 : e.current) === this && this._deliveryQueue.reset(), this._listeners && (this._listeners = void 0, this._size = 0), (s = (n = this._options) == null ? void 0 : n.onDidRemoveLastListener) == null || s.call(n), (r = this._leakageMon) == null || r.dispose());
  }
  get event() {
    return this._event ?? (this._event = (e, n, s) => {
      var l, u, c, h, f;
      if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
        ...
        console.warn(d);
        const m = this._leakageMon.getMostFrequentStack() ?? ["UNKNOWN stack", -1], g = new Gr(
          `${d}. HINT: Stack shows most frequent listener (${m[1]}-times)`,
          m[0]
        );
        return (((l = this._options) == null ? void 0 : l.onListenerError) || dt)(g), at.None;
      }
      if (this._disposed)
        return at.None;
      n && (e = e.bind(n));
      const r = new en(e);
      let i;
      this._leakageMon && this._size >= Math.ceil(this._leakageMon.threshold * 0.2) && (r.stack = Fn.create(), i = this._leakageMon.check(r.stack, this._size + 1)), this._listeners ? this._listeners instanceof en ? (this._deliveryQueue ?? (this._deliveryQueue = new Yr()), this._listeners = [this._listeners, r]) : this._listeners.push(r) : ((c = (u = this._options) == null ? void 0 : u.onWillAddFirstListener) == null || c.call(u, this), this._listeners = r, (f = (h = this._options) == null ? void 0 : h.onDidAddFirstListener) == null || f.call(h, this)), this._size++;
      const a = _t(() => {
        i == null || i(), this._removeListener(r);
      });
      return s instanceof Lt ? s.add(a) : Array.isArray(s) && s.push(a), a;
    }), this._event;
  }
  _removeListener(e) {
    var i, a, l, u;
    if ((a = (i = this._options) == null ? void 0 : i.onWillRemoveListener) == null || a.call(i, this), !this._listeners)
      return;
    if (this._size === 1) {
  ...
  _deliver(e, n) {
    ...
    if (!e)
      return;
    const s = ((r = this._options) == null ? void 0 : r.onListenerError) || dt;
    if (!s) {
      e.value(n);
      return;
    }
  ...
  fire(e) {
    var n, s, r, i;
    if ((n = this._deliveryQueue) != null && n.current && (this._deliverQueue(this._deliveryQueue), (s = this._perfMon) == null || s.stop()), (r = this._perfMon) == null || r.start(this._size), this._listeners) if (this._listeners instanceof en)
...
const Zr = Js() === "pseudo" || typeof document < "u" && document.location && typeof document.location.hash == "string" && document.location.hash.indexOf("pseudo=true") >= 0;
function Qn(t, e) {
  let n;
  return e.length === 0 ? n = t : n = t.replace(/\{(\d+)\}/g, (s, r) => {
    const i = r[0], a = e[i];
    let l = s;
    return typeof a == "string" ? l = a : (typeof a == "number" || typeof a == "boolean" || a === void 0 || a === null) && (l = String(a)), l;
  }), Zr && (n = "［" + n.replace(/[aouei]/g, "$&$&") + "］"), n;
}
function j(t, e, ...n) {
  return Qn(typeof t == "number" ? Kr(t, e) : e, n);
}
function Kr(t, e) {
  var s;
  const n = (s = Jr()) == null ? void 0 : s[t];
  if (typeof n != "string") {
    if (typeof e == "string")
      return e;
...
const Xe = "en";
let gn = !1, bn = !1, tn = !1, Zs = !1, In = !1, At, kt = Xe, Yn = Xe, ei, be;
const Ne = globalThis;
let ne;
var Os;
typeof Ne.vscode < "u" && typeof Ne.vscode.process < "u" ? ne = Ne.vscode.process : typeof process < "u" && typeof ((Os = process == null ? void 0 : process.versions) == null ? void 0 : Os.node) == "string" && (ne = process);
var js;
const ti = typeof ((js = ne == null ? void 0 : ne.versions) == null ? void 0 : js.electron) == "string", ni = ti && (ne == null ? void 0 : ne.type) === "renderer";
var Gs;
if (typeof ne == "object") {
  gn = ne.platform === "win32", bn = ne.platform === "darwin", tn = ne.platform === "linux", tn && ne.env.SNAP && ne.env.SNAP_REVISION, ne.env.CI || ne.env.BUILD_ARTIFACTSTAGINGDIRECTORY, At = Xe, kt = Xe;
  const t = ne.env.VSCODE_NLS_CONFIG;
  if (t)
    try {
      const e = JSON.parse(t);
      At = e.userLocale, Yn = e.osLocale, kt = e.resolvedLanguage || Xe, ei = (Gs = e.languagePack) == null ? void 0 : Gs.translationsConfigFile;
    } catch {
    }
  Zs = !0;
} else typeof navigator == "object" && !ni ? (be = navigator.userAgent, gn = be.indexOf("Windows") >= 0, bn = be.indexOf("Macintosh") >= 0, (be.indexOf("Macintosh") >= 0 || be.indexOf("iPad") >= 0 || be.indexOf("iPhone") >= 0) && navigator.maxTouchPoints && navigator.maxTouchPoints > 0, tn = be.indexOf("Linux") >= 0, (be == null ? void 0 : be.indexOf("Mobi")) >= 0, In = !0, kt = Js() || Xe, At = navigator.language.toLowerCase(), Yn = At) : console.error("Unable to resolve platform.");
const ot = gn, si = bn, ri = Zs, ii = In, ai = In && typeof Ne.importScripts == "function", oi = ai ? Ne.origin : void 0, _e = be, Re = kt;
var Jn;
(function(t) {
  function e() {
    return Re;
  ...
  t.value = e;
  function n() {
    return Re.length === 2 ? Re === "en" : Re.length >= 3 ? Re[0] === "e" && Re[1] === "n" && Re[2] === "-" : !1;
  }
...
const li = typeof Ne.postMessage == "function" && !Ne.importScripts;
(() => {
  if (li) {
    const t = [];
    ...
    return (n) => {
      ...
      t.push({
        id: s,
        callback: n
      }), Ne.postMessage({ vscodeScheduleAsyncWork: s }, "*");
    };
  }
  return (t) => setTimeout(t);
})();
const ui = !!(_e && _e.indexOf("Chrome") >= 0);
_e && _e.indexOf("Firefox") >= 0;
!ui && _e && _e.indexOf("Safari") >= 0;
_e && _e.indexOf("Edg/") >= 0;
_e && _e.indexOf("Android") >= 0;
const Ks = Object.freeze(function(t, e) {
...
(function(t) {
  function e(n) {
    return n === t.None || n === t.Cancelled || n instanceof Pt ? !0 : !n || typeof n != "object" ? !1 : typeof n.isCancellationRequested == "boolean" && typeof n.onCancellationRequested == "function";
  }
...
class Pt {
  ...
  get onCancellationRequested() {
    return this._isCancelled ? Ks : (this._emitter || (this._emitter = new fe()), this._emitter.event);
  }
  dispose() {
...
class ci {
  ...
  cancel() {
    this._token ? this._token instanceof Pt && this._token.cancel() : this._token = qt.Cancelled;
  }
  dispose(e = !1) {
    var n;
    e && this.cancel(), (n = this._parentListener) == null || n.dispose(), this._token ? this._token instanceof Pt && this._token.dispose() : this._token = qt.None;
  }
}
function hi(t) {
  return t;
...
function xi(t, e, n = 0, s = t.length, r = 0, i = e.length) {
  for (; n < s && r < i; n++, r++) {
    const u = t.charCodeAt(n), c = e.charCodeAt(r);
    if (u < c)
      return -1;
    if (u > c)
      return 1;
...
function er(t, e, n = 0, s = t.length, r = 0, i = e.length) {
  for (; n < s && r < i; n++, r++) {
    let u = t.charCodeAt(n), c = e.charCodeAt(r);
    if (u === c)
      continue;
    if (u >= 128 || c >= 128)
      return xi(t.toLowerCase(), e.toLowerCase(), n, s, r, i);
    Kn(u) && (u -= 32), Kn(c) && (c -= 32);
    const h = u - c;
    if (h !== 0)
      return h;
...
function wi(t, e) {
  return t.length === e.length && er(t, e) === 0;
}
function _i(t, e) {
  const n = e.length;
  return e.length > t.length ? !1 : er(t, e, 0, n) === 0;
}
function pn(t) {
...
xe.ambiguousCharacterData = new Zn(() => JSON.parse('{"_common":[8232,32,8233,32,5760,32,8192,32,8193,32,8194,32,8195,32,8196,32,8197,32,8198,32,8200,32,8201,32,8202,32,8287,32,8199,32,8239,32,2042,95,65101,95,65102,95,65103,95,8208,45,8209,45,8210,45,65112,45,1748,45,8259,45,727,45,8722,45,10134,45,11450,45,1549,44,1643,44,8218,44,184,44,42233,44,894,59,2307,58,2691,58,1417,58,1795,58,1796,58,5868,58,65072,58,6147,58,6153,58,8282,58,1475,58,760,58,42889,58,8758,58,720,58,42237,58,451,33,11601,33,660,63,577,63,2429,63,5038,63,42731,63,119149,46,8228,46,1793,46,1794,46,42510,46,68176,46,1632,46,1776,46,42232,46,1373,96,65287,96,8219,96,8242,96,1370,96,1523,96,8175,96,65344,96,900,96,8189,96,8125,96,8127,96,8190,96,697,96,884,96,712,96,714,96,715,96,756,96,699,96,701,96,700,96,702,96,42892,96,1497,96,2036,96,2037,96,5194,96,5836,96,94033,96,94034,96,65339,91,10088,40,10098,40,12308,40,64830,40,65341,93,10089,41,10099,41,12309,41,64831,41,10100,123,119060,123,10101,125,65342,94,8270,42,1645,42,8727,42,66335,42,5941,47,8257,47,8725,47,8260,47,9585,47,10187,47,10744,47,119354,47,12755,47,12339,47,11462,47,20031,47,12035,47,65340,92,65128,92,8726,92,10189,92,10741,92,10745,92,119311,92,119355,92,12756,92,20022,92,12034,92,42872,38,708,94,710,94,5869,43,10133,43,66203,43,8249,60,10094,60,706,60,119350,60,5176,60,5810,60,5120,61,11840,61,12448,61,42239,61,8250,62,10095,62,707,62,119351,62,5171,62,94015,62,8275,126,732,126,8128,126,8764,126,65372,124,65293,45,120784,50,120794,50,120804,50,120814,50,120824,50,130034,50,42842,50,423,50,1000,50,42564,50,5311,50,42735,50,119302,51,120785,51,120795,51,120805,51,120815,51,120825,51,130035,51,42923,51,540,51,439,51,42858,51,11468,51,1248,51,94011,51,71882,51,120786,52,120796,52,120806,52,120816,52,120826,52,130036,52,5070,52,71855,52,120787,53,120797,53,120807,53,120817,53,120827,53,130037,53,444,53,71867,53,120788,54,120798,54,120808,54,120818,54,120828,54,130038,54,11474,54,5102,54,71893,54,119314,55,120789,55,120799,55,120809,55,120819,55,120829,55,130039,55,66770,55,71878,55,2819,56,2538,56,2666,56,125131,56,120790,56,120800,56,120810,56,120820,56,120830,56,130040,56,547,56,546,56,66330,56,2663,57,2920,57,2541,57,3437,57,120791,57,120801,57,120811,57,120821,57,120831,57,130041,57,42862,57,11466,57,71884,57,71852,57,71894,57,9082,97,65345,97,119834,97,119886,97,119938,97,119990,97,120042,97,120094,97,120146,97,120198,97,120250,97,120302,97,120354,97,120406,97,120458,97,593,97,945,97,120514,97,120572,97,120630,97,120688,97,120746,97,65313,65,119808,65,119860,65,119912,65,119964,65,120016,65,120068,65,120120,65,120172,65,120224,65,120276,65,120328,65,120380,65,120432,65,913,65,120488,65,120546,65,120604,65,120662,65,120720,65,5034,65,5573,65,42222,65,94016,65,66208,65,119835,98,119887,98,119939,98,119991,98,120043,98,120095,98,120147,98,120199,98,120251,98,120303,98,120355,98,120407,98,120459,98,388,98,5071,98,5234,98,5551,98,65314,66,8492,66,119809,66,119861,66,119913,66,120017,66,120069,66,120121,66,120173,66,120225,66,120277,66,120329,66,120381,66,120433,66,42932,66,914,66,120489,66,120547,66,120605,66,120663,66,120721,66,5108,66,5623,66,42192,66,66178,66,66209,66,66305,66,65347,99,8573,99,119836,99,119888,99,119940,99,119992,99,120044,99,120096,99,120148,99,120200,99,120252,99,120304,99,120356,99,120408,99,120460,99,7428,99,1010,99,11429,99,43951,99,66621,99,128844,67,71922,67,71913,67,65315,67,8557,67,8450,67,8493,67,119810,67,119862,67,119914,67,119966,67,120018,67,120174,67,120226,67,120278,67,120330,67,120382,67,120434,67,1017,67,11428,67,5087,67,42202,67,66210,67,66306,67,66581,67,66844,67,8574,100,8518,100,119837,100,119889,100,119941,100,119993,100,120045,100,120097,100,120149,100,120201,100,120253,100,120305,100,120357,100,120409,100,120461,100,1281,100,5095,100,5231,100,42194,100,8558,68,8517,68,119811,68,119863,68,119915,68,119967,68,120019,68,120071,68,120123,68,120175,68,120227,68,120279,68,120331,68,120383,68,120435,68,5024,68,5598,68,5610,68,42195,68,8494,101,65349,101,8495,101,8519,101,119838,101,119890,101,119942,101,120046,101,120098,101,120150,101,120202,101,120254,101,120306,101,120358,101,120410,101,120462,101,43826,101,1213,101,8959,69,65317,69,8496,69,119812,69,119864,69,119916,69,120020,69,120072,69,120124,69,120176,69,120228,69,120280,69,120332,69,120384,69,120436,69,917,69,120492,69,120550,69,120608,69,120666,69,120724,69,11577,69,5036,69,42224,69,71846,69,71854,69,66182,69,119839,102,119891,102,119943,102,119995,102,120047,102,120099,102,120151,102,120203,102,120255,102,120307,102,120359,102,120411,102,120463,102,43829,102,42905,102,383,102,7837,102,1412,102,119315,70,8497,70,119813,70,119865,70,119917,70,120021,70,120073,70,120125,70,120177,70,120229,70,120281,70,120333,70,120385,70,120437,70,42904,70,988,70,120778,70,5556,70,42205,70,71874,70,71842,70,66183,70,66213,70,66853,70,65351,103,8458,103,119840,103,119892,103,119944,103,120048,103,120100,103,120152,103,120204,103,120256,103,120308,103,120360,103,120412,103,120464,103,609,103,7555,103,397,103,1409,103,119814,71,119866,71,119918,71,119970,71,120022,71,120074,71,120126,71,120178,71,120230,71,120282,71,120334,71,120386,71,120438,71,1292,71,5056,71,5107,71,42198,71,65352,104,8462,104,119841,104,119945,104,119997,104,120049,104,120101,104,120153,104,120205,104,120257,104,120309,104,120361,104,120413,104,120465,104,1211,104,1392,104,5058,104,65320,72,8459,72,8460,72,8461,72,119815,72,119867,72,119919,72,120023,72,120179,72,120231,72,120283,72,120335,72,120387,72,120439,72,919,72,120494,72,120552,72,120610,72,120668,72,120726,72,11406,72,5051,72,5500,72,42215,72,66255,72,731,105,9075,105,65353,105,8560,105,8505,105,8520,105,119842,105,119894,105,119946,105,119998,105,120050,105,120102,105,120154,105,120206,105,120258,105,120310,105,120362,105,120414,105,120466,105,120484,105,618,105,617,105,953,105,8126,105,890,105,120522,105,120580,105,120638,105,120696,105,120754,105,1110,105,42567,105,1231,105,43893,105,5029,105,71875,105,65354,106,8521,106,119843,106,119895,106,119947,106,119999,106,120051,106,120103,106,120155,106,120207,106,120259,106,120311,106,120363,106,120415,106,120467,106,1011,106,1112,106,65322,74,119817,74,119869,74,119921,74,119973,74,120025,74,120077,74,120129,74,120181,74,120233,74,120285,74,120337,74,120389,74,120441,74,42930,74,895,74,1032,74,5035,74,5261,74,42201,74,119844,107,119896,107,119948,107,120000,107,120052,107,120104,107,120156,107,120208,107,120260,107,120312,107,120364,107,120416,107,120468,107,8490,75,65323,75,119818,75,119870,75,119922,75,119974,75,120026,75,120078,75,120130,75,120182,75,120234,75,120286,75,120338,75,120390,75,120442,75,922,75,120497,75,120555,75,120613,75,120671,75,120729,75,11412,75,5094,75,5845,75,42199,75,66840,75,1472,108,8739,73,9213,73,65512,73,1633,108,1777,73,66336,108,125127,108,120783,73,120793,73,120803,73,120813,73,120823,73,130033,73,65321,73,8544,73,8464,73,8465,73,119816,73,119868,73,119920,73,120024,73,120128,73,120180,73,120232,73,120284,73,120336,73,120388,73,120440,73,65356,108,8572,73,8467,108,119845,108,119897,108,119949,108,120001,108,120053,108,120105,73,120157,73,120209,73,120261,73,120313,73,120365,73,120417,73,120469,73,448,73,120496,73,120554,73,120612,73,120670,73,120728,73,11410,73,1030,73,1216,73,1493,108,1503,108,1575,108,126464,108,126592,108,65166,108,65165,108,1994,108,11599,73,5825,73,42226,73,93992,73,66186,124,66313,124,119338,76,8556,76,8466,76,119819,76,119871,76,119923,76,120027,76,120079,76,120131,76,120183,76,120235,76,120287,76,120339,76,120391,76,120443,76,11472,76,5086,76,5290,76,42209,76,93974,76,71843,76,71858,76,66587,76,66854,76,65325,77,8559,77,8499,77,119820,77,119872,77,119924,77,120028,77,120080,77,120132,77,120184,77,120236,77,120288,77,120340,77,120392,77,120444,77,924,77,120499,77,120557,77,120615,77,120673,77,120731,77,1018,77,11416,77,5047,77,5616,77,5846,77,42207,77,66224,77,66321,77,119847,110,119899,110,119951,110,120003,110,120055,110,120107,110,120159,110,120211,110,120263,110,120315,110,120367,110,120419,110,120471,110,1400,110,1404,110,65326,78,8469,78,119821,78,119873,78,119925,78,119977,78,120029,78,120081,78,120185,78,120237,78,120289,78,120341,78,120393,78,120445,78,925,78,120500,78,120558,78,120616,78,120674,78,120732,78,11418,78,42208,78,66835,78,3074,111,3202,111,3330,111,3458,111,2406,111,2662,111,2790,111,3046,111,3174,111,3302,111,3430,111,3664,111,3792,111,4160,111,1637,111,1781,111,65359,111,8500,111,119848,111,119900,111,119952,111,120056,111,120108,111,120160,111,120212,111,120264,111,120316,111,120368,111,120420,111,120472,111,7439,111,7441,111,43837,111,959,111,120528,111,120586,111,120644,111,120702,111,120760,111,963,111,120532,111,120590,111,120648,111,120706,111,120764,111,11423,111,4351,111,1413,111,1505,111,1607,111,126500,111,126564,111,126596,111,65259,111,65260,111,65258,111,65257,111,1726,111,64428,111,64429,111,64427,111,64426,111,1729,111,64424,111,64425,111,64423,111,64422,111,1749,111,3360,111,4125,111,66794,111,71880,111,71895,111,66604,111,1984,79,2534,79,2918,79,12295,79,70864,79,71904,79,120782,79,120792,79,120802,79,120812,79,120822,79,130032,79,65327,79,119822,79,119874,79,119926,79,119978,79,120030,79,120082,79,120134,79,120186,79,120238,79,120290,79,120342,79,120394,79,120446,79,927,79,120502,79,120560,79,120618,79,120676,79,120734,79,11422,79,1365,79,11604,79,4816,79,2848,79,66754,79,42227,79,71861,79,66194,79,66219,79,66564,79,66838,79,9076,112,65360,112,119849,112,119901,112,119953,112,120005,112,120057,112,120109,112,120161,112,120213,112,120265,112,120317,112,120369,112,120421,112,120473,112,961,112,120530,112,120544,112,120588,112,120602,112,120646,112,120660,112,120704,112,120718,112,120762,112,120776,112,11427,112,65328,80,8473,80,119823,80,119875,80,119927,80,119979,80,120031,80,120083,80,120187,80,120239,80,120291,80,120343,80,120395,80,120447,80,929,80,120504,80,120562,80,120620,80,120678,80,120736,80,11426,80,5090,80,5229,80,42193,80,66197,80,119850,113,119902,113,119954,113,120006,113,120058,113,120110,113,120162,113,120214,113,120266,113,120318,113,120370,113,120422,113,120474,113,1307,113,1379,113,1382,113,8474,81,119824,81,119876,81,119928,81,119980,81,120032,81,120084,81,120188,81,120240,81,120292,81,120344,81,120396,81,120448,81,11605,81,119851,114,119903,114,119955,114,120007,114,120059,114,120111,114,120163,114,120215,114,120267,114,120319,114,120371,114,120423,114,120475,114,43847,114,43848,114,7462,114,11397,114,43905,114,119318,82,8475,82,8476,82,8477,82,119825,82,119877,82,119929,82,120033,82,120189,82,120241,82,120293,82,120345,82,120397,82,120449,82,422,82,5025,82,5074,82,66740,82,5511,82,42211,82,94005,82,65363,115,119852,115,119904,115,119956,115,120008,115,120060,115,120112,115,120164,115,120216,115,120268,115,120320,115,120372,115,120424,115,120476,115,42801,115,445,115,1109,115,43946,115,71873,115,66632,115,65331,83,119826,83,119878,83,119930,83,119982,83,120034,83,120086,83,120138,83,120190,83,120242,83,120294,83,120346,83,120398,83,120450,83,1029,83,1359,83,5077,83,5082,83,42210,83,94010,83,66198,83,66592,83,119853,116,119905,116,119957,116,120009,116,120061,116,120113,116,120165,116,120217,116,120269,116,120321,116,120373,116,120425,116,120477,116,8868,84,10201,84,128872,84,65332,84,119827,84,119879,84,119931,84,119983,84,120035,84,120087,84,120139,84,120191,84,120243,84,120295,84,120347,84,120399,84,120451,84,932,84,120507,84,120565,84,120623,84,120681,84,120739,84,11430,84,5026,84,42196,84,93962,84,71868,84,66199,84,66225,84,66325,84,119854,117,119906,117,119958,117,120010,117,120062,117,120114,117,120166,117,120218,117,120270,117,120322,117,120374,117,120426,117,120478,117,42911,117,7452,117,43854,117,43858,117,651,117,965,117,120534,117,120592,117,120650,117,120708,117,120766,117,1405,117,66806,117,71896,117,8746,85,8899,85,119828,85,119880,85,119932,85,119984,85,120036,85,120088,85,120140,85,120192,85,120244,85,120296,85,120348,85,120400,85,120452,85,1357,85,4608,85,66766,85,5196,85,42228,85,94018,85,71864,85,8744,118,8897,118,65366,118,8564,118,119855,118,119907,118,119959,118,120011,118,120063,118,120115,118,120167,118,120219,118,120271,118,120323,118,120375,118,120427,118,120479,118,7456,118,957,118,120526,118,120584,118,120642,118,120700,118,120758,118,1141,118,1496,118,71430,118,43945,118,71872,118,119309,86,1639,86,1783,86,8548,86,119829,86,119881,86,119933,86,119985,86,120037,86,120089,86,120141,86,120193,86,120245,86,120297,86,120349,86,120401,86,120453,86,1140,86,11576,86,5081,86,5167,86,42719,86,42214,86,93960,86,71840,86,66845,86,623,119,119856,119,119908,119,119960,119,120012,119,120064,119,120116,119,120168,119,120220,119,120272,119,120324,119,120376,119,120428,119,120480,119,7457,119,1121,119,1309,119,1377,119,71434,119,71438,119,71439,119,43907,119,71919,87,71910,87,119830,87,119882,87,119934,87,119986,87,120038,87,120090,87,120142,87,120194,87,120246,87,120298,87,120350,87,120402,87,120454,87,1308,87,5043,87,5076,87,42218,87,5742,120,10539,120,10540,120,10799,120,65368,120,8569,120,119857,120,119909,120,119961,120,120013,120,120065,120,120117,120,120169,120,120221,120,120273,120,120325,120,120377,120,120429,120,120481,120,5441,120,5501,120,5741,88,9587,88,66338,88,71916,88,65336,88,8553,88,119831,88,119883,88,119935,88,119987,88,120039,88,120091,88,120143,88,120195,88,120247,88,120299,88,120351,88,120403,88,120455,88,42931,88,935,88,120510,88,120568,88,120626,88,120684,88,120742,88,11436,88,11613,88,5815,88,42219,88,66192,88,66228,88,66327,88,66855,88,611,121,7564,121,65369,121,119858,121,119910,121,119962,121,120014,121,120066,121,120118,121,120170,121,120222,121,120274,121,120326,121,120378,121,120430,121,120482,121,655,121,7935,121,43866,121,947,121,8509,121,120516,121,120574,121,120632,121,120690,121,120748,121,1199,121,4327,121,71900,121,65337,89,119832,89,119884,89,119936,89,119988,89,120040,89,120092,89,120144,89,120196,89,120248,89,120300,89,120352,89,120404,89,120456,89,933,89,978,89,120508,89,120566,89,120624,89,120682,89,120740,89,11432,89,1198,89,5033,89,5053,89,42220,89,94019,89,71844,89,66226,89,119859,122,119911,122,119963,122,120015,122,120067,122,120119,122,120171,122,120223,122,120275,122,120327,122,120379,122,120431,122,120483,122,7458,122,43923,122,71876,122,66293,90,71909,90,65338,90,8484,90,8488,90,119833,90,119885,90,119937,90,119989,90,120041,90,120197,90,120249,90,120301,90,120353,90,120405,90,120457,90,918,90,120493,90,120551,90,120609,90,120667,90,120725,90,5059,90,42204,90,71849,90,65282,34,65284,36,65285,37,65286,38,65290,42,65291,43,65294,46,65295,47,65296,48,65297,49,65298,50,65299,51,65300,52,65301,53,65302,54,65303,55,65304,56,65305,57,65308,60,65309,61,65310,62,65312,64,65316,68,65318,70,65319,71,65324,76,65329,81,65330,82,65333,85,65334,86,65335,87,65343,95,65346,98,65348,100,65350,102,65355,107,65357,109,65358,110,65361,113,65362,114,65364,116,65365,117,65367,119,65370,122,65371,123,65373,125,119846,109],"_default":[160,32,8211,45,65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"cs":[65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"de":[65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"es":[8211,45,65374,126,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"fr":[65374,126,65306,58,65281,33,8216,96,8245,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"it":[160,32,8211,45,65374,126,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"ja":[8211,45,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65292,44,65307,59],"ko":[8211,45,65374,126,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"pl":[65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"pt-BR":[65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"qps-ploc":[160,32,8211,45,65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"ru":[65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,305,105,921,73,1009,112,215,120,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"tr":[160,32,8211,45,65374,126,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"zh-hans":[65374,126,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41],"zh-hant":[8211,45,65374,126,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65307,59]}')), xe.cache = new fi({ getCacheKey: JSON.stringify }, (e) => {
  ...
  const i = xe.ambiguousCharacterData.value;
  let a = e.filter((h) => !h.startsWith("_") && h in i);
  ...
  return new xe(c);
}), xe._locales = new Zn(() => Object.keys(xe.ambiguousCharacterData.value).filter((e) => !e.startsWith("_")));
let vt = xe;
const Ve = class Ve {
  static getRawData() {
  ...
  static containsInvisibleCharacter(e) {
    for (let n = 0; n < e.length; n++) {
      const s = e.codePointAt(n);
      if (typeof s == "number" && Ve.isInvisibleCharacter(s))
        return !0;
    }
    return !1;
  }
...
Ve._data = void 0;
let bt = Ve;
const nn = "default", Ai = "$initialize";
class yi {
  constructor(e, n, s, r, i) {
    this.vsWorker = e, this.req = n, this.channel = s, this.method = r, this.args = i, this.type = 0;
  }
}
class t1 {
  constructor(e, n, s, r) {
    this.vsWorker = e, this.seq = n, this.res = s, this.err = r, this.type = 1;
  }
}
class Ei {
  constructor(e, n, s, r, i) {
    this.vsWorker = e, this.req = n, this.channel = s, this.eventName = r, this.arg = i, this.type = 2;
  }
}
class Mi {
  constructor(e, n, s) {
    this.vsWorker = e, this.req = n, this.event = s, this.type = 3;
  }
}
class ki {
  constructor(e, n) {
...
class Pi {
  ...
  sendMessage(e, n, s) {
    ...
    return new Promise((i, a) => {
      this._pendingReplies[r] = {
        resolve: i,
        reject: a
      }, this._send(new yi(this._workerId, r, e, n, s));
    });
  }
  listen(e, n, s) {
    let r = null;
    const i = new fe({
      onWillAddFirstListener: () => {
        r = String(++this._lastSentReq), this._pendingEmitters.set(r, i), this._send(new Ei(this._workerId, r, e, n, s));
      },
      onDidRemoveLastListener: () => {
        this._pendingEmitters.delete(r), this._send(new ki(this._workerId, r)), r = null;
      }
    });
    return i.event;
  }
  ...
  createProxyToRemoteChannel(e, n) {
    const s = {
      get: (r, i) => (typeof i == "string" && !r[i] && (sr(i) ? r[i] = (a) => this.listen(e, i, a) : nr(i) ? r[i] = this.listen(e, i, void 0) : i.charCodeAt(0) === 36 && (r[i] = async (...a) => (await (n == null ? void 0 : n()), this.sendMessage(e, i, a)))), r[i])
    };
  ...
  _handleReplyMessage(e) {
    ...
    if (delete this._pendingReplies[e.seq], e.err) {
      let s = e.err;
      e.err.$isError && (s = new Error(), s.name = e.err.name, s.message = e.err.message, s.stack = e.err.stack), n.reject(s);
      return;
    }
    n.resolve(e.res);
  }
  _handleRequestMessage(e) {
    ...
    this._handler.handleMessage(e.channel, e.method, e.args).then((r) => {
      this._send(new t1(this._workerId, n, r, void 0));
    }, (r) => {
      r.detail instanceof Error && (r.detail = zn(r.detail)), this._send(new t1(this._workerId, n, void 0, zn(r)));
    });
  }
  _handleSubscribeEventMessage(e) {
    const n = e.req, s = this._handler.handleEvent(e.channel, e.eventName, e.arg)((r) => {
      this._send(new Mi(this._workerId, n, r));
    });
  ...
  _send(e) {
    ...
    if (e.type === 0)
      for (let s = 0; s < e.args.length; s++)
        e.args[s] instanceof ArrayBuffer && n.push(e.args[s]);
    else e.type === 1 && e.res instanceof ArrayBuffer && n.push(e.res);
    this._handler.sendMessage(e, n);
  }
}
function nr(t) {
  return t[0] === "o" && t[1] === "n" && tr(t.charCodeAt(2));
}
function sr(t) {
  return /^onDynamic/.test(t) && tr(t.charCodeAt(9));
}
class Ti {
  constructor(e, n) {
    this._localChannels = /* @__PURE__ */ new Map(), this._remoteChannels = /* @__PURE__ */ new Map(), this._requestHandlerFactory = n, this._requestHandler = null, this._protocol = new Pi({
      sendMessage: (s, r) => {
        e(s, r);
      },
  ...
  _handleMessage(e, n, s) {
    if (e === nn && n === Ai)
      return this.initialize(s[0], s[1], s[2]);
    const r = e === nn ? this._requestHandler : this._localChannels.get(e);
    if (!r)
...
class Me {
  constructor(e, n, s, r) {
    this.originalStart = e, this.originalLength = n, this.modifiedStart = s, this.modifiedLength = r;
  }
  getOriginalEnd() {
...
function Fi(t, e, n) {
  return new ke(new s1(t), new s1(e)).ComputeDiff(n).changes;
}
class We {
  static Assert(e, n) {
    if (!e)
...
class ze {
  static Copy(e, n, s, r, i) {
    for (let a = 0; a < i; a++)
      s[r + a] = e[n + a];
  }
  static Copy2(e, n, s, r, i) {
    for (let a = 0; a < i; a++)
      s[r + a] = e[n + a];
  }
}
...
class ke {
  constructor(e, n, s = null) {
    this.ContinueProcessingPredicate = s, this._originalSequence = e, this._modifiedSequence = n;
    const [r, i, a] = ke._getElements(e), [l, u, c] = ke._getElements(n);
    this._hasStrings = a && c, this._originalStringElements = r, this._originalElementsOrHash = i, this._modifiedStringElements = l, this._modifiedElementsOrHash = u, this.m_forwardHistory = [], this.m_reverseHistory = [];
  }
  ...
  ElementsAreStrictEqual(e, n) {
    if (!this.ElementsAreEqual(e, n))
      return !1;
    const s = ke._getStrictElement(this._originalSequence, e), r = ke._getStrictElement(this._modifiedSequence, n);
    return s === r;
  }
  ...
  _ComputeDiff(e, n, s, r, i) {
    const a = [!1];
    let l = this.ComputeDiffRecursive(e, n, s, r, a);
    return i && (l = this.PrettifyChanges(l)), {
      quitEarly: a[0],
      changes: l
    };
  }
  ComputeDiffRecursive(e, n, s, r, i) {
    for (i[0] = !1; e <= n && s <= r && this.ElementsAreEqual(e, s); )
      e++, s++;
    for (; n >= e && r >= s && this.ElementsAreEqual(n, r); )
      n--, r--;
    if (e > n || s > r) {
      let f;
      return s <= r ? (We.Assert(e === n + 1, "originalStart should only be one more than originalEnd"), f = [
        new Me(e, 0, s, r - s + 1)
      ]) : e <= n ? (We.Assert(s === r + 1, "modifiedStart should only be one more than modifiedEnd"), f = [
        new Me(e, n - e + 1, s, 0)
      ]) : (We.Assert(e === n + 1, "originalStart should only be one more than originalEnd"), We.Assert(s === r + 1, "modifiedStart should only be one more than modifiedEnd"), f = []), f;
    }
    const a = [0], l = [0], u = this.ComputeRecursionPoint(e, n, s, r, a, l, i), c = a[0], h = l[0];
    if (u !== null)
      return u;
    if (!i[0]) {
      const f = this.ComputeDiffRecursive(e, c, s, h, i);
      let d = [];
      return i[0] ? d = [
        new Me(
          c + 1,
  ...
  WALKTRACE(e, n, s, r, i, a, l, u, c, h, f, d, m, g, b, w, L, _) {
    let v = null, p = null, x = new r1(), C = n, R = s, M = m[0] - w[0] - r, U = -1073741824, J = this.m_forwardHistory.length - 1;
    do {
      const $ = M + e;
      $ === C || $ < R && c[$ - 1] < c[$ + 1] ? (f = c[$ + 1], g = f - M - r, f < U && x.MarkNextChange(), U = f, x.AddModifiedElement(f + 1, g), M = $ + 1 - e) : (f = c[$ - 1] + 1, g = f - M - r, f < U && x.MarkNextChange(), U = f - 1, x.AddOriginalElement(f, g + 1), M = $ - 1 - e), J >= 0 && (c = this.m_forwardHistory[J], e = c[0], C = 1, R = c.length - 1);
    } while (--J >= -1);
    if (v = x.getReverseChanges(), _[0]) {
      let $ = m[0] + 1, D = w[0] + 1;
      if (v !== null && v.length > 0) {
        const S = v[v.length - 1];
        $ = Math.max($, S.getOriginalEnd()), D = Math.max(D, S.getModifiedEnd());
      }
      p = [
        new Me(
          $,
      ...
      x = new r1(), C = a, R = l, M = m[0] - w[0] - u, U = 1073741824, J = L ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2;
      do {
        const $ = M + i;
        $ === C || $ < R && h[$ - 1] >= h[$ + 1] ? (f = h[$ + 1] - 1, g = f - M - u, f > U && x.MarkNextChange(), U = f + 1, x.AddOriginalElement(f + 1, g + 1), M = $ + 1 - i) : (f = h[$ - 1], g = f - M - u, f > U && x.MarkNextChange(), U = f, x.AddModifiedElement(f + 1, g + 1), M = $ - 1 - i), J >= 0 && (h = this.m_reverseHistory[J], i = h[0], C = 1, R = h.length - 1);
      } while (--J >= -1);
      p = x.getChanges();
    }
    return this.ConcatenateChanges(v, p);
  }
  ComputeRecursionPoint(e, n, s, r, i, a, l) {
    let u = 0, c = 0, h = 0, f = 0, d = 0, m = 0;
    e--, s--, i[0] = 0, a[0] = 0, this.m_forwardHistory = [], this.m_reverseHistory = [];
    const g = n - e + (r - s), b = g + 1, w = new Int32Array(b), L = new Int32Array(b), _ = r - s, v = n - e, p = e - s, x = n - r, R = (v - _) % 2 === 0;
    w[_] = e, L[v] = n, l[0] = !1;
    for (let M = 1; M <= g / 2 + 1; M++) {
      let U = 0, J = 0;
      h = this.ClipDiagonalBound(_ - M, M, _, b), f = this.ClipDiagonalBound(_ + M, M, _, b);
      for (let D = h; D <= f; D += 2) {
        D === h || D < f && w[D - 1] < w[D + 1] ? u = w[D + 1] : u = w[D - 1] + 1, c = u - (D - _) - p;
        const S = u;
        for (; u < n && c < r && this.ElementsAreEqual(u + 1, c + 1); )
          u++, c++;
        if (w[D] = u, u + c > U + J && (U = u, J = c), !R && Math.abs(D - v) <= M - 1 && u >= L[D])
          return i[0] = u, a[0] = c, S <= L[D] && M <= 1448 ? this.WALKTRACE(_, h, f, p, v, d, m, x, w, L, u, n, i, c, r, a, R, l) : null;
      }
      const $ = (U - e + (J - s) - M) / 2;
      if (this.ContinueProcessingPredicate !== null && !this.ContinueProcessingPredicate(U, $))
        return l[0] = !0, i[0] = U, a[0] = J, $ > 0 && M <= 1448 ? this.WALKTRACE(_, h, f, p, v, d, m, x, w, L, u, n, i, c, r, a, R, l) : (e++, s++, [
          new Me(
            e,
            n - e + 1,
            s,
      ...
      d = this.ClipDiagonalBound(v - M, M, v, b), m = this.ClipDiagonalBound(v + M, M, v, b);
      for (let D = d; D <= m; D += 2) {
        D === d || D < m && L[D - 1] >= L[D + 1] ? u = L[D + 1] - 1 : u = L[D - 1], c = u - (D - v) - x;
        const S = u;
        for (; u > e && c > s && this.ElementsAreEqual(u, c); )
          u--, c--;
        if (L[D] = u, R && Math.abs(D - _) <= M && u <= w[D])
          return i[0] = u, a[0] = c, S >= w[D] && M <= 1448 ? this.WALKTRACE(_, h, f, p, v, d, m, x, w, L, u, n, i, c, r, a, R, l) : null;
      }
      if (M <= 1447) {
        let D = new Int32Array(f - h + 2);
        D[0] = _ - h + 1, ze.Copy2(w, h, D, 1, f - h + 1), this.m_forwardHistory.push(D), D = new Int32Array(m - d + 2), D[0] = v - d + 1, ze.Copy2(L, d, D, 1, m - d + 1), this.m_reverseHistory.push(D);
      }
    }
    return this.WALKTRACE(_, h, f, p, v, d, m, x, w, L, u, n, i, c, r, a, R, l);
  }
  PrettifyChanges(e) {
    for (let n = 0; n < e.length; n++) {
      const s = e[n], r = n < e.length - 1 ? e[n + 1].originalStart : this._originalElementsOrHash.length, i = n < e.length - 1 ? e[n + 1].modifiedStart : this._modifiedElementsOrHash.length, a = s.originalLength > 0, l = s.modifiedLength > 0;
      for (; s.originalStart + s.originalLength < r && s.modifiedStart + s.modifiedLength < i && (!a || this.OriginalElementsAreEqual(s.originalStart, s.originalStart + s.originalLength)) && (!l || this.ModifiedElementsAreEqual(s.modifiedStart, s.modifiedStart + s.modifiedLength)); ) {
    ...
    for (let n = e.length - 1; n >= 0; n--) {
      ...
      for (let f = 1; ; f++) {
        ...
        if (d < r || m < i || a && !this.OriginalElementsAreEqual(d, d + s.originalLength) || l && !this.ModifiedElementsAreEqual(m, m + s.modifiedLength))
          break;
    ...
    if (this._hasStrings)
      for (let n = 1, s = e.length; n < s; n++) {
        const r = e[n - 1], i = e[n], a = i.originalStart - r.originalStart - r.originalLength, l = r.originalStart, u = i.originalStart + i.originalLength, c = u - l, h = r.modifiedStart, f = i.modifiedStart + i.modifiedLength, d = f - h;
        if (a < 5 && c < 20 && d < 20) {
          const m = this._findBetterContiguousSequence(l, c, h, d, a);
          if (m) {
            const [g, b] = m;
            (g !== r.originalStart + r.originalLength || b !== r.modifiedStart + r.modifiedLength) && (r.originalLength = g - r.originalStart, r.modifiedLength = b - r.modifiedStart, i.originalStart = g + a, i.modifiedStart = b + a, i.originalLength = u - i.originalStart, i.modifiedLength = f - i.modifiedStart);
          }
        }
      }
    return e;
  }
  _findBetterContiguousSequence(e, n, s, r, i) {
    if (n < i || r < i)
      return null;
    const a = e + n - i + 1, l = s + r - i + 1;
    let u = 0, c = 0, h = 0;
    for (let f = e; f < a; f++)
      for (let d = s; d < l; d++) {
  ...
  _contiguousSequenceScore(e, n, s) {
    let r = 0;
    for (let i = 0; i < s; i++) {
  ...
  _boundaryScore(e, n, s, r) {
    const i = this._OriginalRegionIsBoundary(e, n) ? 1 : 0, a = this._ModifiedRegionIsBoundary(s, r) ? 1 : 0;
    return i + a;
  }
  ConcatenateChanges(e, n) {
    ...
    if (this.ChangesOverlap(e[e.length - 1], n[0], s)) {
      const r = new Array(e.length + n.length - 1);
      return ze.Copy(e, 0, r, 0, e.length - 1), r[e.length - 1] = s[0], ze.Copy(n, 1, r, e.length, n.length - 1), r;
    } else {
      const r = new Array(e.length + n.length);
      return ze.Copy(e, 0, r, 0, e.length), ze.Copy(n, 0, r, e.length, n.length), r;
    }
  }
  ChangesOverlap(e, n, s) {
    if (We.Assert(e.originalStart <= n.originalStart, "Left change is not less than or equal to right change"), We.Assert(e.modifiedStart <= n.modifiedStart, "Left change is not less than or equal to right change"), e.originalStart + e.originalLength >= n.originalStart || e.modifiedStart + e.modifiedLength >= n.modifiedStart) {
      const r = e.originalStart;
      let i = e.originalLength;
      const a = e.modifiedStart;
      let l = e.modifiedLength;
      return e.originalStart + e.originalLength >= n.originalStart && (i = n.originalStart + n.originalLength - e.originalStart), e.modifiedStart + e.modifiedLength >= n.modifiedStart && (l = n.modifiedStart + n.modifiedLength - e.modifiedStart), s[0] = new Me(r, i, a, l), !0;
    } else
      return s[0] = null, !1;
  }
  ClipDiagonalBound(e, n, s, r) {
    if (e >= 0 && e < r)
      return e;
    const i = s, a = r - s - 1, l = n % 2 === 0;
    if (e < 0) {
      const u = i % 2 === 0;
      return l === u ? 0 : 1;
    } else {
...
class q {
  ...
  static compare(e, n) {
    const s = e.lineNumber | 0, r = n.lineNumber | 0;
    if (s === r) {
      const i = e.column | 0, a = n.column | 0;
      return i - a;
    }
    return s - r;
  }
...
class A {
  constructor(e, n, s, r) {
    e > s || e === s && n > r ? (this.startLineNumber = s, this.startColumn = r, this.endLineNumber = e, this.endColumn = n) : (this.startLineNumber = e, this.startColumn = n, this.endLineNumber = s, this.endColumn = r);
  }
  isEmpty() {
  ...
  containsPosition(e) {
    return A.containsPosition(this, e);
  }
  ...
  strictContainsRange(e) {
    return A.strictContainsRange(this, e);
  }
  static strictContainsRange(e, n) {
    return !(n.startLineNumber < e.startLineNumber || n.endLineNumber < e.startLineNumber || n.startLineNumber > e.endLineNumber || n.endLineNumber > e.endLineNumber || n.startLineNumber === e.startLineNumber && n.startColumn <= e.startColumn || n.endLineNumber === e.endLineNumber && n.endColumn >= e.endColumn);
  }
  plusRange(e) {
    return A.plusRange(this, e);
  }
  static plusRange(e, n) {
    let s, r, i, a;
    return n.startLineNumber < e.startLineNumber ? (s = n.startLineNumber, r = n.startColumn) : n.startLineNumber === e.startLineNumber ? (s = n.startLineNumber, r = Math.min(n.startColumn, e.startColumn)) : (s = e.startLineNumber, r = e.startColumn), n.endLineNumber > e.endLineNumber ? (i = n.endLineNumber, a = n.endColumn) : n.endLineNumber === e.endLineNumber ? (i = n.endLineNumber, a = Math.max(n.endColumn, e.endColumn)) : (i = e.endLineNumber, a = e.endColumn), new A(s, r, i, a);
  }
  intersectRanges(e) {
    return A.intersectRanges(this, e);
  }
  static intersectRanges(e, n) {
    let s = e.startLineNumber, r = e.startColumn, i = e.endLineNumber, a = e.endColumn;
    const l = n.startLineNumber, u = n.startColumn, c = n.endLineNumber, h = n.endColumn;
    return s < l ? (s = l, r = u) : s === l && (r = Math.max(r, u)), i > c ? (i = c, a = h) : i === c && (a = Math.min(a, h)), s > i || s === i && r > a ? null : new A(
      s,
      r,
      i,
      a
  ...
  setEndPosition(e, n) {
    return new A(this.startLineNumber, this.startColumn, e, n);
  }
  setStartPosition(e, n) {
    return new A(e, n, this.endLineNumber, this.endColumn);
  }
  collapseToStart() {
  ...
  static collapseToEnd(e) {
    return new A(e.endLineNumber, e.endColumn, e.endLineNumber, e.endColumn);
  }
  delta(e) {
    return new A(
  ...
  static fromPositions(e, n = e) {
    return new A(e.lineNumber, e.column, n.lineNumber, n.column);
  }
  static lift(e) {
    return e ? new A(
      e.startLineNumber,
  ...
  static compareRangesUsingStarts(e, n) {
    if (e && n) {
      const i = e.startLineNumber | 0, a = n.startLineNumber | 0;
      if (i === a) {
        const l = e.startColumn | 0, u = n.startColumn | 0;
        if (l === u) {
          const c = e.endLineNumber | 0, h = n.endLineNumber | 0;
          if (c === h) {
            const f = e.endColumn | 0, d = n.endColumn | 0;
            return f - d;
          }
          return c - h;
        }
...
class Vn {
  constructor(e) {
    const n = i1(e);
    this._defaultValue = n, this._asciiMap = Vn._createAsciiMap(n), this._map = /* @__PURE__ */ new Map();
  }
  ...
  set(e, n) {
    const s = i1(n);
    e >= 0 && e < 256 ? this._asciiMap[e] = s : this._map.set(e, s);
  }
  get(e) {
...
function qi() {
  if (ut === null) {
    ...
    const t = ` 	<>'"、。｡､，．：；‘〈「『〔（［｛｢｣｝］）〕』」〉’｀～…`;
    for (let n = 0; n < t.length; n++)
      ut.set(t.charCodeAt(n), 1);
    const e = ".,;:";
    for (let n = 0; n < e.length; n++)
      ut.set(e.charCodeAt(n), 2);
  }
  return ut;
}
class Ut {
  static _createLink(e, n, s, r, i) {
    let a = i - 1;
    do {
  ...
  static computeLinks(e, n = Bi()) {
    ...
    for (let i = 1, a = e.getLineCount(); i <= a; i++) {
      ...
      let c = 0, h = 0, f = 0, d = 1, m = !1, g = !1, b = !1, w = !1;
      for (; c < u; ) {
        let L = !1;
        ...
        if (d === 13) {
          ...
          switch (_) {
            ...
            case 34:
            case 96:
              f === _ ? v = 1 : f === 39 || f === 34 || f === 96 ? v = 0 : v = 1;
              break;
            case 42:
              v = f === 42 ? 1 : 0;
              break;
          ...
          v === 1 && (r.push(Ut._createLink(s, l, i, h, c)), L = !0);
        } else if (d === 12) {
          let v;
          _ === 91 ? (g = !0, v = 0) : v = s.get(_), v === 1 ? L = !0 : d = 13;
        } else
          d = n.nextState(d, _), d === 0 && (L = !0);
        L && (d = 1, m = !1, g = !1, w = !1, h = c + 1, f = _), c++;
      }
      d === 13 && r.push(Ut._createLink(s, l, i, h, u));
    }
    return r;
  }
}
function Ui(t) {
  return !t || typeof t.getLineCount != "function" || typeof t.getLineContent != "function" ? [] : Ut.computeLinks(t);
}
const Yt = class Yt {
  constructor() {
  ...
  navigateValueSet(e, n, s, r, i) {
    ...
    if (s && r) {
      const a = this.doNavigateValueSet(r, i);
      if (a)
        return {
          range: s,
          value: a
  ...
  doNavigateValueSet(e, n) {
    const s = this.numberReplace(e, n);
    return s !== null ? s : this.textReplace(e, n);
  }
  numberReplace(e, n) {
    const s = Math.pow(10, e.length - (e.lastIndexOf(".") + 1));
    let r = Number(e);
  ...
  valueSetsReplace(e, n, s) {
    let r = null;
    for (let i = 0, a = e.length; r === null && i < a; i++)
      r = this.valueSetReplace(e[i], n, s);
    return r;
  }
  valueSetReplace(e, n, s) {
    let r = e.indexOf(n);
    return r >= 0 ? (r += s ? 1 : -1, r < 0 ? r = e.length - 1 : r %= e.length, e[r]) : null;
  }
};
Yt.INSTANCE = new Yt();
let xn = Yt;
...
const Tt = new Bn(), wn = new Bn(), _n = new Bn(), $i = new Array(230), Hi = /* @__PURE__ */ Object.create(null), Wi = /* @__PURE__ */ Object.create(null);
(function() {
  const t = "", e = [
  ...
  for (const r of e) {
    const [i, a, l, u, c, h, f, d, m] = r;
    if (s[a] || (s[a] = !0, Hi[l] = a, Wi[l.toLowerCase()] = a), !n[u]) {
      if (n[u] = !0, !c)
        throw new Error(
          `String representation missing for key code ${u} around scan code ${l}`
        );
      Tt.define(u, c), wn.define(u, d || c), _n.define(u, m || d || c);
    }
    h && ($i[h] = u);
  }
})();
...
(function(t) {
  function e(l) {
    return Tt.keyCodeToStr(l);
  }
  t.toString = e;
  function n(l) {
    return Tt.strToKeyCode(l);
  }
  t.fromString = n;
  function s(l) {
    return wn.keyCodeToStr(l);
  }
  t.toUserSettingsUS = s;
  function r(l) {
    return _n.keyCodeToStr(l);
  }
  t.toUserSettingsGeneral = r;
  function i(l) {
    return wn.strToKeyCode(l) || _n.strToKeyCode(l);
  }
...
let Ue;
const rn = globalThis.vscode;
var Xs;
if (typeof rn < "u" && typeof rn.process < "u") {
  const t = rn.process;
  Ue = {
    get platform() {
      return t.platform;
...
} else typeof process < "u" && typeof ((Xs = process == null ? void 0 : process.versions) == null ? void 0 : Xs.node) == "string" ? Ue = {
  get platform() {
  ...
  get platform() {
    return ot ? "win32" : si ? "darwin" : "linux";
  },
  get arch() {
  },
  get env() {
...
function ye(t) {
  return t >= Gi && t <= Qi || t >= Xi && t <= Yi;
}
function Ht(t, e, n, s) {
  let r = "", i = 0, a = -1, l = 0, u = 0;
  for (let c = 0; c <= t.length; ++c) {
    ...
    if (s(u)) {
      if (!(a === c - 1 || l === 1)) if (l === 2) {
        if (r.length < 2 || i !== 2 || r.charCodeAt(r.length - 1) !== Pe || r.charCodeAt(r.length - 2) !== Pe) {
          if (r.length > 2) {
            const h = r.lastIndexOf(n);
            h === -1 ? (r = "", i = 0) : (r = r.slice(0, h), i = r.length - 1 - r.lastIndexOf(n)), a = c, l = 0;
            continue;
          } else if (r.length !== 0) {
            r = "", i = 0, a = c, l = 0;
            continue;
        ...
        e && (r += r.length > 0 ? `${n}..` : "..", i = 2);
      } else
        r.length > 0 ? r += `${n}${t.slice(a + 1, c)}` : r = t.slice(a + 1, c), i = c - a - 1;
      a = c, l = 0;
    } else u === Pe && l !== -1 ? ++l : l = -1;
  }
  return r;
...
function ir(t, e) {
  Zi(e, "pathObject");
  const n = e.dir || e.root, s = e.base || `${e.name || ""}${Ki(e.ext)}`;
...
const Z = {
  resolve(...t) {
    ...
    for (let r = t.length - 1; r >= -1; r--) {
      let i;
      if (r >= 0) {
        if (i = t[r], Y(i, `paths[${r}]`), i.length === 0)
          continue;
      } else e.length === 0 ? i = $t() : (i = Oi[`=${e}`] || $t(), (i === void 0 || i.slice(0, 2).toLowerCase() !== e.toLowerCase() && i.charCodeAt(2) === le) && (i = `${e}\\`));
      const a = i.length;
      let l = 0, u = "", c = !1;
      ...
      if (a === 1)
        ...
        if (c = !0, F(i.charCodeAt(1))) {
          let f = 2, d = f;
          for (; f < a && !F(i.charCodeAt(f)); )
            f++;
          if (f < a && f !== d) {
            const m = i.slice(d, f);
            for (d = f; f < a && F(i.charCodeAt(f)); )
              f++;
            if (f < a && f !== d) {
              for (d = f; f < a && !F(i.charCodeAt(f)); )
                f++;
              (f === a || f !== d) && (u = `\\\\${m}\\${i.slice(d, f)}`, l = f);
            }
          }
        } else
          l = 1;
      else ye(h) && i.charCodeAt(1) === Ae && (u = i.slice(0, 2), l = 2, a > 2 && F(i.charCodeAt(2)) && (c = !0, l = 3));
      if (u.length > 0)
        if (e.length > 0) {
      ...
      if (s) {
        if (e.length > 0)
          break;
      } else if (n = `${i.slice(l)}\\${n}`, s = c, c && e.length > 0)
        break;
    }
    return n = Ht(n, !s, "\\", F), s ? `${e}\\${n}` : `${e}${n}` || ".";
  },
  normalize(t) {
    Y(t, "path");
    const e = t.length;
      ...
      if (r = !0, F(t.charCodeAt(1))) {
        ...
        if (l < e && l !== u) {
          ...
          if (l < e && l !== u) {
            ...
            if (l === e)
              return `\\\\${c}\\${t.slice(u)}\\`;
            l !== u && (s = `\\\\${c}\\${t.slice(u, l)}`, n = l);
          }
        }
      } else
        n = 1;
    else ye(i) && t.charCodeAt(1) === Ae && (s = t.slice(0, 2), n = 2, e > 2 && F(t.charCodeAt(2)) && (r = !0, n = 3));
    let a = n < e ? Ht(t.slice(n), !r, "\\", F) : "";
    return a.length === 0 && !r && (a = "."), a.length > 0 && F(t.charCodeAt(e - 1)) && (a += "\\"), s === void 0 ? r ? `\\${a}` : a : r ? `${s}\\${a}` : `${s}${a}`;
  },
  isAbsolute(t) {
    Y(t, "path");
    const e = t.length;
    ...
    return F(n) || e > 2 && ye(n) && t.charCodeAt(1) === Ae && F(t.charCodeAt(2));
  },
  join(...t) {
    if (t.length === 0)
      return ".";
    ...
    for (let i = 0; i < t.length; ++i) {
      const a = t[i];
      Y(a, "path"), a.length > 0 && (e === void 0 ? e = n = a : e += `\\${a}`);
    }
    if (e === void 0)
      return ".";
    let s = !0, r = 0;
    if (typeof n == "string" && F(n.charCodeAt(0))) {
      ++r;
      const i = n.length;
      i > 1 && F(n.charCodeAt(1)) && (++r, i > 2 && (F(n.charCodeAt(2)) ? ++r : s = !1));
    }
    if (s) {
      for (; r < e.length && F(e.charCodeAt(r)); )
        r++;
      r >= 2 && (e = `\\${e.slice(r)}`);
    }
  ...
  relative(t, e) {
    if (Y(t, "from"), Y(e, "to"), t === e)
      return "";
    const n = Z.resolve(t), s = Z.resolve(e);
    if (n === s || (t = n.toLowerCase(), e = s.toLowerCase(), t === e))
      return "";
    let r = 0;
    for (; r < t.length && t.charCodeAt(r) === le; )
      r++;
    let i = t.length;
    for (; i - 1 > r && t.charCodeAt(i - 1) === le; )
      i--;
    const a = i - r;
    let l = 0;
    for (; l < e.length && e.charCodeAt(l) === le; )
      l++;
    let u = e.length;
    for (; u - 1 > l && e.charCodeAt(u - 1) === le; )
      u--;
    const c = u - l, h = a < c ? a : c;
    let f = -1, d = 0;
    for (; d < h; d++) {
      const g = t.charCodeAt(r + d);
      if (g !== e.charCodeAt(l + d))
        break;
      g === le && (f = d);
    }
    if (d !== h) {
      ...
      if (c > h) {
        if (e.charCodeAt(l + d) === le)
          return s.slice(l + d + 1);
        if (d === 2)
          return s.slice(l + d);
      }
      a > h && (t.charCodeAt(r + d) === le ? f = d : d === 2 && (f = 3)), f === -1 && (f = 0);
    }
    let m = "";
    for (d = r + f + 1; d <= i; ++d)
      (d === i || t.charCodeAt(d) === le) && (m += m.length === 0 ? ".." : "\\..");
    return l += f, m.length > 0 ? `${m}${s.slice(l, u)}` : (s.charCodeAt(l) === le && ++l, s.slice(l, u));
  },
  toNamespacedPath(t) {
    ...
    if (e.length <= 2)
      return t;
    if (e.charCodeAt(0) === le) {
      if (e.charCodeAt(1) === le) {
        const n = e.charCodeAt(2);
        if (n !== Ji && n !== Pe)
          return `\\\\?\\UNC\\${e.slice(2)}`;
      }
    } else if (ye(e.charCodeAt(0)) && e.charCodeAt(1) === Ae && e.charCodeAt(2) === le)
      return `\\\\?\\${e}`;
    return t;
  },
  dirname(t) {
    ...
    } else ye(r) && t.charCodeAt(1) === Ae && (n = e > 2 && F(t.charCodeAt(2)) ? 3 : 2, s = n);
    let i = -1, a = !0;
    for (let l = e - 1; l >= s; --l)
      if (F(t.charCodeAt(l))) {
        if (!a) {
  ...
  basename(t, e) {
    ...
    let n = 0, s = -1, r = !0, i;
    if (t.length >= 2 && ye(t.charCodeAt(0)) && t.charCodeAt(1) === Ae && (n = 2), e !== void 0 && e.length > 0 && e.length <= t.length) {
      if (e === t)
        return "";
      let a = e.length - 1, l = -1;
      for (i = t.length - 1; i >= n; --i) {
        ...
        if (F(u)) {
          ...
          l === -1 && (r = !1, l = i + 1), a >= 0 && (u === e.charCodeAt(a) ? --a === -1 && (s = i) : (a = -1, s = l));
      }
      return n === s ? s = l : s === -1 && (s = t.length), t.slice(n, s);
    }
    for (i = t.length - 1; i >= n; --i)
      if (F(t.charCodeAt(i))) {
        if (!r) {
  ...
  extname(t) {
    Y(t, "path");
    let e = 0, n = -1, s = 0, r = -1, i = !0, a = 0;
    t.length >= 2 && t.charCodeAt(1) === Ae && ye(t.charCodeAt(0)) && (e = s = 2);
    for (let l = t.length - 1; l >= e; --l) {
      ...
      r === -1 && (i = !1, r = l + 1), u === Pe ? n === -1 ? n = l : a !== 1 && (a = 1) : n !== -1 && (a = -1);
    }
    return n === -1 || r === -1 || a === 0 || a === 1 && n === r - 1 && n === s + 1 ? "" : t.slice(n, r);
  },
  format: ir.bind(null, "\\"),
  parse(t) {
    Y(t, "path");
    ...
    if (t.length === 0)
      return e;
    const n = t.length;
    let s = 0, r = t.charCodeAt(0);
    if (n === 1)
      return F(r) ? (e.root = e.dir = t, e) : (e.base = e.name = t, e);
    if (F(r)) {
      if (s = 1, F(t.charCodeAt(1))) {
        let f = 2, d = f;
        for (; f < n && !F(t.charCodeAt(f)); )
          f++;
        if (f < n && f !== d) {
          for (d = f; f < n && F(t.charCodeAt(f)); )
            f++;
          if (f < n && f !== d) {
            for (d = f; f < n && !F(t.charCodeAt(f)); )
              f++;
    ...
    } else if (ye(r) && t.charCodeAt(1) === Ae) {
      if (n <= 2)
        return e.root = e.dir = t, e;
      if (s = 2, F(t.charCodeAt(2))) {
        if (n === 3)
          return e.root = e.dir = t, e;
        s = 3;
      }
    ...
    let i = -1, a = s, l = -1, u = !0, c = t.length - 1, h = 0;
    for (; c >= s; --c) {
      if (r = t.charCodeAt(c), F(r)) {
        if (!u) {
          a = c + 1;
          break;
        }
      ...
      l === -1 && (u = !1, l = c + 1), r === Pe ? i === -1 ? i = c : h !== 1 && (h = 1) : i !== -1 && (h = -1);
    }
    return l !== -1 && (i === -1 || h === 0 || h === 1 && i === l - 1 && i === a + 1 ? e.base = e.name = t.slice(a, l) : (e.name = t.slice(a, i), e.base = t.slice(a, l), e.ext = t.slice(i, l))), a > 0 && a !== s ? e.dir = t.slice(0, a - 1) : e.dir = e.root, e;
  },
  sep: "\\",
  delimiter: ";",
  win32: null,
  ...
  resolve(...t) {
    ...
    for (let s = t.length - 1; s >= -1 && !n; s--) {
      const r = s >= 0 ? t[s] : ea();
      Y(r, `paths[${s}]`), r.length !== 0 && (e = `${r}/${e}`, n = r.charCodeAt(0) === ee);
    }
    return e = Ht(e, !n, "/", Ln), n ? `/${e}` : e.length > 0 ? e : ".";
  },
  normalize(t) {
    if (Y(t, "path"), t.length === 0)
      return ".";
    const e = t.charCodeAt(0) === ee, n = t.charCodeAt(t.length - 1) === ee;
    return t = Ht(t, !e, "/", Ln), t.length === 0 ? e ? "/" : n ? "./" : "." : (n && (t += "/"), e ? `/${t}` : t);
  },
  isAbsolute(t) {
    return Y(t, "path"), t.length > 0 && t.charCodeAt(0) === ee;
  },
  join(...t) {
    if (t.length === 0)
      return ".";
    ...
    for (let n = 0; n < t.length; ++n) {
      const s = t[n];
      Y(s, "path"), s.length > 0 && (e === void 0 ? e = s : e += `/${s}`);
    }
    return e === void 0 ? "." : z.normalize(e);
  },
  relative(t, e) {
    if (Y(t, "from"), Y(e, "to"), t === e || (t = z.resolve(t), e = z.resolve(e), t === e))
      return "";
    const n = 1, s = t.length, r = s - n, i = 1, a = e.length - i, l = r < a ? r : a;
    let u = -1, c = 0;
    for (; c < l; c++) {
      const f = t.charCodeAt(n + c);
      if (f !== e.charCodeAt(i + c))
        break;
      f === ee && (u = c);
    }
    if (c === l)
      if (a > l) {
        if (e.charCodeAt(i + c) === ee)
          return e.slice(i + c + 1);
        if (c === 0)
          return e.slice(i + c);
      } else r > l && (t.charCodeAt(n + c) === ee ? u = c : c === 0 && (u = 0));
    let h = "";
    for (c = n + u + 1; c <= s; ++c)
      (c === s || t.charCodeAt(c) === ee) && (h += h.length === 0 ? ".." : "/..");
  ...
  dirname(t) {
    if (Y(t, "path"), t.length === 0)
      return ".";
    const e = t.charCodeAt(0) === ee;
    let n = -1, s = !0;
    for (let r = t.length - 1; r >= 1; --r)
      if (t.charCodeAt(r) === ee) {
        if (!s) {
          n = r;
          break;
        }
  ...
  extname(t) {
    ...
    for (let a = t.length - 1; a >= 0; --a) {
      ...
      s === -1 && (r = !1, s = a + 1), l === Pe ? e === -1 ? e = a : i !== 1 && (i = 1) : e !== -1 && (i = -1);
    }
  ...
  parse(t) {
    ...
    if (t.length === 0)
      return e;
    const n = t.charCodeAt(0) === ee;
    let s;
    n ? (e.root = "/", s = 1) : s = 0;
    let r = -1, i = 0, a = -1, l = !0, u = t.length - 1, c = 0;
    for (; u >= s; --u) {
      ...
      a === -1 && (l = !1, a = u + 1), h === Pe ? r === -1 ? r = u : c !== 1 && (c = 1) : r !== -1 && (c = -1);
    }
    if (a !== -1) {
      const h = i === 0 && n ? 1 : i;
      r === -1 || c === 0 || c === 1 && r === a - 1 && r === i + 1 ? e.base = e.name = t.slice(h, a) : (e.name = t.slice(h, r), e.base = t.slice(h, a), e.ext = t.slice(r, a));
    }
...
z.win32 = Z.win32 = Z;
z.posix = Z.posix = z;
const ta = ge ? Z.normalize : z.normalize;
ge ? Z.isAbsolute : z.isAbsolute;
const na = ge ? Z.join : z.join, sa = ge ? Z.resolve : z.resolve, ra = ge ? Z.relative : z.relative, ia = ge ? Z.dirname : z.dirname;
ge ? Z.basename : z.basename;
ge ? Z.extname : z.extname;
ge ? Z.parse : z.parse;
const Dt = ge ? Z.sep : z.sep;
ge ? Z.delimiter : z.delimiter;
const aa = /^\w[\w\d+.-]*$/, oa = /^\//, la = /^\/\//;
function ua(t, e) {
  if (!t.scheme && e)
    throw new Error(
      `[UriError]: Scheme is missing: {scheme: "", authority: "${t.authority}", path: "${t.path}", query: "${t.query}", fragment: "${t.fragment}"}`
    );
  if (t.scheme && !aa.test(t.scheme))
...
class te {
  ...
  constructor(e, n, s, r, i, a = !1) {
    typeof e == "object" ? (this.scheme = e.scheme || O, this.authority = e.authority || O, this.path = e.path || O, this.query = e.query || O, this.fragment = e.fragment || O) : (this.scheme = ca(e, a), this.authority = n || O, this.path = ha(this.scheme, s || O), this.query = r || O, this.fragment = i || O, ua(this, a));
  }
  get fsPath() {
    return Wt(this, !1);
  }
  with(e) {
    if (!e)
      return this;
    let { scheme: n, authority: s, path: r, query: i, fragment: a } = e;
    return n === void 0 ? n = this.scheme : n === null && (n = O), s === void 0 ? s = this.authority : s === null && (s = O), r === void 0 ? r = this.path : r === null && (r = O), i === void 0 ? i = this.query : i === null && (i = O), a === void 0 ? a = this.fragment : a === null && (a = O), n === this.scheme && s === this.authority && r === this.path && i === this.query && a === this.fragment ? this : new je(n, s, r, i, a);
  }
  static parse(e, n = !1) {
    const s = fa.exec(e);
    return s ? new je(
  ...
  static file(e) {
    let n = O;
    if (ot && (e = e.replace(/\\/g, pe)), e[0] === pe && e[1] === pe) {
      const s = e.indexOf(pe, 2);
      s === -1 ? (n = e.substring(2), e = pe) : (n = e.substring(2, s), e = e.substring(s) || pe);
    }
    return new je("file", n, e, O, O);
  }
  static from(e, n) {
    return new je(
      e.scheme,
  ...
  static joinPath(e, ...n) {
    ...
    let s;
    return ot && e.scheme === "file" ? s = te.file(Z.join(Wt(e, !0), ...n)).path : s = z.join(e.path, ...n), e.with({ path: s });
  }
  toString(e = !1) {
    return vn(this, e);
  }
  ...
  static revive(e) {
    if (e) {
      ...
      {
        const n = new je(e);
        return n._formatted = e.external ?? null, n._fsPath = e._sep === ar ? e.fsPath ?? null : null, n;
      }
    } else return e;
  }
...
class je extends te {
  ...
  toString(e = !1) {
    return e ? vn(this, !0) : (this._formatted || (this._formatted = vn(this, !1)), this._formatted);
  }
  toJSON() {
    const e = {
      $mid: 1
    };
    return this._fsPath && (e.fsPath = this._fsPath, e._sep = ar), this._formatted && (e.external = this._formatted), this.path && (e.path = this.path), this.scheme && (e.scheme = this.scheme), this.authority && (e.authority = this.authority), this.query && (e.query = this.query), this.fragment && (e.fragment = this.fragment), e;
  }
}
const or = {
  58: "%3A",
...
function o1(t, e, n) {
  ...
  for (let i = 0; i < t.length; i++) {
    ...
    if (a >= 97 && a <= 122 || a >= 65 && a <= 90 || a >= 48 && a <= 57 || a === 45 || a === 46 || a === 95 || a === 126 || e && a === 47 || n && a === 91 || n && a === 93 || n && a === 58)
      r !== -1 && (s += encodeURIComponent(t.substring(r, i)), r = -1), s !== void 0 && (s += t.charAt(i));
    else {
      s === void 0 && (s = t.substr(0, i));
      const l = or[a];
      l !== void 0 ? (r !== -1 && (s += encodeURIComponent(t.substring(r, i)), r = -1), s += l) : r === -1 && (r = i);
    }
  }
...
function da(t) {
  ...
  for (let n = 0; n < t.length; n++) {
    const s = t.charCodeAt(n);
    s === 35 || s === 63 ? (e === void 0 && (e = t.substr(0, n)), e += or[s]) : e !== void 0 && (e += t[n]);
  }
  return e !== void 0 ? e : t;
}
function Wt(t, e) {
  let n;
  return t.authority && t.path.length > 1 && t.scheme === "file" ? n = `//${t.authority}${t.path}` : t.path.charCodeAt(0) === 47 && (t.path.charCodeAt(1) >= 65 && t.path.charCodeAt(1) <= 90 || t.path.charCodeAt(1) >= 97 && t.path.charCodeAt(1) <= 122) && t.path.charCodeAt(2) === 58 ? e ? n = t.path.substr(1) : n = t.path[1].toLowerCase() + t.path.substr(2) : n = t.path, ot && (n = n.replace(/\//g, "\\")), n;
}
function vn(t, e) {
  const n = e ? da : o1;
  let s = "", { scheme: r, authority: i, path: a, query: l, fragment: u } = t;
  if (r && (s += r, s += ":"), (i || r === "file") && (s += pe, s += pe), i) {
    let c = i.indexOf("@");
    if (c !== -1) {
  ...
  return l && (s += "?", s += n(l, !1, !1)), u && (s += "#", s += e ? u : o1(u, !1, !1)), s;
}
function lr(t) {
  try {
    return decodeURIComponent(t);
  } catch {
    return t.length > 3 ? t.substr(0, 3) + lr(t.substr(3)) : t;
  }
}
const l1 = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
function yt(t) {
  return t.match(l1) ? t.replace(l1, (e) => lr(e)) : t;
}
class ce extends A {
  constructor(e, n, s, r) {
    super(e, n, s, r), this.selectionStartLineNumber = e, this.selectionStartColumn = n, this.positionLineNumber = s, this.positionColumn = r;
  }
  toString() {
  ...
  static selectionsArrEqual(e, n) {
    ...
    if (e.length !== n.length)
      return !1;
    for (let s = 0, r = e.length; s < r; s++)
      if (!this.selectionsEqual(e[s], n[s]))
        return !1;
    return !0;
  }
  ...
  static createWithDirection(e, n, s, r, i) {
    return i === 0 ? new ce(e, n, s, r) : new ce(s, r, e, n);
  }
}
function ma(t) {
...
class ur {
  ...
  register(e, n) {
    return this._tokenizationSupports.set(e, n), this.handleChange([e]), _t(() => {
  ...
  registerFactory(e, n) {
    ...
    const s = new pa(this, e, n);
    return this._factories.set(e, s), _t(() => {
      const i = this._factories.get(e);
      !i || i !== s || (this._factories.delete(e), i.dispose());
    });
  }
  async getOrCreate(e) {
    const n = this.get(e);
    ...
    return !s || s.isResolved ? null : (await s.resolve(), this.get(e));
  }
  isResolved(e) {
    if (this.get(e))
      return !0;
...
class pa extends at {
  ...
  constructor(e, n, s) {
    super(), this._registry = e, this._languageId = n, this._factory = s, this._isDisposed = !1, this._resolvePromise = null, this._isResolved = !1;
  }
  dispose() {
...
class xa {
  constructor(e, n, s) {
    this.offset = e, this.type = n, this.language = s, this._tokenBrand = void 0;
  }
  toString() {
...
(function(t) {
  ...
  function n(i) {
    let a = e.get(i);
    return a || (console.info("No codicon found for CompletionItemKind " + i), a = k.symbolProperty), a;
  }
  t.toIcon = n;
...
j(1678, "array"), j(1679, "boolean"), j(1680, "class"), j(1681, "constant"), j(1682, "constructor"), j(1683, "enumeration"), j(1684, "enumeration member"), j(1685, "event"), j(1686, "field"), j(1687, "file"), j(1688, "function"), j(1689, "interface"), j(1690, "key"), j(1691, "method"), j(1692, "module"), j(1693, "namespace"), j(1694, "null"), j(1695, "number"), j(1696, "object"), j(1697, "operator"), j(1698, "package"), j(1699, "property"), j(1700, "string"), j(1701, "struct"), j(1702, "type parameter"), j(1703, "variable");
var b1;
(function(t) {
  const e = /* @__PURE__ */ new Map();
  ...
  function n(s) {
    let r = e.get(s);
    return r || (console.info("No codicon found for SymbolKind " + s), r = k.symbolProperty), r;
  }
  t.toIcon = n;
})(b1 || (b1 = {}));
const he = class he {
...
const xt = class xt {
  static getChannel(e) {
    return e.getChannel(xt.CHANNEL_NAME);
  }
  static setChannel(e, n) {
    e.setChannel(xt.CHANNEL_NAME, n);
  }
};
xt.CHANNEL_NAME = "editorWorkerHost";
let yn = xt;
new $r(10);
function _a(t) {
  let e = [];
...
function Ca(t, e, n, s, r) {
  if (s + r === n)
    return !0;
  const i = e.charCodeAt(s + r);
  if (t.get(i) !== 0 || i === 13 || i === 10)
    return !0;
  if (r > 0) {
    const a = e.charCodeAt(s + r - 1);
    if (t.get(a) !== 0)
      return !0;
  }
  return !1;
...
function Sa(t, e, n, s, r) {
  return Na(t, e, n, s, r) && Ca(t, e, n, s, r);
}
class Ra {
  constructor(e, n) {
  ...
  next(e) {
    ...
    let s;
    do {
      if (this._prevMatchStartIndex + this._prevMatchLength === n || (s = this._searchRegex.exec(e), !s))
        return null;
      const r = s.index, i = s[0].length;
      if (r === this._prevMatchStartIndex && i === this._prevMatchLength) {
        if (i === 0) {
          Ni(e, n, this._searchRegex.lastIndex) > 65535 ? this._searchRegex.lastIndex += 2 : this._searchRegex.lastIndex += 1;
          continue;
        }
        return null;
      }
      if (this._prevMatchStartIndex = r, this._prevMatchLength = i, !this._wordSeparators || Sa(this._wordSeparators, e, n, r, i))
        return s;
    } while (s);
    return null;
  }
}
function Aa(t, e = "Unreachable") {
  throw new Error(e);
}
function ya(t, e = "unexpected state") {
  if (!t)
    throw new re(`Assertion Failed: ${e}`);
}
function Nt(t) {
  if (!t()) {
    debugger;
    t(), dt(new re("Assertion Failed"));
  }
}
function qn(t, e) {
  let n = 0;
...
function Un(t, e, n, s, r) {
  if (e = hr(e), r || (r = Vt.first(fr)), n.length > r.maxLen) {
    let c = t - r.maxLen / 2;
    return c < 0 ? c = 0 : s += c, n = n.substring(c, t + r.maxLen / 2), Un(t, e, n, s, r);
  }
  const i = Date.now(), a = t - 1 - s;
  let l = -1, u = null;
...
class Pa {
  static computeUnicodeHighlights(e, n, s) {
    const r = s ? s.startLineNumber : 1, i = s ? s.endLineNumber : e.getLineCount(), a = new ws(n), l = a.getCandidateCodePoints();
    let u;
    l === "allNonBasicAscii" ? u = new RegExp("[^\\t\\n\\r\\x20-\\x7E]", "g") : u = new RegExp(`${Ta(Array.from(l))}`, "g");
    const c = new Ra(null, u), h = [];
    let f = !1, d, m = 0, g = 0, b = 0;
    e: for (let w = r, L = i; w <= L; w++) {
      const _ = e.getLineContent(w), v = _.length;
      c.reset(0);
      do
        if (d = c.next(_), d) {
          let p = d.index, x = d.index + d[0].length;
          if (p > 0) {
            const U = _.charCodeAt(p - 1);
            pn(U) && p--;
          }
          if (x + 1 < v) {
            const U = _.charCodeAt(x - 1);
            pn(U) && x++;
          }
          const C = _.substring(p, x);
          let R = Un(p + 1, cr, _, 0);
          R && R.endColumn <= p + 1 && (R = null);
          const M = a.shouldHighlightNonBasicASCII(C, R ? R.word : null);
          if (M !== 0) {
            if (M === 3 ? m++ : M === 2 ? g++ : M === 1 ? b++ : Aa(), h.length >= 1e3) {
              f = !0;
              break e;
            }
            h.push(new A(w, p + 1, w, x + 1));
          }
        }
      while (d);
    }
  ...
  static computeUnicodeHighlightReason(e, n) {
    const s = new ws(n);
    switch (s.shouldHighlightNonBasicASCII(e, null)) {
      case 0:
        return null;
      case 2:
        return { kind: 1 };
      case 3: {
        const i = e.codePointAt(0), a = s.ambiguousCharacters.getPrimaryConfusable(i), l = vt.getLocales().filter((u) => !vt.getInstance(/* @__PURE__ */ new Set([...n.allowedLocales, u])).isAmbiguous(i));
...
function Ta(t, e) {
  return `[${di(t.map((s) => String.fromCodePoint(s)).join(""))}]`;
}
class ws {
  constructor(e) {
    this.options = e, this.allowedCodePoints = new Set(e.allowedCodePoints), this.ambiguousCharacters = vt.getInstance(new Set(e.allowedLocales));
  }
  getCandidateCodePoints() {
    ...
    if (this.options.invisibleCharacters)
      for (const n of bt.codePoints)
        _s(String.fromCodePoint(n)) || e.add(n);
  ...
  shouldHighlightNonBasicASCII(e, n) {
    ...
    if (n)
      for (const a of n) {
        ...
        r = r || u, !u && !this.ambiguousCharacters.isAmbiguous(l) && !bt.isInvisibleCharacter(l) && (i = !0);
      }
    return !r && i ? 0 : this.options.invisibleCharacters && !_s(e) && bt.isInvisibleCharacter(s) ? 2 : this.options.ambiguousCharacters && this.ambiguousCharacters.isAmbiguous(s) ? 3 : 0;
  }
}
function _s(t) {
  return t === " " || t === `
...
class Ft {
  constructor(e, n, s) {
    this.changes = e, this.moves = n, this.hitTimeout = s;
  }
}
class $n {
  constructor(e, n) {
  ...
  flip() {
    return new $n(this.lineRangeMapping.flip(), this.changes.map((e) => e.flip()));
  }
}
class B {
  static addRange(e, n) {
    let s = 0;
    for (; s < n.length && n[s].endExclusive < e.start; )
      s++;
    let r = s;
    ...
    if (s === r)
      ...
      const i = Math.min(e.start, n[s].start), a = Math.max(e.endExclusive, n[r - 1].endExclusive);
      n.splice(s, r - s, new B(i, a));
    }
  }
  ...
  intersect(e) {
    const n = Math.max(this.start, e.start), s = Math.min(this.endExclusive, e.endExclusive);
    if (n <= s)
      return new B(n, s);
  }
...
class T {
  ...
  static joinMany(e) {
    ...
    for (let s = 1; s < e.length; s++)
      n = n.getUnion(new we(e[s].slice()));
    return n.ranges;
  }
  static join(e) {
    if (e.length === 0)
      throw new re("lineRanges cannot be empty");
    let n = e[0].startLineNumber, s = e[0].endLineNumberExclusive;
    for (let r = 1; r < e.length; r++)
      n = Math.min(n, e[r].startLineNumber), s = Math.max(s, e[r].endLineNumberExclusive);
    return new T(n, s);
  }
  static ofLength(e, n) {
    return new T(e, e + n);
  ...
  intersect(e) {
    const n = Math.max(this.startLineNumber, e.startLineNumber), s = Math.min(this.endLineNumberExclusive, e.endLineNumberExclusive);
    if (n <= s)
      return new T(n, s);
  }
  intersectsStrict(e) {
  ...
  toInclusiveRange() {
    return this.isEmpty ? null : new A(
  ...
  toExclusiveRange() {
    return new A(this.startLineNumber, 1, this.endLineNumberExclusive, 1);
  }
  mapToLineArray(e) {
    const n = [];
...
class we {
  ...
  addRange(e) {
    if (e.length === 0)
      return;
    const n = cn(this._normalizedRanges, (r) => r.endLineNumberExclusive >= e.startLineNumber), s = it(this._normalizedRanges, (r) => r.startLineNumber <= e.endLineNumberExclusive) + 1;
    if (n === s)
      ...
      const r = this._normalizedRanges[n].join(this._normalizedRanges[s - 1]).join(e);
      this._normalizedRanges.splice(n, s - n, r);
    }
  }
  contains(e) {
    const n = rt(this._normalizedRanges, (s) => s.startLineNumber <= e);
    return !!n && n.endLineNumberExclusive > e;
  }
  intersects(e) {
    const n = rt(this._normalizedRanges, (s) => s.startLineNumber < e.endLineNumberExclusive);
  ...
  getUnion(e) {
    ...
    const n = [];
    let s = 0, r = 0, i = null;
    for (; s < this._normalizedRanges.length || r < e._normalizedRanges.length; ) {
      let a = null;
      if (s < this._normalizedRanges.length && r < e._normalizedRanges.length) {
        const l = this._normalizedRanges[s], u = e._normalizedRanges[r];
        l.startLineNumber < u.startLineNumber ? (a = l, s++) : (a = u, r++);
      } else s < this._normalizedRanges.length ? (a = this._normalizedRanges[s], s++) : (a = e._normalizedRanges[r], r++);
      i === null ? i = a : i.endLineNumberExclusive >= a.startLineNumber ? i = new T(
        i.startLineNumber,
        Math.max(i.endLineNumberExclusive, a.endLineNumberExclusive)
      ) : (n.push(i), i = a);
    }
    return i !== null && n.push(i), new we(n);
  }
  subtractFrom(e) {
    const n = cn(this._normalizedRanges, (a) => a.endLineNumberExclusive >= e.startLineNumber), s = it(this._normalizedRanges, (a) => a.startLineNumber <= e.endLineNumberExclusive) + 1;
    if (n === s)
      return new we([e]);
    const r = [];
    ...
    for (let a = n; a < s; a++) {
      ...
      l.startLineNumber > i && r.push(new T(i, l.startLineNumber)), i = l.endLineNumberExclusive;
    }
    return i < e.endLineNumberExclusive && r.push(new T(i, e.endLineNumberExclusive)), new we(r);
  }
  toString() {
  ...
  getIntersection(e) {
    ...
    let s = 0, r = 0;
    for (; s < this._normalizedRanges.length && r < e._normalizedRanges.length; ) {
      const i = this._normalizedRanges[s], a = e._normalizedRanges[r], l = i.intersect(a);
      l && !l.isEmpty && n.push(l), i.endLineNumberExclusive < a.endLineNumberExclusive ? s++ : r++;
    }
    return new we(n);
  }
  getWithDelta(e) {
...
const ue = class ue {
  static lengthDiffNonNegative(e, n) {
    return n.isLessThan(e) ? ue.zero : e.lineCount === n.lineCount ? new ue(0, n.columnCount - e.columnCount) : new ue(n.lineCount - e.lineCount, n.columnCount);
  }
  static betweenPositions(e, n) {
    return e.lineNumber === n.lineNumber ? new ue(0, n.column - e.column) : new ue(n.lineNumber - e.lineNumber, n.column - 1);
  }
  static fromPosition(e) {
    return new ue(e.lineNumber - 1, e.column - 1);
  }
  static ofRange(e) {
    return ue.betweenPositions(e.getStartPosition(), e.getEndPosition());
  }
  static ofText(e) {
    let n = 0, s = 0;
    for (const r of e)
...
` ? (n++, s = 0) : s++;
  ...
  add(e) {
    return e.lineCount === 0 ? new ue(this.lineCount, this.columnCount + e.columnCount) : new ue(this.lineCount + e.lineCount, e.columnCount);
  }
  createRange(e) {
    return this.lineCount === 0 ? new A(
      e.lineNumber,
      e.column,
      e.lineNumber,
  ...
  toRange() {
    return new A(1, 1, this.lineCount + 1, this.columnCount + 1);
  }
  addToPosition(e) {
    return this.lineCount === 0 ? new q(e.lineNumber, e.column + this.columnCount) : new q(e.lineNumber + this.lineCount, this.columnCount + 1);
  }
  addToRange(e) {
    return A.fromPositions(this.addToPosition(e.getStartPosition()), this.addToPosition(e.getEndPosition()));
  }
  toString() {
...
` && this.lineStartOffsetByLineIdx.push(n + 1);
  ...
  getPosition(e) {
    const n = it(this.lineStartOffsetByLineIdx, (i) => i <= e), s = n + 1, r = e - this.lineStartOffsetByLineIdx[n] + 1;
    return new q(s, r);
  }
  getRange(e) {
    return A.fromPositions(this.getPosition(e.start), this.getPosition(e.endExclusive));
  }
  getTextLength(e) {
    return $e.ofRange(this.getRange(e));
  }
  get textLength() {
    const e = this.lineStartOffsetByLineIdx.length - 1;
    return new $e(e, this.text.length - this.lineStartOffsetByLineIdx[e]);
  }
}
class Qe {
  static single(e, n) {
    return new Qe([new qe(e, n)]);
  }
  static insert(e, n) {
    return new Qe([new qe(A.fromPositions(e, e), n)]);
  }
  constructor(e) {
    this.edits = e, Nt(() => qn(e, (n, s) => n.range.getEndPosition().isBeforeOrEqual(s.range.getStartPosition())));
  }
  normalize() {
    const e = [];
    for (const n of this.edits)
      if (e.length > 0 && e[e.length - 1].range.getEndPosition().equals(n.range.getStartPosition())) {
        ...
        e[e.length - 1] = new qe(s.range.plusRange(n.range), s.text + n.text);
  ...
  mapPosition(e) {
    ...
    for (const i of this.edits) {
      ...
      if (e.isBeforeOrEqual(a))
        break;
      const l = i.range.getEndPosition(), u = $e.ofText(i.text);
      if (e.isBefore(l)) {
        const c = new q(
          a.lineNumber + n,
          a.column + (a.lineNumber + n === s ? r : 0)
        ), h = u.addToPosition(c);
        return Et(c, h);
      }
      a.lineNumber + n !== s && (r = 0), n += u.lineCount - (i.range.endLineNumber - i.range.startLineNumber), u.lineCount === 0 ? l.lineNumber !== a.lineNumber ? r += u.columnCount - (l.column - 1) : r += u.columnCount - (l.column - a.column) : r = u.columnCount, s = l.lineNumber + n;
    }
    return new q(
      e.lineNumber + n,
      e.column + (e.lineNumber + n === s ? r : 0)
    );
  }
  mapRange(e) {
    function n(a) {
      return a instanceof q ? a : a.getStartPosition();
    }
    function s(a) {
      return a instanceof q ? a : a.getEndPosition();
    }
    const r = n(this.mapPosition(e.getStartPosition())), i = s(this.mapPosition(e.getEndPosition()));
    return Et(r, i);
  }
  ...
  apply(e) {
    let n = "", s = new q(1, 1);
    for (const i of this.edits) {
      const a = i.range, l = a.getStartPosition(), u = a.getEndPosition(), c = Et(s, l);
      c.isEmpty() || (n += e.getValueOfRange(c)), n += i.text, s = u;
    }
    const r = Et(s, e.endPositionExclusive);
  ...
  inverse(e) {
    ...
    return new Qe(this.edits.map((s, r) => new qe(n[r], e.getValueOfRange(s.range))));
  }
  getNewRanges() {
    const e = [];
    let n = 0, s = 0, r = 0;
    for (const i of this.edits) {
      const a = $e.ofText(i.text), l = q.lift({
        lineNumber: i.range.startLineNumber + s,
        column: i.range.startColumn + (i.range.startLineNumber === n ? r : 0)
      }), u = a.createRange(l);
      e.push(u), s = u.endLineNumber - i.range.endLineNumber, r = u.endColumn - i.range.endColumn, n = i.range.endLineNumber;
    }
    return e;
  }
}
...
function Et(t, e) {
  if (t.lineNumber === e.lineNumber && t.column === Number.MAX_SAFE_INTEGER)
    return A.fromPositions(e, e);
  if (!t.isBeforeOrEqual(e))
    throw new re("start must be before end");
  return new A(t.lineNumber, t.column, e.lineNumber, e.column);
}
class dr {
  ...
  getLineLength(e) {
    return this.getValueOfRange(new A(e, 1, e, Number.MAX_SAFE_INTEGER)).length;
  }
}
class Fa extends dr {
  constructor(e, n) {
    ya(n >= 1), super(), this._getLineContent = e, this._lineCount = n;
  }
  getValueOfRange(e) {
    ...
    for (let s = e.startLineNumber + 1; s < e.endLineNumber; s++)
      n += `
` + this._getLineContent(s);
    return n += `
` + this._getLineContent(e.endLineNumber).substring(0, e.endColumn - 1), n;
  ...
  get length() {
    ...
    return new $e(this._lineCount - 1, e.length);
  }
}
class Mt extends Fa {
  constructor(e) {
...
class Ia extends dr {
  constructor(e) {
    super(), this.value = e, this._t = new Da(this.value);
  }
  getValueOfRange(e) {
...
class me {
  static inverse(e, n, s) {
    const r = [];
    let i = 1, a = 1;
    for (const u of e) {
      const c = new me(new T(i, u.original.startLineNumber), new T(a, u.modified.startLineNumber));
      c.modified.isEmpty || r.push(c), i = u.original.endLineNumberExclusive, a = u.modified.endLineNumberExclusive;
    }
    const l = new me(new T(i, n + 1), new T(a, s + 1));
    return l.modified.isEmpty || r.push(l), r;
  }
  static clip(e, n, s) {
    const r = [];
    for (const i of e) {
      const a = i.original.intersect(n), l = i.modified.intersect(s);
      a && !a.isEmpty && l && !l.isEmpty && r.push(new me(a, l));
    }
    return r;
  }
  constructor(e, n) {
  ...
  toRangeMapping() {
    ...
    if (this.original.startLineNumber === 1 || this.modified.startLineNumber === 1) {
      ...
      return new oe(new A(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1), new A(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1));
    } else
      return new oe(new A(
  ...
  toRangeMapping2(e, n) {
    if (Ls(this.original.endLineNumberExclusive, e) && Ls(this.modified.endLineNumberExclusive, n))
      return new oe(new A(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1), new A(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1));
    if (!this.original.isEmpty && !this.modified.isEmpty)
      return new oe(A.fromPositions(new q(this.original.startLineNumber, 1), Ge(new q(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), e)), A.fromPositions(new q(this.modified.startLineNumber, 1), Ge(new q(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), n)));
    if (this.original.startLineNumber > 1 && this.modified.startLineNumber > 1)
      return new oe(A.fromPositions(Ge(new q(this.original.startLineNumber - 1, Number.MAX_SAFE_INTEGER), e), Ge(new q(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), e)), A.fromPositions(Ge(new q(this.modified.startLineNumber - 1, Number.MAX_SAFE_INTEGER), n), Ge(new q(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), n)));
    throw new re();
  }
}
function Ge(t, e) {
...
class Ce extends me {
  static fromRangeMappings(e) {
    const n = T.join(e.map((r) => T.fromRangeInclusive(r.originalRange))), s = T.join(e.map((r) => T.fromRangeInclusive(r.modifiedRange)));
    return new Ce(n, s, e);
  }
  constructor(e, n, s) {
    super(e, n), this.innerChanges = s;
  }
  flip() {
    var e;
    return new Ce(this.modified, this.original, (e = this.innerChanges) == null ? void 0 : e.map((n) => n.flip()));
  }
...
class oe {
  ...
  static fromEditJoin(e) {
    const n = e.getNewRanges(), s = e.edits.map((r, i) => new oe(r.range, n[i]));
    return oe.join(s);
  }
  static join(e) {
    if (e.length === 0)
      throw new re("Cannot join an empty list of range mappings");
    let n = e[0];
    for (let s = 1; s < e.length; s++)
      n = n.join(e[s]);
    return n;
...
function vs(t, e, n, s = !1) {
  const r = [];
  for (const i of Pr(t.map((a) => Va(a, e, n)), (a, l) => a.original.overlapOrTouch(l.original) || a.modified.overlapOrTouch(l.modified))) {
  ...
  return Nt(() => !s && r.length > 0 && (r[0].modified.startLineNumber !== r[0].original.startLineNumber || n.length.lineCount - r[r.length - 1].modified.endLineNumberExclusive !== e.length.lineCount - r[r.length - 1].original.endLineNumberExclusive) ? !1 : qn(r, (i, a) => a.original.startLineNumber - i.original.endLineNumberExclusive === a.modified.startLineNumber - i.modified.endLineNumberExclusive && i.original.endLineNumberExclusive < a.original.startLineNumber && i.modified.endLineNumberExclusive < a.modified.startLineNumber)), r;
}
function Va(t, e, n) {
  let s = 0, r = 0;
  t.modifiedRange.endColumn === 1 && t.originalRange.endColumn === 1 && t.originalRange.startLineNumber + s <= t.originalRange.endLineNumber && t.modifiedRange.startLineNumber + s <= t.modifiedRange.endLineNumber && (r = -1), t.modifiedRange.startColumn - 1 >= n.getLineLength(t.modifiedRange.startLineNumber) && t.originalRange.startColumn - 1 >= e.getLineLength(t.originalRange.startLineNumber) && t.originalRange.startLineNumber <= t.originalRange.endLineNumber + r && t.modifiedRange.startLineNumber <= t.modifiedRange.endLineNumber + r && (s = 1);
  const i = new T(
    t.originalRange.startLineNumber + s,
    t.originalRange.endLineNumber + 1 + r
  ), a = new T(
    t.modifiedRange.startLineNumber + s,
    t.modifiedRange.endLineNumber + 1 + r
  );
  return new Ce(i, a, [t]);
}
const Ba = 3;
class qa {
  computeDiff(e, n, s) {
    ...
    for (const c of i.changes) {
      ...
      let d = new Ce(h, f, (u = c.charChanges) == null ? void 0 : u.map((m) => new oe(new A(
      ...
      l && (l.modified.endLineNumberExclusive === d.modified.startLineNumber || l.original.endLineNumberExclusive === d.original.startLineNumber) && (d = new Ce(
    ...
    return Nt(() => qn(a, (c, h) => h.original.startLineNumber - c.original.endLineNumberExclusive === h.modified.startLineNumber - c.modified.endLineNumberExclusive && c.original.endLineNumberExclusive < h.original.startLineNumber && c.modified.endLineNumberExclusive < h.modified.startLineNumber)), new Ft(a, [], i.quitEarly);
  }
}
function mr(t, e, n, s) {
  return new ke(t, e, n).ComputeDiff(s);
}
let Ns = class {
  constructor(e) {
    const n = [], s = [];
    for (let r = 0, i = e.length; r < i; r++)
      n[r] = En(e[r], 1), s[r] = Mn(e[r], 1);
    this.lines = e, this._startColumns = n, this._endColumns = s;
  }
  getElements() {
    const e = [];
  ...
  createCharSequence(e, n, s) {
    const r = [], i = [], a = [];
    let l = 0;
    for (let u = n; u <= s; u++) {
      const c = this.lines[u], h = e ? this._startColumns[u] : 1, f = e ? this._endColumns[u] : c.length + 1;
      for (let d = h; d < f; d++)
        r[l] = c.charCodeAt(d - 1), i[l] = u + 1, a[l] = d, l++;
      !e && u < s && (r[l] = 10, i[l] = u + 1, a[l] = c.length + 1, l++);
    }
    return new Ua(r, i, a);
  }
};
class Ua {
  constructor(e, n, s) {
    this._charCodes = e, this._lineNumbers = n, this._columns = s;
  }
  toString() {
...
class nt {
  constructor(e, n, s, r, i, a, l, u) {
    this.originalStartLineNumber = e, this.originalStartColumn = n, this.originalEndLineNumber = s, this.originalEndColumn = r, this.modifiedStartLineNumber = i, this.modifiedStartColumn = a, this.modifiedEndLineNumber = l, this.modifiedEndColumn = u;
  }
  static createFromDiffChange(e, n, s) {
    const r = n.getStartLineNumber(e.originalStart), i = n.getStartColumn(e.originalStart), a = n.getEndLineNumber(e.originalStart + e.originalLength - 1), l = n.getEndColumn(e.originalStart + e.originalLength - 1), u = s.getStartLineNumber(e.modifiedStart), c = s.getStartColumn(e.modifiedStart), h = s.getEndLineNumber(e.modifiedStart + e.modifiedLength - 1), f = s.getEndColumn(e.modifiedStart + e.modifiedLength - 1);
    return new nt(
      r,
      i,
      a,
...
function $a(t) {
  ...
  for (let s = 1, r = t.length; s < r; s++) {
    const i = t[s], a = i.originalStart - (n.originalStart + n.originalLength), l = i.modifiedStart - (n.modifiedStart + n.modifiedLength);
    Math.min(a, l) < Ba ? (n.originalLength = i.originalStart + i.originalLength - n.originalStart, n.modifiedLength = i.modifiedStart + i.modifiedLength - n.modifiedStart) : (e.push(i), n = i);
  }
  return e;
}
class pt {
  constructor(e, n, s, r, i) {
    this.originalStartLineNumber = e, this.originalEndLineNumber = n, this.modifiedStartLineNumber = s, this.modifiedEndLineNumber = r, this.charChanges = i;
  }
  static createFromDiffResult(e, n, s, r, i, a, l) {
    let u, c, h, f, d;
    if (n.originalLength === 0 ? (u = s.getStartLineNumber(n.originalStart) - 1, c = 0) : (u = s.getStartLineNumber(n.originalStart), c = s.getEndLineNumber(n.originalStart + n.originalLength - 1)), n.modifiedLength === 0 ? (h = r.getStartLineNumber(n.modifiedStart) - 1, f = 0) : (h = r.getStartLineNumber(n.modifiedStart), f = r.getEndLineNumber(n.modifiedStart + n.modifiedLength - 1)), a && n.originalLength > 0 && n.originalLength < 20 && n.modifiedLength > 0 && n.modifiedLength < 20 && i()) {
      const m = s.createCharSequence(e, n.originalStart, n.originalStart + n.originalLength - 1), g = r.createCharSequence(e, n.modifiedStart, n.modifiedStart + n.modifiedLength - 1);
      if (m.getElements().length > 0 && g.getElements().length > 0) {
        let b = mr(m, g, i, !0).changes;
        l && (b = $a(b)), d = [];
        for (let w = 0, L = b.length; w < L; w++)
          d.push(nt.createFromDiffChange(b[w], m, g));
      }
    }
    return new pt(
      u,
...
class gr {
  constructor(e, n, s) {
    this.shouldComputeCharChanges = s.shouldComputeCharChanges, this.shouldPostProcessCharChanges = s.shouldPostProcessCharChanges, this.shouldIgnoreTrimWhitespace = s.shouldIgnoreTrimWhitespace, this.shouldMakePrettyDiff = s.shouldMakePrettyDiff, this.originalLines = e, this.modifiedLines = n, this.original = new Ns(e), this.modified = new Ns(n), this.continueLineDiff = Cs(s.maxComputationTime), this.continueCharDiff = Cs(s.maxComputationTime === 0 ? 0 : Math.min(s.maxComputationTime, 5e3));
  }
  computeDiff() {
    ...
    const e = mr(this.original, this.modified, this.continueLineDiff, this.shouldMakePrettyDiff), n = e.changes, s = e.quitEarly;
    if (this.shouldIgnoreTrimWhitespace) {
      const l = [];
      for (let u = 0, c = n.length; u < c; u++)
        l.push(pt.createFromDiffResult(this.shouldIgnoreTrimWhitespace, n[u], this.original, this.modified, this.continueCharDiff, this.shouldComputeCharChanges, this.shouldPostProcessCharChanges));
      return {
        quitEarly: s,
        changes: l
      };
    ...
    for (let l = -1, u = n.length; l < u; l++) {
      ...
      for (; i < h && a < f; ) {
        const d = this.originalLines[i], m = this.modifiedLines[a];
        if (d !== m) {
          {
            let g = En(d, 1), b = En(m, 1);
            for (; g > 1 && b > 1; ) {
              const w = d.charCodeAt(g - 2), L = m.charCodeAt(b - 2);
              if (w !== L)
                break;
              g--, b--;
            }
            (g > 1 || b > 1) && this._pushTrimWhitespaceCharChange(r, i + 1, 1, g, a + 1, 1, b);
          }
          {
            let g = Mn(d, 1), b = Mn(m, 1);
            const w = d.length + 1, L = m.length + 1;
            for (; g < w && b < L; ) {
              const _ = d.charCodeAt(g - 1), v = d.charCodeAt(b - 1);
              if (_ !== v)
                break;
              g++, b++;
            }
            (g < w || b < L) && this._pushTrimWhitespaceCharChange(r, i + 1, g, w, a + 1, b, L);
          }
        }
        i++, a++;
      }
      c && (r.push(pt.createFromDiffResult(this.shouldIgnoreTrimWhitespace, c, this.original, this.modified, this.continueCharDiff, this.shouldComputeCharChanges, this.shouldPostProcessCharChanges)), i += c.originalLength, a += c.modifiedLength);
    }
    return {
      quitEarly: s,
      changes: r
  ...
  _pushTrimWhitespaceCharChange(e, n, s, r, i, a, l) {
    if (this._mergeTrimWhitespaceCharChange(e, n, s, r, i, a, l))
      return;
    let u;
    this.shouldComputeCharChanges && (u = [new nt(
      n,
      s,
      n,
      r,
  ...
  _mergeTrimWhitespaceCharChange(e, n, s, r, i, a, l) {
    const u = e.length;
    if (u === 0)
      return !1;
    const c = e[u - 1];
    return c.originalEndLineNumber === 0 || c.modifiedEndLineNumber === 0 ? !1 : c.originalEndLineNumber === n && c.modifiedEndLineNumber === i ? (this.shouldComputeCharChanges && c.charChanges && c.charChanges.push(new nt(
      n,
      s,
      n,
      r,
      ...
      i,
      l
    )), !0) : c.originalEndLineNumber + 1 === n && c.modifiedEndLineNumber + 1 === i ? (c.originalEndLineNumber = n, c.modifiedEndLineNumber = i, this.shouldComputeCharChanges && c.charChanges && c.charChanges.push(new nt(
      n,
      s,
      n,
      r,
...
class Se {
  static trivial(e, n) {
    return new Se([new Q(B.ofLength(e.length), B.ofLength(n.length))], !1);
  }
  static trivialTimedOut(e, n) {
    return new Se([new Q(B.ofLength(e.length), B.ofLength(n.length))], !0);
  }
  constructor(e, n) {
...
class Q {
  static invert(e, n) {
    const s = [];
    return Tr(e, (r, i) => {
      s.push(Q.fromOffsetPairs(r ? r.getEndExclusives() : ve.zero, i ? i.getStarts() : new ve(
        n,
  ...
  static fromOffsetPairs(e, n) {
    return new Q(new B(e.offset1, n.offset1), new B(e.offset2, n.offset2));
  }
  static assertSorted(e) {
    let n;
    for (const s of e) {
  ...
  intersect(e) {
    const n = this.seq1Range.intersect(e.seq1Range), s = this.seq2Range.intersect(e.seq2Range);
    if (!(!n || !s))
      return new Q(n, s);
  }
  getStarts() {
    return new ve(this.seq1Range.start, this.seq2Range.start);
  }
  getEndExclusives() {
    return new ve(this.seq1Range.endExclusive, this.seq2Range.endExclusive);
  }
}
const Be = class Be {
  constructor(e, n) {
...
Be.zero = new Be(0, 0), Be.max = new Be(Number.MAX_SAFE_INTEGER, Number.MAX_SAFE_INTEGER);
let ve = Be;
const Jt = class Jt {
  isValid() {
    return !0;
...
const wt = class wt {
  ...
  constructor(e, n, s) {
    this.range = e, this.lines = n, this.source = s, this.histogram = [];
    let r = 0;
    for (let i = e.startLineNumber - 1; i < e.endLineNumberExclusive - 1; i++) {
      const a = n[i];
      for (let u = 0; u < a.length; u++) {
        r++;
        const c = a[u], h = wt.getKey(c);
...
`);
  ...
  computeSimilarity(e) {
    let n = 0;
    const s = Math.max(this.histogram.length, e.histogram.length);
    for (let r = 0; r < s; r++)
...
let zt = wt;
class Wa {
  compute(e, n, s = Ct.instance, r) {
    if (e.length === 0 || n.length === 0)
      return Se.trivial(e, n);
    const i = new an(e.length, n.length), a = new an(e.length, n.length), l = new an(e.length, n.length);
    for (let g = 0; g < e.length; g++)
      for (let b = 0; b < n.length; b++) {
        ...
        let _;
        e.getElement(g) === n.getElement(b) ? (g === 0 || b === 0 ? _ = 0 : _ = i.get(g - 1, b - 1), g > 0 && b > 0 && a.get(g - 1, b - 1) === 3 && (_ += l.get(g - 1, b - 1)), _ += r ? r(g, b) : 1) : _ = -1;
        const v = Math.max(w, L, _);
        if (v === _) {
          const p = g > 0 && b > 0 ? l.get(g - 1, b - 1) : 0;
          l.set(g, b, p + 1), a.set(g, b, 3);
        } else v === w ? (l.set(g, b, 0), a.set(g, b, 1)) : v === L && (l.set(g, b, 0), a.set(g, b, 2));
        i.set(g, b, v);
      }
    const u = [];
    let c = e.length, h = n.length;
    function f(g, b) {
      (g + 1 !== c || b + 1 !== h) && u.push(new Q(new B(g + 1, c), new B(b + 1, h))), c = g, h = b;
    }
    let d = e.length - 1, m = n.length - 1;
    for (; d >= 0 && m >= 0; )
      a.get(d, m) === 3 ? (f(d, m), d--, m--) : a.get(d, m) === 1 ? d-- : m--;
    return f(-1, -1), u.reverse(), new Se(u, !1);
  }
}
class br {
  compute(e, n, s = Ct.instance) {
    if (e.length === 0 || n.length === 0)
      return Se.trivial(e, n);
    const r = e, i = n;
    function a(b, w) {
      for (; b < r.length && w < i.length && r.getElement(b) === i.getElement(w); )
        b++, w++;
      return b;
    }
    let l = 0;
    ...
    u.set(0, a(0, 0));
    const c = new Oa();
    c.set(0, u.get(0) === 0 ? null : new Ss(null, 0, 0, u.get(0)));
    let h = 0;
    e: for (; ; ) {
      if (l++, !s.isValid())
        return Se.trivialTimedOut(r, i);
      const b = -Math.min(l, i.length + l % 2), w = Math.min(l, r.length + l % 2);
      for (h = b; h <= w; h += 2) {
        const L = h === w ? -1 : u.get(h + 1), _ = h === b ? -1 : u.get(h - 1) + 1, v = Math.min(Math.max(L, _), r.length), p = v - h;
        if (v > r.length || p > i.length)
          continue;
        const x = a(v, p);
        u.set(h, x);
        const C = v === L ? c.get(h + 1) : c.get(h - 1);
        if (c.set(h, x !== v ? new Ss(C, v, p, x - v) : C), u.get(h) === r.length && u.get(h) - h === i.length)
          break e;
      }
    }
    let f = c.get(h);
    ...
    for (; ; ) {
      ...
      if ((b !== m || w !== g) && d.push(new Q(new B(b, m), new B(w, g))), !f)
        break;
      m = f.x, g = f.y, f = f.prev;
    }
    return d.reverse(), new Se(d, !1);
  }
}
class Ss {
  constructor(e, n, s, r) {
    this.prev = e, this.x = n, this.y = s, this.length = r;
  }
}
class za {
  constructor() {
...
class Ot {
  constructor(e, n, s) {
    this.lines = e, this.range = n, this.considerWhitespaceChanges = s, this.elements = [], this.firstElementOffsetByLineIdx = [], this.lineStartOffsets = [], this.trimmedWsLengthsByLineIdx = [], this.firstElementOffsetByLineIdx.push(0);
    for (let r = this.range.startLineNumber; r <= this.range.endLineNumber; r++) {
      ...
      const u = r === this.range.endLineNumber ? Math.min(this.range.endColumn - 1 - a - l, i.length) : i.length;
      for (let c = 0; c < u; c++)
  ...
  getBoundaryScore(e) {
    const n = As(e > 0 ? this.elements[e - 1] : -1), s = As(e < this.elements.length ? this.elements[e] : -1);
    if (n === 7 && s === 8)
      return 0;
    if (n === 8)
      return 150;
    let r = 0;
    return n !== s && (r += 10, n === 0 && s === 1 && (r += 1)), r += Rs(n), r += Rs(s), r;
  }
  translateOffset(e, n = "right") {
    const s = it(this.firstElementOffsetByLineIdx, (i) => i <= e), r = e - this.firstElementOffsetByLineIdx[s];
    return new q(
      this.range.startLineNumber + s,
      1 + this.lineStartOffsets[s] + r + (r === 0 && n === "left" ? 0 : this.trimmedWsLengthsByLineIdx[s])
    );
  }
  translateRange(e) {
    const n = this.translateOffset(e.start, "right"), s = this.translateOffset(e.endExclusive, "left");
    return s.isBefore(n) ? A.fromPositions(s, s) : A.fromPositions(n, s);
  }
  findWordContaining(e) {
    if (e < 0 || e >= this.elements.length || !on(this.elements[e]))
      return;
    let n = e;
    for (; n > 0 && on(this.elements[n - 1]); )
      n--;
    let s = e;
    for (; s < this.elements.length && on(this.elements[s]); )
      s++;
    return new B(n, s);
  }
  countLinesIn(e) {
  ...
  extendToFullLines(e) {
    const n = rt(this.firstElementOffsetByLineIdx, (r) => r <= e.start) ?? 0, s = Mr(this.firstElementOffsetByLineIdx, (r) => e.endExclusive <= r) ?? this.elements.length;
    return new B(n, s);
  }
}
function on(t) {
...
function As(t) {
  return t === 10 ? 8 : t === 13 ? 7 : kn(t) ? 6 : t >= 97 && t <= 122 ? 0 : t >= 65 && t <= 90 ? 1 : t >= 48 && t <= 57 ? 2 : t === -1 ? 3 : t === 44 || t === 59 ? 5 : 4;
}
function Ga(t, e, n, s, r, i) {
  let { moves: a, excludedChanges: l } = Qa(t, e, n, i);
  if (!i.isValid())
    return [];
  const u = t.filter((h) => !l.has(h)), c = Ya(u, s, r, e, n, i);
  return Fr(a, c), a = Ja(a), a = a.filter((h) => {
    const f = h.original.toOffsetRange().slice(e).map((m) => m.trim());
    return f.join(`
`).length >= 15 && Xa(f, (m) => m.length >= 2) >= 2;
  }), a = Za(t, a), a;
}
function Xa(t, e) {
  let n = 0;
...
function Qa(t, e, n, s) {
  const r = [], i = t.filter((u) => u.modified.isEmpty && u.original.length >= 3).map((u) => new zt(u.original, e, u)), a = new Set(t.filter((u) => u.original.isEmpty && u.modified.length >= 3).map((u) => new zt(u.modified, n, u))), l = /* @__PURE__ */ new Set();
  for (const u of i) {
    let c = -1, h;
    for (const f of a) {
    ...
    if (c > 0.9 && h && (a.delete(h), r.push(new me(u.range, h.range)), l.add(u.source), l.add(h.source)), !s.isValid())
      return { moves: r, excludedChanges: l };
  }
  return { moves: r, excludedChanges: l };
}
function Ya(t, e, n, s, r, i) {
  const a = [], l = new Qs();
  for (const d of t)
    for (let m = d.original.startLineNumber; m < d.original.endLineNumberExclusive - 2; m++) {
      const g = `${e[m - 1]}:${e[m + 1 - 1]}:${e[m + 2 - 1]}`;
      l.add(g, { range: new T(m, m + 3) });
    }
  const u = [];
  t.sort(mt((d) => d.modified.startLineNumber, gt));
  for (const d of t) {
    let m = [];
    for (let g = d.modified.startLineNumber; g < d.modified.endLineNumberExclusive - 2; g++) {
      const b = `${n[g - 1]}:${n[g + 1 - 1]}:${n[g + 2 - 1]}`, w = new T(g, g + 3), L = [];
      l.forEach(b, ({ range: _ }) => {
        for (const p of m)
          if (p.originalLineRange.endLineNumberExclusive + 1 === _.endLineNumberExclusive && p.modifiedLineRange.endLineNumberExclusive + 1 === w.endLineNumberExclusive) {
            p.originalLineRange = new T(
              p.originalLineRange.startLineNumber,
              _.endLineNumberExclusive
            ), p.modifiedLineRange = new T(
  ...
  u.sort(Ir(mt((d) => d.modifiedLineRange.length, gt)));
  const c = new we(), h = new we();
  for (const d of u) {
    const m = d.modifiedLineRange.startLineNumber - d.originalLineRange.startLineNumber, g = c.subtractFrom(d.modifiedLineRange), b = h.subtractFrom(d.originalLineRange).getWithDelta(m), w = g.getIntersection(b);
    for (const L of w.ranges) {
      if (L.length < 3)
        continue;
      const _ = L, v = L.delta(-m);
      a.push(new me(v, _)), c.addRange(_), h.addRange(v);
    }
  }
  a.sort(mt((d) => d.original.startLineNumber, gt));
  const f = new It(t);
  for (let d = 0; d < a.length; d++) {
    const m = a[d], g = f.findLastMonotonous((C) => C.original.startLineNumber <= m.original.startLineNumber), b = rt(t, (C) => C.modified.startLineNumber <= m.modified.startLineNumber), w = Math.max(m.original.startLineNumber - g.original.startLineNumber, m.modified.startLineNumber - b.modified.startLineNumber), L = f.findLastMonotonous((C) => C.original.startLineNumber < m.original.endLineNumberExclusive), _ = rt(t, (C) => C.modified.startLineNumber < m.modified.endLineNumberExclusive), v = Math.max(L.original.endLineNumberExclusive - m.original.endLineNumberExclusive, _.modified.endLineNumberExclusive - m.modified.endLineNumberExclusive);
    let p;
    for (p = 0; p < w; p++) {
      const C = m.original.startLineNumber - p - 1, R = m.modified.startLineNumber - p - 1;
      if (C > s.length || R > r.length || c.contains(R) || h.contains(C) || !ys(s[C - 1], r[R - 1], i))
        break;
    }
    p > 0 && (h.addRange(new T(m.original.startLineNumber - p, m.original.startLineNumber)), c.addRange(new T(m.modified.startLineNumber - p, m.modified.startLineNumber)));
    let x;
    for (x = 0; x < v; x++) {
      const C = m.original.endLineNumberExclusive + x, R = m.modified.endLineNumberExclusive + x;
      if (C > s.length || R > r.length || c.contains(R) || h.contains(C) || !ys(s[C - 1], r[R - 1], i))
        break;
    }
    x > 0 && (h.addRange(new T(
...
function ys(t, e, n) {
  ...
  if (t.length > 300 && e.length > 300)
    return !1;
  const r = new br().compute(new Ot([t], new A(1, 1, 1, t.length), !1), new Ot([e], new A(1, 1, 1, e.length), !1), n);
  let i = 0;
  const a = Q.invert(r.diffs, t.length);
  for (const h of a)
...
function Ja(t) {
  if (t.length === 0)
    return t;
  t.sort(mt((n) => n.original.startLineNumber, gt));
  const e = [t[0]];
  for (let n = 1; n < t.length; n++) {
    const s = e[e.length - 1], r = t[n], i = r.original.startLineNumber - s.original.endLineNumberExclusive, a = r.modified.startLineNumber - s.modified.endLineNumberExclusive;
    if (i >= 0 && a >= 0 && i + a <= 2) {
      e[e.length - 1] = s.join(r);
      continue;
    }
    e.push(r);
  }
...
function Za(t, e) {
  const n = new It(t);
  return e = e.filter((s) => {
    const r = n.findLastMonotonous((l) => l.original.startLineNumber < s.original.endLineNumberExclusive) || new me(new T(1, 1), new T(1, 1)), i = rt(t, (l) => l.modified.startLineNumber < s.modified.endLineNumberExclusive);
    return r !== i;
  }), e;
}
function Es(t, e, n) {
  let s = n;
  return s = Ms(t, e, s), s = Ms(t, e, s), s = Ka(t, e, s), s;
}
function Ms(t, e, n) {
  if (n.length === 0)
    return n;
  ...
  for (let i = 1; i < n.length; i++) {
    ...
    if (l.seq1Range.isEmpty || l.seq2Range.isEmpty) {
      ...
      for (c = 1; c <= u && !(t.getElement(l.seq1Range.start - c) !== t.getElement(l.seq1Range.endExclusive - c) || e.getElement(l.seq2Range.start - c) !== e.getElement(l.seq2Range.endExclusive - c)); c++)
        ;
      if (c--, c === u) {
        s[s.length - 1] = new Q(new B(a.seq1Range.start, l.seq1Range.endExclusive - u), new B(a.seq2Range.start, l.seq2Range.endExclusive - u));
        continue;
      }
      l = l.delta(-c);
    }
  ...
  for (let i = 0; i < s.length - 1; i++) {
    ...
    if (l.seq1Range.isEmpty || l.seq2Range.isEmpty) {
      ...
      for (c = 0; c < u && !(!t.isStronglyEqual(l.seq1Range.start + c, l.seq1Range.endExclusive + c) || !e.isStronglyEqual(l.seq2Range.start + c, l.seq2Range.endExclusive + c)); c++)
        ;
      if (c === u) {
        s[i + 1] = new Q(new B(l.seq1Range.start + u, a.seq1Range.endExclusive), new B(l.seq2Range.start + u, a.seq2Range.endExclusive));
        continue;
      }
      c > 0 && (l = l.delta(c));
    }
...
function Ka(t, e, n) {
  ...
  for (let s = 0; s < n.length; s++) {
    const r = s > 0 ? n[s - 1] : void 0, i = n[s], a = s + 1 < n.length ? n[s + 1] : void 0, l = new B(
    ...
    i.seq1Range.isEmpty ? n[s] = ks(i, t, e, l, u) : i.seq2Range.isEmpty && (n[s] = ks(i.swap(), e, t, u, l).swap());
  }
  return n;
}
function ks(t, e, n, s, r) {
  let a = 1;
  for (; t.seq1Range.start - a >= s.start && t.seq2Range.start - a >= r.start && n.isStronglyEqual(t.seq2Range.start - a, t.seq2Range.endExclusive - a) && a < 100; )
    a++;
  a--;
  let l = 0;
  for (; t.seq1Range.start + l < s.endExclusive && t.seq2Range.endExclusive + l < r.endExclusive && n.isStronglyEqual(t.seq2Range.start + l, t.seq2Range.endExclusive + l) && l < 100; )
    l++;
  if (a === 0 && l === 0)
    return t;
  let u = 0, c = -1;
  for (let h = -a; h <= l; h++) {
    const f = t.seq2Range.start + h, d = t.seq2Range.endExclusive + h, m = t.seq1Range.start + h, g = e.getBoundaryScore(m) + n.getBoundaryScore(f) + n.getBoundaryScore(d);
    g > c && (c = g, u = h);
  }
  return t.delta(u);
}
function eo(t, e, n) {
  ...
  for (const r of n) {
    ...
    r.seq1Range.start - i.seq1Range.endExclusive <= 2 || r.seq2Range.start - i.seq2Range.endExclusive <= 2 ? s[s.length - 1] = new Q(i.seq1Range.join(r.seq1Range), i.seq2Range.join(r.seq2Range)) : s.push(r);
  }
  return s;
}
function to(t, e, n) {
  const s = Q.invert(n, t.length), r = [];
  let i = new ve(0, 0);
  function a(u, c) {
    if (u.offset1 < i.offset1 || u.offset2 < i.offset2)
      return;
    const h = t.findWordContaining(u.offset1), f = e.findWordContaining(u.offset2);
    if (!h || !f)
      return;
    let d = new Q(h, f);
    ...
    for (; s.length > 0; ) {
      ...
      if (!(w.seq1Range.intersects(d.seq1Range) || w.seq2Range.intersects(d.seq2Range)))
        break;
      const _ = t.findWordContaining(w.seq1Range.start), v = e.findWordContaining(w.seq2Range.start), p = new Q(_, v), x = p.intersect(w);
      if (g += x.seq1Range.length, b += x.seq2Range.length, d = d.join(p), d.seq1Range.endExclusive >= w.seq1Range.endExclusive)
        s.shift();
      else
        break;
    }
...
function no(t, e) {
  ...
  for (; t.length > 0 || e.length > 0; ) {
    const s = t[0], r = e[0];
    let i;
    s && (!r || s.seq1Range.start < r.seq1Range.start) ? i = t.shift() : i = e.shift(), n.length > 0 && n[n.length - 1].seq1Range.endExclusive >= i.seq1Range.start ? n[n.length - 1] = n[n.length - 1].join(i) : n.push(i);
  }
  return n;
}
function so(t, e, n) {
  ...
  do {
    ...
    for (let l = 1; l < s.length; l++) {
      let h = function(d, m) {
        const g = new B(c.seq1Range.endExclusive, u.seq1Range.start);
        return t.getText(g).replace(/\s/g, "").length <= 4 && (d.seq1Range.length + d.seq2Range.length > 5 || m.seq1Range.length + m.seq2Range.length > 5);
      };
...
function ro(t, e, n) {
    ...
    for (let u = 1; u < s.length; u++) {
      let f = function(m, g) {
        ...
        if (t.countLinesIn(b) > 5 || b.length > 500)
          return !1;
        const L = t.getText(b).trim();
        if (L.length > 20 || L.split(/\r\n|\r|\n/).length > 1)
          return !1;
        const _ = t.countLinesIn(m.seq1Range), v = m.seq1Range.length, p = e.countLinesIn(m.seq2Range), x = m.seq2Range.length, C = t.countLinesIn(g.seq1Range), R = g.seq1Range.length, M = e.countLinesIn(g.seq2Range), U = g.seq2Range.length, J = 2 * 40 + 50;
        function $(D) {
          return Math.min(D, J);
        }
        return Math.pow(Math.pow($(_ * 40 + v), 1.5) + Math.pow($(p * 40 + x), 1.5), 1.5) + Math.pow(Math.pow($(C * 40 + R), 1.5) + Math.pow($(M * 40 + U), 1.5), 1.5) > (J ** 1.5) ** 1.5 * 1.3;
      };
  ...
  return Dr(s, (l, u, c) => {
    ...
    const d = t.extendToFullLines(u.seq1Range), m = t.getText(new B(d.start, u.seq1Range.start));
    f(m) && (h = h.deltaStart(-m.length));
    const g = t.getText(new B(u.seq1Range.endExclusive, d.endExclusive));
    f(g) && (h = h.deltaEnd(g.length));
    const b = Q.fromOffsetPairs(l ? l.getEndExclusives() : ve.zero, c ? c.getStarts() : ve.max), w = h.intersect(b);
...
class Ps {
  ...
  getBoundaryScore(e) {
    const n = e === 0 ? 0 : Ts(this.lines[e - 1]), s = e === this.lines.length ? 0 : Ts(this.lines[e]);
    return 1e3 - (n + s);
  }
  getText(e) {
...
class io {
  constructor() {
    this.dynamicProgrammingDiffing = new Wa(), this.myersDiffingAlgorithm = new br();
  }
  computeDiff(e, n, s) {
    if (e.length <= 1 && kr(e, n, (x, C) => x === C))
      return new Ft([], [], !1);
    if (e.length === 1 && e[0].length === 0 || n.length === 1 && n[0].length === 0)
      return new Ft([
        new Ce(new T(1, e.length + 1), new T(1, n.length + 1), [
          new oe(new A(
            1,
            1,
            e.length,
    ...
    const r = s.maxComputationTimeMs === 0 ? Ct.instance : new Ha(s.maxComputationTimeMs), i = !s.ignoreTrimWhitespace, a = /* @__PURE__ */ new Map();
    function l(x) {
      let C = a.get(x);
      return C === void 0 && (C = a.size, a.set(x, C)), C;
    }
    const u = e.map((x) => l(x.trim())), c = n.map((x) => l(x.trim())), h = new Ps(u, e), f = new Ps(c, n), d = h.length + f.length < 1700 ? this.dynamicProgrammingDiffing.compute(h, f, r, (x, C) => e[x] === n[C] ? n[C].length === 0 ? 0.1 : 1 + Math.log(1 + n[C].length) : 0.99) : this.myersDiffingAlgorithm.compute(h, f, r);
    let m = d.diffs, g = d.hitTimeout;
    m = Es(h, f, m), m = so(h, f, m);
    const b = [], w = (x) => {
      if (i)
        for (let C = 0; C < x; C++) {
          const R = L + C, M = _ + C;
          if (e[R] !== n[M]) {
            const U = this.refineDiff(e, n, new Q(new B(R, R + 1), new B(M, M + 1)), r, i);
            for (const J of U.mappings)
              b.push(J);
            U.hitTimeout && (g = !0);
          }
        }
    ...
    let L = 0, _ = 0;
    for (const x of m) {
      Nt(() => x.seq1Range.start - L === x.seq2Range.start - _);
      const C = x.seq1Range.start - L;
      w(C), L = x.seq1Range.endExclusive, _ = x.seq2Range.endExclusive;
      const R = this.refineDiff(e, n, x, r, i);
      R.hitTimeout && (g = !0);
      for (const M of R.mappings)
        b.push(M);
    }
    w(e.length - L);
    const v = vs(b, new Mt(e), new Mt(n));
    let p = [];
    return s.computeMoves && (p = this.computeMoves(v, e, n, u, c, r, i)), Nt(() => {
      function x(R, M) {
        if (R.lineNumber < 1 || R.lineNumber > M.length)
          return !1;
        const U = M[R.lineNumber - 1];
        return !(R.column < 1 || R.column > U.length + 1);
      }
      function C(R, M) {
        return !(R.startLineNumber < 1 || R.startLineNumber > M.length + 1 || R.endLineNumberExclusive < 1 || R.endLineNumberExclusive > M.length + 1);
      }
      for (const R of v) {
        if (!R.innerChanges)
          return !1;
        for (const M of R.innerChanges)
          if (!(x(M.modifiedRange.getStartPosition(), n) && x(M.modifiedRange.getEndPosition(), n) && x(M.originalRange.getStartPosition(), e) && x(M.originalRange.getEndPosition(), e)))
            return !1;
        if (!C(R.modified, n) || !C(R.original, e))
          return !1;
      }
      return !0;
    }), new Ft(v, p, g);
  }
  computeMoves(e, n, s, r, i, a, l) {
    return Ga(e, n, s, r, i, a).map((h) => {
      const f = this.refineDiff(n, s, new Q(h.original.toOffsetRange(), h.modified.toOffsetRange()), a, l), d = vs(f.mappings, new Mt(n), new Mt(s), !0);
      return new $n(h, d);
    });
  }
  refineDiff(e, n, s, r, i) {
    const l = ao(s).toRangeMapping2(e, n), u = new Ot(e, l.originalRange, i), c = new Ot(n, l.modifiedRange, i), h = u.length + c.length < 500 ? this.dynamicProgrammingDiffing.compute(u, c, r) : this.myersDiffingAlgorithm.compute(u, c, r);
    let f = h.diffs;
    return f = Es(u, c, f), f = to(u, c, f), f = eo(u, c, f), f = ro(u, c, f), {
      mappings: f.map((m) => new oe(u.translateRange(m.seq1Range), c.translateRange(m.seq2Range))),
...
class X {
  constructor(e, n, s, r = 1) {
    this._rgbaBrand = void 0, this.r = Math.min(255, Math.max(0, e)) | 0, this.g = Math.min(255, Math.max(0, n)) | 0, this.b = Math.min(255, Math.max(0, s)) | 0, this.a = Te(Math.max(Math.min(1, r), 0), 3);
  }
  static equals(e, n) {
...
class de {
  constructor(e, n, s, r) {
    this._hslaBrand = void 0, this.h = Math.max(Math.min(360, e), 0) | 0, this.s = Te(Math.max(Math.min(1, n), 0), 3), this.l = Te(Math.max(Math.min(1, s), 0), 3), this.a = Te(Math.max(Math.min(1, r), 0), 3);
  }
  static equals(e, n) {
    return e.h === n.h && e.s === n.s && e.l === n.l && e.a === n.a;
  }
  static fromRGBA(e) {
    const n = e.r / 255, s = e.g / 255, r = e.b / 255, i = e.a, a = Math.max(n, s, r), l = Math.min(n, s, r);
    let u = 0, c = 0;
    const h = (l + a) / 2, f = a - l;
    if (f > 0) {
    ...
    return new de(u, c, h, i);
  }
  static _hue2rgb(e, n, s) {
    return s < 0 && (s += 1), s > 1 && (s -= 1), s < 1 / 6 ? e + (n - e) * 6 * s : s < 1 / 2 ? n : s < 2 / 3 ? e + (n - e) * (2 / 3 - s) * 6 : e;
  }
  static toRGBA(e) {
    const n = e.h / 360, { s, l: r, a: i } = e;
    let a, l, u;
    if (s === 0)
      a = l = u = r;
    else {
      const c = r < 0.5 ? r * (1 + s) : r + s - r * s, h = 2 * r - c;
      a = de._hue2rgb(h, c, n + 1 / 3), l = de._hue2rgb(h, c, n), u = de._hue2rgb(h, c, n - 1 / 3);
    }
    return new X(Math.round(a * 255), Math.round(l * 255), Math.round(u * 255), i);
  }
}
class Ye {
  constructor(e, n, s, r) {
    this._hsvaBrand = void 0, this.h = Math.max(Math.min(360, e), 0) | 0, this.s = Te(Math.max(Math.min(1, n), 0), 3), this.v = Te(Math.max(Math.min(1, s), 0), 3), this.a = Te(Math.max(Math.min(1, r), 0), 3);
  }
  static equals(e, n) {
    return e.h === n.h && e.s === n.s && e.v === n.v && e.a === n.a;
  }
  static fromRGBA(e) {
    const n = e.r / 255, s = e.g / 255, r = e.b / 255, i = Math.max(n, s, r), a = Math.min(n, s, r), l = i - a, u = i === 0 ? 0 : l / i;
    let c;
    return l === 0 ? c = 0 : i === n ? c = ((s - r) / l % 6 + 6) % 6 : i === s ? c = (r - n) / l + 2 : c = (n - s) / l + 4, new Ye(Math.round(c * 60), u, i, e.a);
  }
  static toRGBA(e) {
    const { h: n, s, v: r, a: i } = e, a = r * s, l = a * (1 - Math.abs(n / 60 % 2 - 1)), u = r - a;
    let [c, h, f] = [0, 0, 0];
    return n < 60 ? (c = a, h = l) : n < 120 ? (c = l, h = a) : n < 180 ? (h = a, f = l) : n < 240 ? (h = l, f = a) : n < 300 ? (c = l, f = a) : n <= 360 && (c = a, f = l), c = Math.round((c + u) * 255), h = Math.round((h + u) * 255), f = Math.round((f + u) * 255), new X(c, h, f, i);
  }
}
const V = class V {
  static fromHex(e) {
    return V.Format.CSS.parseHex(e) || V.red;
  }
  static equals(e, n) {
  ...
  constructor(e) {
    if (e)
      if (e instanceof X)
        ...
        this._hsva = e, this.rgba = Ye.toRGBA(e);
      else
        throw new Error("Invalid color ctor argument");
    else throw new Error("Color needs a value");
  }
  equals(e) {
    return !!e && X.equals(this.rgba, e.rgba) && de.equals(this.hsla, e.hsla) && Ye.equals(this.hsva, e.hsva);
  }
  getRelativeLuminance() {
    const e = V._relativeLuminanceForComponent(this.rgba.r), n = V._relativeLuminanceForComponent(this.rgba.g), s = V._relativeLuminanceForComponent(this.rgba.b), r = 0.2126 * e + 0.7152 * n + 0.0722 * s;
    return Te(r, 4);
  }
  reduceRelativeLuminace(e, n) {
    let { r: s, g: r, b: i } = e.rgba, a = this.getContrastRatio(e);
    for (; a < n && (s > 0 || r > 0 || i > 0); )
      s -= Math.max(0, Math.ceil(s * 0.1)), r -= Math.max(0, Math.ceil(r * 0.1)), i -= Math.max(0, Math.ceil(i * 0.1)), a = this.getContrastRatio(new V(new X(s, r, i)));
    return new V(new X(s, r, i));
  }
  increaseRelativeLuminace(e, n) {
    let { r: s, g: r, b: i } = e.rgba, a = this.getContrastRatio(e);
    for (; a < n && (s < 255 || r < 255 || i < 255); )
      s = Math.min(255, s + Math.ceil((255 - s) * 0.1)), r = Math.min(255, r + Math.ceil((255 - r) * 0.1)), i = Math.min(255, i + Math.ceil((255 - i) * 0.1)), a = this.getContrastRatio(new V(new X(s, r, i)));
    return new V(new X(s, r, i));
  }
  ...
  getContrastRatio(e) {
    const n = this.getRelativeLuminance(), s = e.getRelativeLuminance();
  ...
  ensureConstrast(e, n) {
    const s = this.getRelativeLuminance(), r = e.getRelativeLuminance();
    if (this.getContrastRatio(e) < n) {
      if (r < s) {
        const u = this.reduceRelativeLuminace(e, n), c = this.getContrastRatio(u);
        if (c < n) {
          const h = this.increaseRelativeLuminace(e, n), f = this.getContrastRatio(h);
          return c > f ? u : h;
        }
        return u;
      }
      const a = this.increaseRelativeLuminace(e, n), l = this.getContrastRatio(a);
      if (l < n) {
        const u = this.reduceRelativeLuminace(e, n), c = this.getContrastRatio(u);
        return l > c ? a : u;
      }
  ...
  lighten(e) {
    return new V(new de(this.hsla.h, this.hsla.s, this.hsla.l + this.hsla.l * e, this.hsla.a));
  }
  darken(e) {
    return new V(new de(this.hsla.h, this.hsla.s, this.hsla.l - this.hsla.l * e, this.hsla.a));
  }
  ...
  opposite() {
    return new V(new X(255 - this.rgba.r, 255 - this.rgba.g, 255 - this.rgba.b, this.rgba.a));
  }
  blend(e) {
    const n = e.rgba, s = this.rgba.a, r = n.a, i = s + r * (1 - s);
    if (i < 1e-6)
      return V.transparent;
    const a = this.rgba.r * s / i + n.r * r * (1 - s) / i, l = this.rgba.g * s / i + n.g * r * (1 - s) / i, u = this.rgba.b * s / i + n.b * r * (1 - s) / i;
    return new V(new X(a, l, u, i));
  }
  makeOpaque(e) {
    ...
    return new V(new X(
      ...
      e.rgba.g - i * (e.rgba.g - s),
      e.rgba.b - i * (e.rgba.b - r),
      1
    ));
  }
  flatten(...e) {
    const n = e.reduceRight((s, r) => V._flatten(r, s));
    return V._flatten(this, n);
  }
  static _flatten(e, n) {
    const s = 1 - e.rgba.a;
    return new V(new X(
      s * n.rgba.r + e.rgba.a * e.rgba.r,
      s * n.rgba.g + e.rgba.a * e.rgba.g,
      s * n.rgba.b + e.rgba.a * e.rgba.b
    ));
  }
  toString() {
    return this._toString || (this._toString = V.Format.CSS.format(this)), this._toString;
  }
  static getLighterColor(e, n, s) {
    if (e.isLighterThan(n))
      return e;
    s = s || 0.5;
    const r = e.getRelativeLuminance(), i = n.getRelativeLuminance();
    return s = s * (i - r) / i, e.lighten(s);
  }
  static getDarkerColor(e, n, s) {
    if (e.isDarkerThan(n))
      return e;
    s = s || 0.5;
    const r = e.getRelativeLuminance(), i = n.getRelativeLuminance();
    return s = s * (r - i) / r, e.darken(s);
  }
};
V.white = new V(new X(255, 255, 255, 1)), V.black = new V(new X(0, 0, 0, 1)), V.red = new V(new X(255, 0, 0, 1)), V.blue = new V(new X(0, 0, 255, 1)), V.green = new V(new X(0, 255, 0, 1)), V.cyan = new V(new X(0, 255, 255, 1)), V.lightgrey = new V(new X(211, 211, 211, 1)), V.transparent = new V(new X(0, 0, 0, 0));
let lt = V;
(function(t) {
  (function(e) {
    (function(n) {
      ...
      n.formatHex = u;
      function c(m, g = !1) {
        return g && m.rgba.a === 1 ? t.Format.CSS.formatHex(m) : `#${l(m.rgba.r)}${l(m.rgba.g)}${l(m.rgba.b)}${l(Math.round(m.rgba.a * 255))}`;
      }
      n.formatHexA = c;
      function h(m) {
      ...
      function f(m) {
        ...
        if (g === 0 || m.charCodeAt(0) !== 35)
          return null;
        if (g === 7) {
          const b = 16 * d(m.charCodeAt(1)) + d(m.charCodeAt(2)), w = 16 * d(m.charCodeAt(3)) + d(m.charCodeAt(4)), L = 16 * d(m.charCodeAt(5)) + d(m.charCodeAt(6));
          return new t(new X(b, w, L, 1));
        }
        if (g === 9) {
          const b = 16 * d(m.charCodeAt(1)) + d(m.charCodeAt(2)), w = 16 * d(m.charCodeAt(3)) + d(m.charCodeAt(4)), L = 16 * d(m.charCodeAt(5)) + d(m.charCodeAt(6)), _ = 16 * d(m.charCodeAt(7)) + d(m.charCodeAt(8));
          return new t(new X(b, w, L, _ / 255));
        }
        if (g === 4) {
          const b = d(m.charCodeAt(1)), w = d(m.charCodeAt(2)), L = d(m.charCodeAt(3));
          return new t(new X(16 * b + b, 16 * w + w, 16 * L + L));
        }
        if (g === 5) {
          const b = d(m.charCodeAt(1)), w = d(m.charCodeAt(2)), L = d(m.charCodeAt(3)), _ = d(m.charCodeAt(4));
          return new t(new X(16 * b + b, 16 * w + w, 16 * L + L, (16 * _ + _) / 255));
        }
        return null;
      }
      n.parseHex = f;
...
function oo(t, e) {
  if (!t)
    return;
  const n = lt.Format.CSS.parseHex(e);
  if (n)
    return {
      range: t,
      color: Hn(n.rgba.r, n.rgba.g, n.rgba.b, n.rgba.a)
    };
}
function Ds(t, e, n) {
  if (!t || e.length !== 1)
    return;
  const r = e[0].values(), i = pr(r);
  return {
    range: t,
    color: Hn(i[0], i[1], i[2], n ? i[3] : 1)
  };
}
function Fs(t, e, n) {
  if (!t || e.length !== 1)
    return;
  const r = e[0].values(), i = pr(r), a = new lt(new de(
    i[0],
    i[1] / 100,
    i[2] / 100,
    n ? i[3] : 1
  ...
  return {
    range: t,
    color: Hn(a.rgba.r, a.rgba.g, a.rgba.b, a.rgba.a)
  };
}
function ht(t, e) {
...
function lo(t) {
  const e = [], s = ht(t, /\b(rgb|rgba|hsl|hsla)(\([0-9\s,.\%]*\))|(#)([A-Fa-f0-9]{3})\b|(#)([A-Fa-f0-9]{4})\b|(#)([A-Fa-f0-9]{6})\b|(#)([A-Fa-f0-9]{8})\b/gm);
  if (s.length > 0)
    for (const r of s) {
      const i = r.filter((c) => c !== void 0), a = i[1], l = i[2];
      if (!l)
        continue;
      let u;
      if (a === "rgb") {
        ...
        u = Ds(ct(t, r), ht(l, c), !0);
      } else if (a === "hsl") {
        const c = /^\(\s*(36[0]|3[0-5][0-9]|[12][0-9][0-9]|[1-9]?[0-9])\s*,\s*(100|\d{1,2}[.]\d*|\d{1,2})%\s*,\s*(100|\d{1,2}[.]\d*|\d{1,2})%\s*\)$/gm;
        u = Fs(ct(t, r), ht(l, c), !1);
      } else if (a === "hsla") {
        const c = /^\(\s*(36[0]|3[0-5][0-9]|[12][0-9][0-9]|[1-9]?[0-9])\s*,\s*(100|\d{1,2}[.]\d*|\d{1,2})%\s*,\s*(100|\d{1,2}[.]\d*|\d{1,2})%\s*,\s*(0[.][0-9]+|[.][0-9]+|[01][.]|[01])\s*\)$/gm;
        u = Fs(ct(t, r), ht(l, c), !0);
      } else a === "#" && (u = oo(ct(t, r), a + l));
      u && e.push(u);
    }
  return e;
}
function uo(t) {
  return !t || typeof t.getValue != "function" || typeof t.positionAt != "function" ? [] : lo(t);
}
const Is = new RegExp("\\bMARK:\\s*(.*)$", "d"), co = /^-+|-+$/g;
function ho(t, e) {
  var s;
  let n = [];
  if (e.findRegionSectionHeaders && ((s = e.foldingRules) != null && s.markers)) {
    const r = fo(t, e);
    n = n.concat(r);
  }
...
function fo(t, e) {
  const n = [], s = t.getLineCount();
  for (let r = 1; r <= s; r++) {
    const i = t.getLineContent(r), a = i.match(e.foldingRules.markers.start);
    if (a) {
      const l = { startLineNumber: r, startColumn: a[0].length + 1, endLineNumber: r, endColumn: i.length + 1 };
      if (l.endColumn > l.startColumn) {
        const u = {
          range: l,
          ...xr(i.substring(a[0].length)),
...
function go(t, e, n) {
  ...
  const s = Is.exec(t);
  if (s) {
    const r = s.indices[1][0] + 1, i = s.indices[1][1] + 1, a = { startLineNumber: e, startColumn: r, endLineNumber: e, endColumn: i };
...
function xr(t) {
  ...
  return t = t.replace(co, ""), { text: t, hasSeparatorLine: e };
}
function Ee(t) {
  return t === 47 || t === 92;
}
function wr(t) {
  return t.replace(/[\\/]/g, z.sep);
}
function bo(t) {
  return t.indexOf("/") === -1 && (t = wr(t)), /^[a-zA-Z]:(\/|$)/.test(t) && (t = "/" + t), t;
}
function Vs(t, e = z.sep) {
  if (!t)
    return "";
  const n = t.length, s = t.charCodeAt(0);
  if (Ee(s)) {
    if (Ee(t.charCodeAt(1)) && !Ee(t.charCodeAt(2))) {
      let i = 3;
      const a = i;
      for (; i < n && !Ee(t.charCodeAt(i)); i++)
        ;
      if (a !== i && !Ee(t.charCodeAt(i + 1))) {
        for (i += 1; i < n; i++)
          if (Ee(t.charCodeAt(i)))
            return t.slice(0, i + 1).replace(/[\\/]/g, e);
      }
    }
    return e;
  } else if (po(s) && t.charCodeAt(1) === 58)
    return Ee(t.charCodeAt(2)) ? t.slice(0, 2) + e : t.slice(0, 2);
  let r = t.indexOf("://");
  if (r !== -1) {
    for (r += 3; r < n; r++)
      if (Ee(t.charCodeAt(r)))
        return t.slice(0, r + 1);
  }
  return "";
}
function Bs(t, e, n, s = Dt) {
  if (t === e)
    return !0;
  ...
  if (n) {
    ...
    if (e.length === t.length)
      return !0;
    let i = e.length;
    return e.charAt(e.length - 1) === s && i--, t.charAt(i) === s;
  }
...
class wo {
  ...
  setServerRootPath(e, n) {
    this._serverRootPath = Lo(e, n);
  }
  getServerRootPath() {
    return this._serverRootPath;
  }
  get _remoteResourcesPath() {
    return z.join(this._serverRootPath, se.vscodeRemoteResource);
  }
  set(e, n, s) {
    this._hosts[e] = n, this._ports[e] = s;
  }
  ...
  rewrite(e) {
    ...
    return typeof i == "string" && (a += `&${xo}=${encodeURIComponent(i)}`), te.from({
      scheme: ii ? this._preferredWebSchema : se.vscodeRemoteResource,
      authority: `${s}:${r}`,
...
const _o = new wo();
function Lo(t, e) {
  return z.join(e ?? "/", `${t.quality ?? "oss"}-${t.commit ?? "dev"}`);
}
const vo = "vscode-app", tt = class tt {
  constructor() {
    this.staticBrowserUris = new fn(), this.appResourcePathUrls = /* @__PURE__ */ new Map();
  }
  ...
  toUrl(e) {
    var s;
    let n = this.appResourcePathUrls.get(e);
    return typeof n == "function" && (n = n()), new URL(n ?? e, ((s = globalThis.location) == null ? void 0 : s.href) ?? "file:///home/jazzpirate/work/Software/sTeX/iMMT/source/ts/editor/node_modules/monaco-editor-wrapper/dist/workers/editorWorker-es.js").toString();
  }
  asBrowserUri(e) {
  ...
  uriToBrowserUri(e) {
    return e.scheme === se.vscodeRemote ? _o.rewrite(e) : e.scheme === se.file && (ri || oi === `${se.vscodeFileResource}://${tt.FALLBACK_AUTHORITY}`) ? e.with({
      scheme: se.vscodeFileResource,
  ...
  uriToFileUri(e) {
    return e.scheme === se.vscodeFileResource ? e.with({
      scheme: se.file,
      authority: e.authority !== tt.FALLBACK_AUTHORITY ? e.authority : null,
      query: null,
      fragment: null
    }) : e;
  }
  toUri(e, n) {
    ...
    if (globalThis._VSCODE_FILE_ROOT) {
      ...
      if (/^\w[\w\d+.-]*:\/\//.test(s))
        return te.joinPath(te.parse(s, !0), e);
      const r = na(s, e);
      return te.file(r);
    }
    return te.parse(n.toUrl(e));
  }
  registerStaticBrowserUri(e, n) {
    return this.staticBrowserUris.set(e, n), _t(() => {
...
(function(t) {
  ...
  function s(i) {
    let a;
    typeof i == "string" ? a = new URL(i).searchParams : i instanceof URL ? a = i.searchParams : te.isUri(i) && (a = new URL(i.toString(!0)).searchParams);
...
class No {
  ...
  compare(e, n, s = !1) {
    return e === n ? 0 : pi(this.getComparisonKey(e, s), this.getComparisonKey(n, s));
  }
  isEqual(e, n, s = !1) {
    return e === n ? !0 : !e || !n ? !1 : this.getComparisonKey(e, s) === this.getComparisonKey(n, s);
  }
  ...
  isEqualOrParent(e, n, s = !1) {
    if (e.scheme === n.scheme) {
      if (e.scheme === se.file)
        return Bs(Le(e), Le(n), this._ignorePathCasing(e)) && e.query === n.query && (s || e.fragment === n.fragment);
      if (Us(e.authority, n.authority))
        return Bs(e.path, n.path, this._ignorePathCasing(e), "/") && e.query === n.query && (s || e.fragment === n.fragment);
    }
    return !1;
  }
  joinPath(e, ...n) {
    return te.joinPath(e, ...n);
  }
  basenameOrAuthority(e) {
    return Co(e) || e.authority;
  }
  basename(e) {
    return z.basename(e.path);
  }
  extname(e) {
    return z.extname(e.path);
  }
  dirname(e) {
    if (e.path.length === 0)
      return e;
    let n;
    return e.scheme === se.file ? n = te.file(ia(Le(e))).path : (n = z.dirname(e.path), e.authority && n.length && n.charCodeAt(0) !== 47 && (console.error(`dirname("${e.toString})) resulted in a relative path`), n = "/")), e.with({
      path: n
    });
  }
  normalizePath(e) {
    if (!e.path.length)
      return e;
    let n;
    return e.scheme === se.file ? n = te.file(ta(Le(e))).path : n = z.normalize(e.path), e.with({
      path: n
    });
  }
  relativePath(e, n) {
    if (e.scheme !== n.scheme || !Us(e.authority, n.authority))
      return;
    if (e.scheme === se.file) {
      const i = ra(Le(e), Le(n));
      return ot ? wr(i) : i;
    }
    let s = e.path || "/";
    const r = n.path || "/";
    if (this._ignorePathCasing(e)) {
      let i = 0;
      for (const a = Math.min(s.length, r.length); i < a && !(s.charCodeAt(i) !== r.charCodeAt(i) && s.charAt(i).toLowerCase() !== r.charAt(i).toLowerCase()); i++)
        ;
      s = r.substr(0, i) + s.substr(i);
    }
    return z.relative(s, r);
  }
  resolvePath(e, n) {
    if (e.scheme === se.file) {
      const s = te.file(sa(Le(e), n));
      return e.with({
        authority: s.authority,
        path: s.path
      });
    }
    return n = bo(n), e.with({
      path: z.resolve(e.path, n)
    });
  }
  isAbsolutePath(e) {
  ...
  isEqualAuthority(e, n) {
    return e === n || e !== void 0 && n !== void 0 && wi(e, n);
  }
  hasTrailingPathSeparator(e, n = Dt) {
    if (e.scheme === se.file) {
      const s = Le(e);
      return s.length > Vs(s).length && s[s.length - 1] === n;
    } else {
      const s = e.path;
      return s.length > 1 && s.charCodeAt(s.length - 1) === 47 && !/^[a-zA-Z]:(\/$|\\$)/.test(e.fsPath);
    }
  }
  removeTrailingPathSeparator(e, n = Dt) {
    return $s(e, n) ? e.with({ path: e.path.substr(0, e.path.length - 1) }) : e;
  }
  addTrailingPathSeparator(e, n = Dt) {
    let s = !1;
    if (e.scheme === se.file) {
      const r = Le(e);
      s = r !== void 0 && r.length === Vs(r).length && r[r.length - 1] === n;
    } else {
      n = "/";
      const r = e.path;
      s = r.length === 1 && r.charCodeAt(r.length - 1) === 47;
    }
    return !s && !$s(e, n) ? e.with({ path: e.path + "/" }) : e;
  }
}
const H = new No(() => !1);
H.isEqual.bind(H);
...
const Us = H.isEqualAuthority.bind(H), $s = H.hasTrailingPathSeparator.bind(H);
...
(function(t) {
  ...
  function e(n) {
    ...
    return i && s.set(t.META_DATA_MIME, i), s;
  }
  t.parseMetaData = e;
})(Hs || (Hs = {}));
var Ws;
(function(t) {
  async function e(s) {
    let r;
    const i = await Promise.all(s.map((a) => a.then((l) => l, (l) => {
      r || (r = l);
    })));
    if (typeof r < "u")
      throw r;
...
const ae = class ae {
  ...
  constructor(e, n) {
    this._state = 0, this._results = [], this._error = null, this._onReturn = n, this._onStateChanged = new fe(), queueMicrotask(async () => {
      const s = {
    ...
    return {
      next: async () => {
        do {
          ...
          await Bt.toPromise(this._onStateChanged.event);
        } while (!0);
      },
      return: async () => {
        var n;
...
class So {
  ...
  insertValues(e, n) {
    ...
    return i === 0 ? !1 : (this.values = new Uint32Array(s.length + i), this.values.set(s.subarray(0, e), 0), this.values.set(s.subarray(e), e + i), this.values.set(n, e), e - 1 < this.prefixSumValidIndex[0] && (this.prefixSumValidIndex[0] = e - 1), this.prefixSum = new Uint32Array(this.values.length), this.prefixSumValidIndex[0] >= 0 && this.prefixSum.set(r.subarray(0, this.prefixSumValidIndex[0] + 1)), !0);
  }
  setValue(e, n) {
    return e = Oe(e), n = Oe(n), this.values[e] === n ? !1 : (this.values[e] = n, e - 1 < this.prefixSumValidIndex[0] && (this.prefixSumValidIndex[0] = e - 1), !0);
  }
  removeValues(e, n) {
    e = Oe(e), n = Oe(n);
    ...
    if (e >= s.length)
      return !1;
    const i = s.length - e;
    return n >= i && (n = i), n === 0 ? !1 : (this.values = new Uint32Array(s.length - n), this.values.set(s.subarray(0, e), 0), this.values.set(s.subarray(e + n), e), this.prefixSum = new Uint32Array(this.values.length), e - 1 < this.prefixSumValidIndex[0] && (this.prefixSumValidIndex[0] = e - 1), this.prefixSumValidIndex[0] >= 0 && this.prefixSum.set(r.subarray(0, this.prefixSumValidIndex[0] + 1)), !0);
  }
  getTotalSum() {
    return this.values.length === 0 ? 0 : this._getPrefixSum(this.values.length - 1);
  }
  getPrefixSum(e) {
    return e < 0 ? 0 : (e = Oe(e), this._getPrefixSum(e));
  }
  _getPrefixSum(e) {
  ...
  getIndexOf(e) {
    ...
    let n = 0, s = this.values.length - 1, r = 0, i = 0, a = 0;
    for (; n <= s; )
      if (r = n + (s - n) / 2 | 0, i = this.prefixSum[r], a = i - this.values[r], e < a)
        s = r - 1;
      else if (e >= i)
        n = r + 1;
      else
...
class Ao {
  constructor(e, n, s, r) {
    this._uri = e, this._lines = n, this._eol = s, this._versionId = r, this._lineStarts = null, this._cachedTextValue = null;
  }
  dispose() {
  ...
  _ensureLineStarts() {
    if (!this._lineStarts) {
      const e = this._eol.length, n = this._lines.length, s = new Uint32Array(n);
      for (let r = 0; r < n; r++)
        s[r] = this._lines[r].length + e;
      this._lineStarts = new So(s);
    }
  }
  _setLineText(e, n) {
  ...
  _acceptInsertText(e, n) {
    ...
    const s = mi(n);
    if (s.length === 1) {
      this._setLineText(e.lineNumber - 1, this._lines[e.lineNumber - 1].substring(0, e.column - 1) + s[0] + this._lines[e.lineNumber - 1].substring(e.column - 1));
      return;
    }
    s[s.length - 1] += this._lines[e.lineNumber - 1].substring(e.column - 1), this._setLineText(e.lineNumber - 1, this._lines[e.lineNumber - 1].substring(0, e.column - 1) + s[0]);
    const r = new Uint32Array(s.length - 1);
    for (let i = 1; i < s.length; i++)
      this._lines.splice(e.lineNumber + i - 1, 0, s[i]), r[i - 1] = s[i].length + this._eol.length;
    this._lineStarts && this._lineStarts.insertValues(e.lineNumber, r);
  }
}
const yo = "workerTextModelSync";
class Eo {
  constructor() {
    this._models = /* @__PURE__ */ Object.create(null);
  }
  bindToServer(e) {
    e.setChannel(yo, this);
  }
  getModel(e) {
  ...
  $acceptNewModel(e) {
    this._models[e.url] = new Mo(te.parse(e.url), e.lines, e.EOL, e.versionId);
  }
...
class Mo extends Ao {
  ...
  findMatches(e) {
    ...
    for (let s = 0; s < this._lines.length; s++) {
      const r = this._lines[s], i = this.offsetAt(new q(s + 1, 1)), a = r.matchAll(e);
      for (const l of a)
  ...
  getWordAtPosition(e, n) {
    const s = Un(e.column, hr(n), this._lines[e.lineNumber - 1], 0);
    return s ? new A(
      e.lineNumber,
      s.startColumn,
      e.lineNumber,
  ...
  getWordUntilPosition(e, n) {
    const s = this.getWordAtPosition(e, n);
    return s ? {
      word: this._lines[e.lineNumber - 1].substring(s.startColumn - 1, e.column - 1),
  ...
  words(e) {
    ...
    return {
      *[Symbol.iterator]() {
        for (; ; )
          if (a < l.length) {
            const u = i.substring(l[a].start, l[a].end);
            a += 1, yield u;
          } else if (r < n.length)
            i = n[r], l = s(i, e), a = 0, r += 1;
          else
            break;
      }
    };
  ...
  getLineWords(e, n) {
    const s = this._lines[e - 1], r = this._wordenize(s, n), i = [];
    for (const a of r)
      i.push({
  ...
  getValueInRange(e) {
    ...
    const n = this._eol, s = e.startLineNumber - 1, r = e.endLineNumber - 1, i = [];
    i.push(this._lines[s].substring(e.startColumn - 1));
    for (let a = s + 1; a < r; a++)
      i.push(this._lines[a]);
    return i.push(this._lines[r].substring(0, e.endColumn - 1)), i.join(n);
  }
  offsetAt(e) {
  ...
  positionAt(e) {
    ...
    const n = this._lineStarts.getIndexOf(e), s = this._lines[n.index].length;
    return {
  ...
  _validateRange(e) {
    const n = this._validatePosition({ lineNumber: e.startLineNumber, column: e.startColumn }), s = this._validatePosition({ lineNumber: e.endLineNumber, column: e.endColumn });
    return n.lineNumber !== e.startLineNumber || n.column !== e.startColumn || s.lineNumber !== e.endLineNumber || s.column !== e.endColumn ? {
  ...
  _validatePosition(e) {
    ...
    let { lineNumber: n, column: s } = e, r = !1;
    if (n < 1)
      n = 1, s = 1, r = !0;
    ...
    return r ? { lineNumber: n, column: s } : e;
  }
}
const Zt = class Zt {
  constructor() {
    this._workerTextModelSyncServer = new Eo();
  }
  dispose() {
  }
  _getModel(e) {
  ...
  async $computeUnicodeHighlights(e, n, s) {
    const r = this._getModel(e);
    return r ? Pa.computeUnicodeHighlights(r, n, s) : { ranges: [], hasMore: !1, ambiguousCharacterCount: 0, invisibleCharacterCount: 0, nonBasicAsciiCharacterCount: 0 };
  }
  async $findSectionHeaders(e, n) {
    const s = this._getModel(e);
    return s ? ho(s, n) : [];
  }
  async $computeDiff(e, n, s, r) {
    const i = this._getModel(e), a = this._getModel(n);
    return !i || !a ? null : ft.computeDiff(i, a, s, r);
  }
  static computeDiff(e, n, s, r) {
    const i = r === "advanced" ? ln.getDefault() : ln.getLegacy(), a = e.getLinesContent(), l = n.getLinesContent(), u = i.computeDiff(a, l, s), c = u.changes.length > 0 ? !1 : this._modelsAreIdentical(e, n);
    function h(f) {
      return f.map(
        (d) => {
          var m;
  ...
  static _modelsAreIdentical(e, n) {
    const s = e.getLineCount(), r = n.getLineCount();
    if (s !== r)
      return !1;
    for (let i = 1; i <= s; i++) {
      const a = e.getLineContent(i), l = n.getLineContent(i);
      if (a !== l)
        return !1;
    }
    return !0;
  }
  async $computeDirtyDiff(e, n, s) {
    const r = this._getModel(e), i = this._getModel(n);
    if (!r || !i)
      return null;
    const a = r.getLinesContent(), l = i.getLinesContent();
    return new gr(a, l, {
  ...
  async $computeMoreMinimalEdits(e, n, s) {
    const r = this._getModel(e);
    if (!r)
      return n;
    const i = [];
    ...
    n = n.slice(0).sort((u, c) => {
      if (u.range && c.range)
        return A.compareRangesUsingStarts(u.range, c.range);
      const h = u.range ? 0 : 1, f = c.range ? 0 : 1;
      return h - f;
    });
    let l = 0;
    for (let u = 1; u < n.length; u++)
      A.getEndPosition(n[l].range).equals(A.getStartPosition(n[u].range)) ? (n[l].range = A.fromPositions(A.getStartPosition(n[l].range), A.getEndPosition(n[u].range)), n[l].text += n[u].text) : (l++, n[l] = n[u]);
    n.length = l + 1;
    for (let { range: u, text: c, eol: h } of n) {
      if (typeof h == "number" && (a = h), A.isEmpty(u) && !c)
        continue;
      const f = r.getValueInRange(u);
      if (c = c.replace(/\r\n|\n|\r/g, r.eol), f === c)
        continue;
      if (Math.max(c.length, f.length) > ft._diffLimit) {
        i.push({ range: u, text: c });
        continue;
      }
      const d = Fi(f, c, s), m = r.offsetAt(A.lift(u).getStartPosition());
      for (const g of d) {
        const b = r.positionAt(m + g.originalStart), w = r.positionAt(m + g.originalStart + g.originalLength), L = {
  ...
  $computeHumanReadableDiff(e, n, s) {
    const r = this._getModel(e);
    if (!r)
      return n;
    const i = [];
    ...
    n = n.slice(0).sort((l, u) => {
      if (l.range && u.range)
        return A.compareRangesUsingStarts(l.range, u.range);
    ...
    for (let { range: l, text: u, eol: c } of n) {
      let b = function(L, _) {
        return new q(
          L.lineNumber + _.lineNumber - 1,
          _.lineNumber === 1 ? L.column + _.column - 1 : _.column
        );
      }, w = function(L, _) {
        const v = [];
        for (let p = _.startLineNumber; p <= _.endLineNumber; p++) {
          const x = L[p - 1];
          p === _.startLineNumber && p === _.endLineNumber ? v.push(x.substring(_.startColumn - 1, _.endColumn - 1)) : p === _.startLineNumber ? v.push(x.substring(_.startColumn - 1)) : p === _.endLineNumber ? v.push(x.substring(0, _.endColumn - 1)) : v.push(x);
        }
        return v;
      };
      if (typeof c == "number" && (a = c), A.isEmpty(l) && !u)
        continue;
      const h = r.getValueInRange(l);
      if (u = u.replace(/\r\n|\n|\r/g, r.eol), h === u)
        continue;
      if (Math.max(u.length, h.length) > ft._diffLimit) {
        i.push({ range: l, text: u });
        continue;
      }
      const f = h.split(/\r\n|\n|\r/), d = u.split(/\r\n|\n|\r/), m = ln.getDefault().computeDiff(f, d, s), g = A.lift(l).getStartPosition();
      for (const L of m.changes)
        if (L.innerChanges)
          for (const _ of L.innerChanges)
            i.push({
              range: A.fromPositions(b(g, _.originalRange.getStartPosition()), b(g, _.originalRange.getEndPosition())),
              text: w(d, _.modifiedRange).join(r.eol)
            });
        else
          throw new re("The experimental diff algorithm always produces inner changes");
    }
    return typeof a == "number" && i.push({ eol: a, text: "", range: { startLineNumber: 0, startColumn: 0, endLineNumber: 0, endColumn: 0 } }), i;
  }
  ...
  async $textualSuggest(e, n, s, r) {
    const i = new Kt(), a = new RegExp(s, r), l = /* @__PURE__ */ new Set();
    e: for (const u of e) {
  ...
  async $computeWordRanges(e, n, s, r) {
    const i = this._getModel(e);
    if (!i)
      return /* @__PURE__ */ Object.create(null);
    const a = new RegExp(s, r), l = /* @__PURE__ */ Object.create(null);
    for (let u = n.startLineNumber; u < n.endLineNumber; u++) {
      const c = i.getLineWords(u, a);
      for (const h of c) {
  ...
  async $navigateValueSet(e, n, s, r, i) {
    ...
    return xn.INSTANCE.navigateValueSet(n, u, c, h, s);
  }
};
Zt._diffLimit = 1e5, Zt._suggestionsLimit = 1e4;
let Tn = Zt;
class ft extends Tn {
  constructor(e, n) {
  ...
  $loadForeignModule(e, n, s) {
    const a = {
      host: va(s, (l, u) => this._host.$fhr(l, u)),
      getMirrorModels: () => this._getModels()
    };
    return this._foreignModuleFactory ? (this._foreignModule = this._foreignModuleFactory(a, n), Promise.resolve(La(this._foreignModule))) : Promise.reject(new Error("Unexpected usage"));
  }
  $fmr(e, n) {
...
typeof importScripts == "function" && (globalThis.monaco = wa());
let Dn = !1;
function _r(t) {
  if (Dn)
    return;
...
var __webpack_exports__bootstrapSimpleEditorWorker = __webpack_exports__.bootstrapSimpleEditorWorker;
var __webpack_exports__initialize = __webpack_exports__.initialize;
export { __webpack_exports__bootstrapSimpleEditorWorker as bootstrapSimpleEditorWorker, __webpack_exports__initialize as initialize };

//# sourceMappingURL=vendors-node_modules_monaco-editor-wrapper_dist_workers_editorWorker-es_js.immt_editor.js.map