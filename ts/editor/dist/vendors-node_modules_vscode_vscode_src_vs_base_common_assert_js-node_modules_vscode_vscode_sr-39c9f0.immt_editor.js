(self["webpackChunkimmt_editor"] = self["webpackChunkimmt_editor"] || []).push([["vendors-node_modules_vscode_vscode_src_vs_base_common_assert_js-node_modules_vscode_vscode_sr-39c9f0"],{
...
/* harmony export */ });
/* harmony import */ var _arraysFind_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./arraysFind.js */ "./node_modules/vscode/vscode/src/vs/base/common/arraysFind.js");
...
function topStep(array, compare, result, i, m) {
    for (const n = result.length; i < m; i++) {
        ...
        if (compare(element, result[n - 1]) < 0) {
            result.pop();
            const j = (0,_arraysFind_js__WEBPACK_IMPORTED_MODULE_0__.findFirstIdxMonotonousOrArrLen)(result, e => compare(element, e) < 0);
...
class Cache {
    ...
    get() {
        ...
        const cts = ( new _cancellation_js__WEBPACK_IMPORTED_MODULE_0__.CancellationTokenSource());
...
/* harmony export */   getAllCodicons: () => (/* binding */ getAllCodicons)
/* harmony export */ });
/* harmony import */ var _codiconsUtil_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./codiconsUtil.js */ "./node_modules/vscode/vscode/src/vs/base/common/codiconsUtil.js");
/* harmony import */ var _codiconsLibrary_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./codiconsLibrary.js */ "./node_modules/vscode/vscode/src/vs/base/common/codiconsLibrary.js");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   SetWithKey: () => (/* binding */ SetWithKey),
...
/* harmony export */   ReadonlyError: () => (/* binding */ ReadonlyError),
...
/* harmony export */   transformErrorFromSerialization: () => (/* binding */ transformErrorFromSerialization)
/* harmony export */ });
class ErrorHandler {
    constructor() {
        this.listeners = [];
...
/* harmony export */   DynamicListEventMultiplexer: () => (/* binding */ DynamicListEventMultiplexer),
...
/* harmony export */   ValueWithChangeEvent: () => (/* binding */ ValueWithChangeEvent),
...
/* harmony export */   trackSetChanges: () => (/* binding */ trackSetChanges)
/* harmony export */ });
/* harmony import */ var _collections_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./collections.js */ "./node_modules/vscode/vscode/src/vs/base/common/collections.js");
/* harmony import */ var _errors_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./errors.js */ "./node_modules/vscode/vscode/src/vs/base/common/errors.js");
/* harmony import */ var _functional_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./functional.js */ "./node_modules/vscode/vscode/src/vs/base/common/functional.js");
/* harmony import */ var _lifecycle_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./lifecycle.js */ "./node_modules/vscode/vscode/src/vs/base/common/lifecycle.js");
/* harmony import */ var _linkedList_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./linkedList.js */ "./node_modules/vscode/vscode/src/vs/base/common/linkedList.js");
/* harmony import */ var _stopwatch_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./stopwatch.js */ "./node_modules/vscode/vscode/src/vs/base/common/stopwatch.js");
...
var Event;
( (function(Event) {
    Event.None = () => _lifecycle_js__WEBPACK_IMPORTED_MODULE_3__.Disposable.None;
    ...
    function any(...events) {
        return (listener, thisArgs = null, disposables) => {
            const disposable = (0,_lifecycle_js__WEBPACK_IMPORTED_MODULE_3__.combinedDisposable)(...( events.map(event => event(e => listener.call(thisArgs, e)))));
    ...
    function fromObservableLight(observable) {
        return (listener, thisArgs, disposables) => {
            ...
            if (disposables instanceof _lifecycle_js__WEBPACK_IMPORTED_MODULE_3__.DisposableStore) {
...
class EventProfiling {
    ...
    start(listenerCount) {
        this._stopWatch = ( new _stopwatch_js__WEBPACK_IMPORTED_MODULE_5__.StopWatch());
...
class Emitter {
    constructor(options) {
        ...
        this._leakageMon = (_globalLeakWarningThreshold > 0 || this._options?.leakWarningThreshold)
            ? ( new LeakageMonitor(
            options?.onListenerError ?? _errors_js__WEBPACK_IMPORTED_MODULE_1__.onUnexpectedError,
    ...
    get event() {
        this._event ??= (callback, thisArgs, disposables) => {
            if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
                ...
                const errorHandler = this._options?.onListenerError || _errors_js__WEBPACK_IMPORTED_MODULE_1__.onUnexpectedError;
                errorHandler(error);
                return _lifecycle_js__WEBPACK_IMPORTED_MODULE_3__.Disposable.None;
            }
            if (this._disposed) {
                return _lifecycle_js__WEBPACK_IMPORTED_MODULE_3__.Disposable.None;
            }
            ...
            this._size++;
            const result = (0,_lifecycle_js__WEBPACK_IMPORTED_MODULE_3__.toDisposable)(() => {
                removeMonitor?.();
...
class AsyncEmitter extends Emitter {
    async fireAsync(data, token, promiseJoin) {
        ...
        if (!this._asyncDeliveryQueue) {
            this._asyncDeliveryQueue = ( new _linkedList_js__WEBPACK_IMPORTED_MODULE_4__.LinkedList());
        }
        ...
        while (this._asyncDeliveryQueue.size > 0 && !token.isCancellationRequested) {
            ...
            try {
                ...
                (0,_errors_js__WEBPACK_IMPORTED_MODULE_1__.onUnexpectedError)(e);
                continue;
            }
            await Promise.allSettled(thenables).then(values => {
                for (const value of values) {
                    if (value.status === 'rejected') {
                        (0,_errors_js__WEBPACK_IMPORTED_MODULE_1__.onUnexpectedError)(value.reason);
                    }
                }
            });
        }
...
class PauseableEmitter extends Emitter {
    ...
    constructor(options) {
        super(options);
        this._isPaused = 0;
        this._eventQueue = ( new _linkedList_js__WEBPACK_IMPORTED_MODULE_4__.LinkedList());
...
class EventMultiplexer {
    ...
    add(event) {
        ...
        return (0,_lifecycle_js__WEBPACK_IMPORTED_MODULE_3__.toDisposable)((0,_functional_js__WEBPACK_IMPORTED_MODULE_2__.createSingleCallFunction)(dispose));
    }
    onFirstListenerAdd() {
...
class DynamicListEventMultiplexer {
    constructor(items, onAddItem, onRemoveItem, getEvent) {
        this._store = ( new _lifecycle_js__WEBPACK_IMPORTED_MODULE_3__.DisposableStore());
        const multiplexer = this._store.add(( new EventMultiplexer()));
        const itemListeners = this._store.add(( new _lifecycle_js__WEBPACK_IMPORTED_MODULE_3__.DisposableMap()));
...
class Relay {
    constructor() {
        ...
        this.inputEventListener = _lifecycle_js__WEBPACK_IMPORTED_MODULE_3__.Disposable.None;
        this.emitter = ( new Emitter({
            onDidAddFirstListener: () => {
                this.listening = true;
...
function trackSetChanges(getData, onDidChangeData, handleItem) {
    const map = ( new _lifecycle_js__WEBPACK_IMPORTED_MODULE_3__.DisposableMap());
    let oldData = ( new Set(getData()));
    for (const d of oldData) {
        map.set(d, handleItem(d));
    }
    const store = ( new _lifecycle_js__WEBPACK_IMPORTED_MODULE_3__.DisposableStore());
    store.add(onDidChangeData(() => {
        const newData = getData();
        const diff = (0,_collections_js__WEBPACK_IMPORTED_MODULE_0__.diffSets)(oldData, newData);
...
/* harmony import */ var _platform_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./platform.js */ "./node_modules/vscode/vscode/src/vs/base/common/platform.js");
...
/* harmony import */ var _types_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./types.js */ "./node_modules/vscode/vscode/src/vs/base/common/types.js");
...
function isValidBasename(name, isWindowsOS = _platform_js__WEBPACK_IMPORTED_MODULE_1__.isWindows) {
...
function isEqual(pathA, pathB, ignoreCase) {
    ...
    return (0,_strings_js__WEBPACK_IMPORTED_MODULE_2__.equalsIgnoreCase)(pathA, pathB);
}
...
function getDriveLetter(path, isWindowsOS = _platform_js__WEBPACK_IMPORTED_MODULE_1__.isWindows) {
...
function parseLineAndColumnAware(rawPath) {
    ...
    for (const segment of segments) {
        ...
        if (!(0,_types_js__WEBPACK_IMPORTED_MODULE_3__.isNumber)(segmentAsNumber)) {
...
function randomPath(parent, prefix, randomLength = 8) {
    ...
    for (let i = 0; i < randomLength; i++) {
        let pathCharsTouse;
        if (i === 0 && _platform_js__WEBPACK_IMPORTED_MODULE_1__.isWindows && !prefix && (randomLength === 3 || randomLength === 4)) {
...
/* harmony export */   DisposableTracker: () => (/* binding */ DisposableTracker),
/* harmony export */   ImmortalReference: () => (/* binding */ ImmortalReference),
/* harmony export */   MandatoryMutableDisposable: () => (/* binding */ MandatoryMutableDisposable),
...
/* harmony import */ var _collections_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./collections.js */ "./node_modules/vscode/vscode/src/vs/base/common/collections.js");
...
/* harmony import */ var _functional_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./functional.js */ "./node_modules/vscode/vscode/src/vs/base/common/functional.js");
/* harmony import */ var _iterator_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./iterator.js */ "./node_modules/vscode/vscode/src/vs/base/common/iterator.js");
...
class DisposableTracker {
    ...
    computeLeakingDisposables(maxReported = 10, preComputedLeaks) {
        ...
        const stackTraceStarts = ( new _map_js__WEBPACK_IMPORTED_MODULE_2__.SetMap());
        ...
        uncoveredLeakingObjs.sort((0,_arrays_js__WEBPACK_IMPORTED_MODULE_0__.compareBy)(l => l.idx, _arrays_js__WEBPACK_IMPORTED_MODULE_0__.numberComparator));
        let message = '';
        let i = 0;
        for (const leaking of uncoveredLeakingObjs.slice(0, maxReported)) {
            ...
            for (let i = 0; i < stackTracePath.length; i++) {
                ...
                const continuations = (0,_collections_js__WEBPACK_IMPORTED_MODULE_1__.groupBy)(( [...prevStarts].map(d => getStackTracePath(d)[i])), v => v);
...
function dispose(arg) {
    if (_iterator_js__WEBPACK_IMPORTED_MODULE_4__.Iterable.is(arg)) {
        const errors = [];
        for (const d of arg) {
            if (d) {
                try {
...
function toDisposable(fn) {
    const self = trackDisposable({
        dispose: (0,_functional_js__WEBPACK_IMPORTED_MODULE_3__.createSingleCallFunction)(() => {
            markAsDisposed(self);
            fn();
        })
    });
...
class ReferenceCollection {
    ...
    acquire(key, ...args) {
        ...
        const dispose = (0,_functional_js__WEBPACK_IMPORTED_MODULE_3__.createSingleCallFunction)(() => {
...
/* harmony export */   CounterSet: () => (/* binding */ CounterSet),
/* harmony export */   LRUCache: () => (/* binding */ LRUCache),
/* harmony export */   LinkedMap: () => (/* binding */ LinkedMap),
/* harmony export */   MRUCache: () => (/* binding */ MRUCache),
...
/* harmony export */   mapsStrictEqualIgnoreOrder: () => (/* binding */ mapsStrictEqualIgnoreOrder)
/* harmony export */ });
var _a, _b, _c;
...
/* harmony import */ var _platform_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./platform.js */ "./node_modules/vscode/vscode/src/vs/base/common/platform.js");
/* harmony import */ var _strings_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./strings.js */ "./node_modules/vscode/vscode/src/vs/base/common/strings.js");
/* harmony import */ var _uri_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./uri.js */ "./node_modules/vscode/vscode/src/vs/base/common/uri.js");
/* harmony import */ var _path_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./path.js */ "./node_modules/vscode/vscode/src/vs/base/common/path.js");
...
/* harmony import */ var _map_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./map.js */ "./node_modules/vscode/vscode/src/vs/base/common/map.js");
...
class FileAccessImpl {
    constructor() {
        this.staticBrowserUris = ( new _map_js__WEBPACK_IMPORTED_MODULE_6__.ResourceMap());
    ...
    toUrl(moduleId) {
        ...
        return ( ( new URL(url ?? moduleId, globalThis.location?.href ?? "file:///home/jazzpirate/work/Software/sTeX/iMMT/source/ts/editor/node_modules/vscode/vscode/src/vs/base/common/network.js")).toString());
    }
    ...
    uriToBrowserUri(uri) {
        ...
        uri.scheme === Schemas.file &&
            (
            (
            _platform_js__WEBPACK_IMPORTED_MODULE_1__.isNative || (_platform_js__WEBPACK_IMPORTED_MODULE_1__.webWorkerOrigin === `${Schemas.vscodeFileResource}://${FileAccessImpl.FALLBACK_AUTHORITY}`)))) {
            return uri.with({
    ...
    toUri(uriOrModule, moduleIdToUrl) {
        ...
        if (globalThis._VSCODE_FILE_ROOT) {
            ...
            const modulePath = (0,_path_js__WEBPACK_IMPORTED_MODULE_4__.join)(rootUriOrPath, uriOrModule);
...
/* harmony export */ });
/* harmony import */ var _process_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./process.js */ "./node_modules/vscode/vscode/src/vs/base/common/process.js");
    ...
    resolve(...pathSegments) {
        ...
        for (let i = pathSegments.length - 1; i >= -1; i--) {
            ...
            if (i >= 0) {
                ...
                path = (0,_process_js__WEBPACK_IMPORTED_MODULE_0__.cwd)();
            }
            else {
                path = _process_js__WEBPACK_IMPORTED_MODULE_0__.env[`=${resolvedDevice}`] || (0,_process_js__WEBPACK_IMPORTED_MODULE_0__.cwd)();
                if (path === undefined ||
...
const posixCwd = (() => {
    if (platformIsWin32) {
        const regexp = /\\/g;
        return () => {
            const cwd$1 = (0,_process_js__WEBPACK_IMPORTED_MODULE_0__.cwd)().replace(regexp, '/');
            return cwd$1.slice(cwd$1.indexOf('/'));
        };
    }
    return () => (0,_process_js__WEBPACK_IMPORTED_MODULE_0__.cwd)();
})();
const posix = {
    resolve(...pathSegments) {
        let resolvedPath = '';
...
/* harmony export */   platformLocale: () => (/* binding */ platformLocale),
...
/* harmony import */ var _nls_messages_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../nls.messages.js */ "./node_modules/vscode/vscode/src/vs/nls.messages.js");
...
if (typeof nodeProcess === 'object') {
    ...
    _isWeb = true;
    _language = (0,_nls_messages_js__WEBPACK_IMPORTED_MODULE_1__.getNLSLanguage)() || LANGUAGE_DEFAULT;
...
/* harmony export */   platform: () => (/* binding */ platform)
/* harmony export */ });
/* harmony import */ var _platform_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./platform.js */ "./node_modules/vscode/vscode/src/vs/base/common/platform.js");
...
/* harmony export */ });
/* harmony import */ var _extpath_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./extpath.js */ "./node_modules/vscode/vscode/src/vs/base/common/extpath.js");
/* harmony import */ var _network_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./network.js */ "./node_modules/vscode/vscode/src/vs/base/common/network.js");
...
class ExtUri {
    ...
    isEqualOrParent(base, parentCandidate, ignoreFragment = false) {
        if (base.scheme === parentCandidate.scheme) {
            if (base.scheme === _network_js__WEBPACK_IMPORTED_MODULE_1__.Schemas.file) {
                return (0,_extpath_js__WEBPACK_IMPORTED_MODULE_0__.isEqualOrParent)(originalFSPath(base), originalFSPath(parentCandidate), this._ignorePathCasing(base)) && base.query === parentCandidate.query && (ignoreFragment || base.fragment === parentCandidate.fragment);
            }
            if (isEqualAuthority(base.authority, parentCandidate.authority)) {
                return (0,_extpath_js__WEBPACK_IMPORTED_MODULE_0__.isEqualOrParent)(base.path, parentCandidate.path, this._ignorePathCasing(base), '/') && base.query === parentCandidate.query && (ignoreFragment || base.fragment === parentCandidate.fragment);
            }
        }
        return false;
    }
    ...
    dirname(resource) {
        ...
        if (resource.scheme === _network_js__WEBPACK_IMPORTED_MODULE_1__.Schemas.file) {
            dirname = _uri_js__WEBPACK_IMPORTED_MODULE_5__.URI.file((0,_path_js__WEBPACK_IMPORTED_MODULE_2__.dirname)(originalFSPath(resource))).path;
        }
        else {
    ...
    normalizePath(resource) {
        ...
        let normalizedPath;
        if (resource.scheme === _network_js__WEBPACK_IMPORTED_MODULE_1__.Schemas.file) {
            normalizedPath = _uri_js__WEBPACK_IMPORTED_MODULE_5__.URI.file((0,_path_js__WEBPACK_IMPORTED_MODULE_2__.normalize)(originalFSPath(resource))).path;
        }
        else {
    ...
    relativePath(from, to) {
        ...
        if (from.scheme === _network_js__WEBPACK_IMPORTED_MODULE_1__.Schemas.file) {
            const relativePath = (0,_path_js__WEBPACK_IMPORTED_MODULE_2__.relative)(originalFSPath(from), originalFSPath(to));
            return _platform_js__WEBPACK_IMPORTED_MODULE_3__.isWindows ? (0,_extpath_js__WEBPACK_IMPORTED_MODULE_0__.toSlashes)(relativePath) : relativePath;
        }
    ...
    resolvePath(base, path) {
        if (base.scheme === _network_js__WEBPACK_IMPORTED_MODULE_1__.Schemas.file) {
            const newURI = _uri_js__WEBPACK_IMPORTED_MODULE_5__.URI.file((0,_path_js__WEBPACK_IMPORTED_MODULE_2__.resolve)(originalFSPath(base), path));
            return base.with({
                authority: newURI.authority,
                path: newURI.path
            });
        }
        path = (0,_extpath_js__WEBPACK_IMPORTED_MODULE_0__.toPosixPath)(path);
        return base.with({
    ...
    hasTrailingPathSeparator(resource, sep$1 = _path_js__WEBPACK_IMPORTED_MODULE_2__.sep) {
        if (resource.scheme === _network_js__WEBPACK_IMPORTED_MODULE_1__.Schemas.file) {
            const fsp = originalFSPath(resource);
            return fsp.length > (0,_extpath_js__WEBPACK_IMPORTED_MODULE_0__.getRoot)(fsp).length && fsp[fsp.length - 1] === sep$1;
        }
        else {
    ...
    removeTrailingPathSeparator(resource, sep$1 = _path_js__WEBPACK_IMPORTED_MODULE_2__.sep) {
        if (hasTrailingPathSeparator(resource, sep$1)) {
            return resource.with({ path: resource.path.substr(0, resource.path.length - 1) });
        }
        return resource;
    }
    addTrailingPathSeparator(resource, sep$1 = _path_js__WEBPACK_IMPORTED_MODULE_2__.sep) {
        let isRootSep = false;
        if (resource.scheme === _network_js__WEBPACK_IMPORTED_MODULE_1__.Schemas.file) {
            const fsp = originalFSPath(resource);
            isRootSep = ((fsp !== undefined) && (fsp.length === (0,_extpath_js__WEBPACK_IMPORTED_MODULE_0__.getRoot)(fsp).length) && (fsp[fsp.length - 1] === sep$1));
        }
        else {
            sep$1 = '/';
            const p = resource.path;
...
function toLocalResource(resource, authority, localScheme) {
    if (authority) {
        ...
        if (path && path[0] !== _path_js__WEBPACK_IMPORTED_MODULE_2__.posix.sep) {
            path = _path_js__WEBPACK_IMPORTED_MODULE_2__.posix.sep + path;
        }
...
/* harmony export */   forAnsiStringParts: () => (/* binding */ forAnsiStringParts),
...
/* harmony export */   getIndentationLength: () => (/* binding */ getIndentationLength),
...
/* harmony export */   removeAnsiEscapeCodesFromPrompt: () => (/* binding */ removeAnsiEscapeCodesFromPrompt),
...
/* harmony export */ });
/* harmony import */ var _cache_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./cache.js */ "./node_modules/vscode/vscode/src/vs/base/common/cache.js");
/* harmony import */ var _lazy_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./lazy.js */ "./node_modules/vscode/vscode/src/vs/base/common/lazy.js");
...
/* harmony export */   isUriComponents: () => (/* binding */ isUriComponents),
...
/***/ "./node_modules/vscode/vscode/src/vs/editor/common/core/editOperation.js":
/*!*******************************************************************************!*\
  !*** ./node_modules/vscode/vscode/src/vs/editor/common/core/editOperation.js ***!
  \*******************************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _range_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./range.js */ "./node_modules/vscode/vscode/src/vs/editor/common/core/range.js");
...
/* harmony import */ var _core_editOperation_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./core/editOperation.js */ "./node_modules/vscode/vscode/src/vs/editor/common/core/editOperation.js");
...
/* harmony import */ var _tokenizationRegistry_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./tokenizationRegistry.js */ "./node_modules/vscode/vscode/src/vs/editor/common/tokenizationRegistry.js");
...
const symbolKindNames = {
    [17 ]: ( (0,_nls_js__WEBPACK_IMPORTED_MODULE_5__.localize)(1678, "array")),
    [16 ]: ( (0,_nls_js__WEBPACK_IMPORTED_MODULE_5__.localize)(1679, "boolean")),
    [4 ]: ( (0,_nls_js__WEBPACK_IMPORTED_MODULE_5__.localize)(1680, "class")),
    [13 ]: ( (0,_nls_js__WEBPACK_IMPORTED_MODULE_5__.localize)(1681, "constant")),
    [8 ]: ( (0,_nls_js__WEBPACK_IMPORTED_MODULE_5__.localize)(1682, "constructor")),
    [9 ]: ( (0,_nls_js__WEBPACK_IMPORTED_MODULE_5__.localize)(1683, "enumeration")),
    [21 ]: ( (0,_nls_js__WEBPACK_IMPORTED_MODULE_5__.localize)(1684, "enumeration member")),
    [23 ]: ( (0,_nls_js__WEBPACK_IMPORTED_MODULE_5__.localize)(1685, "event")),
    [7 ]: ( (0,_nls_js__WEBPACK_IMPORTED_MODULE_5__.localize)(1686, "field")),
    [0 ]: ( (0,_nls_js__WEBPACK_IMPORTED_MODULE_5__.localize)(1687, "file")),
    [11 ]: ( (0,_nls_js__WEBPACK_IMPORTED_MODULE_5__.localize)(1688, "function")),
    [10 ]: ( (0,_nls_js__WEBPACK_IMPORTED_MODULE_5__.localize)(1689, "interface")),
    [19 ]: ( (0,_nls_js__WEBPACK_IMPORTED_MODULE_5__.localize)(1690, "key")),
    [5 ]: ( (0,_nls_js__WEBPACK_IMPORTED_MODULE_5__.localize)(1691, "method")),
    [1 ]: ( (0,_nls_js__WEBPACK_IMPORTED_MODULE_5__.localize)(1692, "module")),
    [2 ]: ( (0,_nls_js__WEBPACK_IMPORTED_MODULE_5__.localize)(1693, "namespace")),
    [20 ]: ( (0,_nls_js__WEBPACK_IMPORTED_MODULE_5__.localize)(1694, "null")),
    [15 ]: ( (0,_nls_js__WEBPACK_IMPORTED_MODULE_5__.localize)(1695, "number")),
    [18 ]: ( (0,_nls_js__WEBPACK_IMPORTED_MODULE_5__.localize)(1696, "object")),
    [24 ]: ( (0,_nls_js__WEBPACK_IMPORTED_MODULE_5__.localize)(1697, "operator")),
    [3 ]: ( (0,_nls_js__WEBPACK_IMPORTED_MODULE_5__.localize)(1698, "package")),
    [6 ]: ( (0,_nls_js__WEBPACK_IMPORTED_MODULE_5__.localize)(1699, "property")),
    [14 ]: ( (0,_nls_js__WEBPACK_IMPORTED_MODULE_5__.localize)(1700, "string")),
    [22 ]: ( (0,_nls_js__WEBPACK_IMPORTED_MODULE_5__.localize)(1701, "struct")),
    [25 ]: ( (0,_nls_js__WEBPACK_IMPORTED_MODULE_5__.localize)(1702, "type parameter")),
    [12 ]: ( (0,_nls_js__WEBPACK_IMPORTED_MODULE_5__.localize)(1703, "variable")),
};
function getAriaLabelForSymbol(symbolName, kind) {
    return ( (0,_nls_js__WEBPACK_IMPORTED_MODULE_5__.localize)(1704, '{0} ({1})', symbolName, symbolKindNames[kind]));
}
var SymbolKinds;
...
class TextEdit {
    static asEditOperation(edit) {
        return _core_editOperation_js__WEBPACK_IMPORTED_MODULE_2__.EditOperation.replace(_core_range_js__WEBPACK_IMPORTED_MODULE_3__.Range.lift(edit.range), edit.text);
    }
}
...
const TokenizationRegistry = ( (new _tokenizationRegistry_js__WEBPACK_IMPORTED_MODULE_4__.TokenizationRegistry()));
const TreeSitterTokenizationRegistry = ( (new _tokenizationRegistry_js__WEBPACK_IMPORTED_MODULE_4__.TokenizationRegistry()));
...
/* harmony import */ var _prefixSumComputer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./prefixSumComputer.js */ "./node_modules/vscode/vscode/src/vs/editor/common/model/prefixSumComputer.js");
...
/* harmony import */ var _base_common_uint_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../base/common/uint.js */ "./node_modules/vscode/vscode/src/vs/base/common/uint.js");
...
/* harmony export */ });
/* harmony import */ var _nls_messages_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./nls.messages.js */ "./node_modules/vscode/vscode/src/vs/nls.messages.js");
...
/***/ "./node_modules/vscode/vscode/src/vs/nls.messages.js":
/*!***********************************************************!*\
  !*** ./node_modules/vscode/vscode/src/vs/nls.messages.js ***!
  \***********************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
//# sourceMappingURL=vendors-node_modules_vscode_vscode_src_vs_base_common_assert_js-node_modules_vscode_vscode_sr-39c9f0.immt_editor.js.map